...
* When you filter assets, the filter text in [!UICONTROL min and max] fields disappear once a value is entered. (ASSETS-6925)
...
* If the text is written in [!UICONTROL Hours and Minutes] in date picker field, no text error message is displayed. The error is only identified using the Red color. (ASSETS-6852, ASSETS-6921, ASSETS-6920, ASSETS-6907)
...
* When you [!UICONTROL save] a Smart Collection, some of the labels are not appropriately associated with the screen reader. (ASSETS-6881)
...
* The empty text input fields, available in the IPTC tab of Asset properties, do not have a 3:1 contrast ratio in comparison to its adjacent colors.
