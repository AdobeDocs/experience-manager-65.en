...
* When a user updates to AEM Forms Service Pack 20 (6.5.20.0) installed with the Forms Add-On, configurations using the legacy cloud service for Adobe Analytics with user credential-based authentication, fail to function correctly, causing analytics rules to not execute.
