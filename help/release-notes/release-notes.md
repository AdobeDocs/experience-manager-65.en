...
* When you filter assets, the filter text in min and max fields disappear once a value is entered. (ASSETS-6925)
* In Experience Manager Collections, the screen reader does not announce the email field on the Download screen. (ASSETS-6923)
* alt` text is missing while annotating the elements. (ASSETS-6922)
...
* In Experience Manager Collections, the remove button `X` does not have any text to speakannounce for the screen readers. (ASSETS-6912)
...
* In Experience Manager Files, while selecting one of the options from Scheduling radio button in Manage Publication, the radio button options name and state are announced by the screen reader, but the **Scheduling** label  is not announced. (ASSETS-6908, ASSETS-6906)
...
* The Filter text lacks 4.5:1 contract ration againstin comparison to the background color. (ASSETS-6873)
...
* While switching tofrom Brand Portal to Experience Manager 6.5, the user predicate filter does not display appropriate results when you apply the filter for the first time. (ASSETS-15932)
