...
<details>
 ...
 <h4>Sites</h4>
 <ul>
  <li>Export AEM Experience Fragments to Adobe Target. For more details, see <a href="https://helpx.adobe.com/experience-manager/6-5/help/sites-developing/experience-fragments.html#TheExperienceFragmentLinkRewriterProviderHTML">The Experience Fragment Link Rewriter Provider - HTML</a>. Hotfix for CQ-4265469</li>
 </ul>
 <h4>Forms - Document Services</h4>
 <ul>
...
* AEM 6.5.2.0 requires AEM 6.5. Check [upgrade documentation](/help/sites-deploying/upgrade.md) for detailed instructions.
