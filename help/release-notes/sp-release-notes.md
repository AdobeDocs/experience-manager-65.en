...
uuid: 47ea8b60-0992-41a8-95d5-1aceac4eb660
contentOwner: User
topic-tags: release-notes
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5
discoiquuid: 8b70d16f-c5be-475f-a101-bac1a20f6350
...
* Unmapped output variables on Watched Folders are causing invocation to fail. Hotfix for CQ-4264451
...
<note type="caution">
<p>For customers with Feature Packs installed on AEM 6.4. Optional Feature Packs provided by Adobe have dependencies on the release version and service pack. If you have any Feature Pack installed, contact the AEM Customer Care team to validate the compatibility of those feature packs with this service pack for AEM 6.4.</p>
</note>
-->
...
<!--
Comment Type: remark
Last Modified By: Deepti Kalra (dekalra)
Last Modified Date: 2019-07-02T04:20:48.140-0400
<p>update the link of HTTP API, to leave as it is (confirmed by Mohit)</p>
-->
...
Comment Type: remark
Last Modified By: Deepti Kalra (dekalra)
Last Modified Date: 2019-07-02T04:21:00.662-0400
<p>@Mohit Kumar Jain - Confirm this for AEM 6.5 (confirmed)</p>
-->
...
Comment Type: remark
Last Modified By: Deepti Kalra (dekalra)
Last Modified Date: 2019-06-27T06:34:39.124-0400
<p>@Mohit Kumar Jain - No OAK released in 6.5.1.0. Removing OAK updates from the release notes, </p>
<p> (3) The OSGi bundle org.apache.jackrabbit.oak-core is on version ___ or higher (Use Web Console: /system/console/bundles).</p>
-->
...
Comment Type: remark
Last Modified By: Deepti Kalra (dekalra)
Last Modified Date: 2019-06-24T04:54:04.602-0400
<p>Update AEM developer support link</p>
-->
