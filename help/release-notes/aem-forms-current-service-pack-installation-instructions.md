...
>* For [Hotfix for CQ-4351234](/help/release-notes/aem-forms-hotfix.md), When deploying in a cluster environment, it is essential to ensure that locators are started using JDK 17. 
