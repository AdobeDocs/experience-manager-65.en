...
<table>
  ...
  <tr>
    ...
    <li>In an Adaptive Form based on an XDP with embedded scripts on checkboxes, the scripts are not executed for elements after such checkboxes. A hotfix is available for this issue. (FORMS-14244) </li>
     ...
     <li>Configurations using the legacy cloud service for Adobe Analytics with user credential-based authentication, fail to function correctly, causing the failure of analytics rules to execute.
    </ul>
    </td>    
  </tr>
  <tr>
