...
* When a customer saves a metadata schema with many fields, the formbuilder's multipart/form-data request exceeds the maxFileCount limit, causing silent failures. (CQDOC-22465)
