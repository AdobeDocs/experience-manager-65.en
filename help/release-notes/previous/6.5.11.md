...
* If you are using Content Fragments and GraphQL, then it is recommended that you upgrade to 6.5.12.0 and install the appropriate packages. If upgrading to 6.5.12.0 is not an option, please contact support to evaluate if a workaround can be implemented in the meantime.
