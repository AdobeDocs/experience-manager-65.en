...
* When you install AEM 6.5 Service Pack 11 you may experience problems with the Assets (Images) search functionality. If so, it is recommended that you upgrade to 6.5.12.0 and install the appropriate hotfix.
