...
| Date     | Thursday, June 6, 2024 <!-- UPDATE FOR EACH NEW RELEASE -->              |
...
* SITES-17934 - Content Fragments - Preview fails due to DoS protection for large tree fragments. See the [KB article about Default GraphQL Query Executor configuration options](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23945)
...
* [List of OSGi bundles included in Experience Manager 6.5.21.0](/help/release-notes/assets/65210-bundles.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
* [List of Content Packages included in Experience Manager 6.5.21.0](/help/release-notes/assets/65210-packages.zip) <!-- UPDATE FOR EACH NEW RELEASE -->
