...
+ Forms {#forms}
  ...
  + Troubleshooting {#troubleshooting}
    ...
    + [Mitigating Path traversal vulnerability in functional web frameworks for AEM Forms on JEE](/help/forms/using/mitigating-spring-framework-vulnerabilities-for-aem-forms-on-jee.md)
