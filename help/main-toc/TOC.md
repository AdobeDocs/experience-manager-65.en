...
+ Developing {#developing}
  ...
  + Headless Experience Management {#headless}
    ...
    + Delivery API{#delivery-api}
      ...
      + [Content Fragments GraphQL API](https://experienceleague.adobe.com/docs/experience-manager-65/developing/headless/delivery-api/graphql-api-content-fragments.html)
      ...
      + [Authentication for Remote AEM GraphQL Queries on Content Fragments](https://experienceleague.adobe.com/docs/experience-manager-65/developing/headless/delivery-api/graphql-authentication-content-fragments.html)
      + [AEM GraphQL API with Content Fragments - Sample Content and Queries](https://experienceleague.adobe.com/docs/experience-manager-65/developing/headless/delivery-api/content-fragments-graphql-samples.html)
...
+ Mobile {#mobile}
  ...
  + Introduction to AEM Mobile {#introduction}
    ...
    + [AEM Mobile On-Demand](/help/mobile/getting-started-aem-mobile-on-demand.md)
    + [Mobile Apps](/help/mobile/mobile-apps.md)
    + [AEM Adobe PhoneGap](/help/mobile/getting-started-aem-mobile-phonegap.md)
    + [AEM Mobile - GDPR Readiness](/help/mobile/aem-mobile-gdpr-compliance.md)
    + [Develop Mobile Apps](/help/mobile/develop-mobile-apps.md)
  + Authoring On-Demand Services App {#authoring}
    + [Mobile On-Demand](/help/mobile/mobile-apps-ondemand.md)
  ...
  + Developing On-Demand Services App {#developing}
    + [AEM Mobile On-Demand](/help/mobile/aem-mobile-on-demand.md)
    + [App Templates and Components](/help/mobile/app-templates-and-components1.md)
    + [Content Properties and Nodes](/help/mobile/content-properties.md)
    ...
    + [Page Templates for Mobile Apps](/help/mobile/apps-architecture.md)
    + [Using Content Properties to Export Content](/help/mobile/on-demand-content-properties-exporting.md)
    + [Rendering and Delivery](/help/mobile/rendering-and-delivery.md)
    + [Content Services](/help/mobile/developing-content-services.md)
    + [Content Delivery](/help/mobile/develop-content-as-a-service.md)
  + Administering On-Demand Services App {#administering}
    + [AEM Mobile On-Demand](/help/mobile/aem-mobile.md)
    + [AEM Mobile SetUp](/help/mobile/aem-mobile-setup.md)
    + [Configure Your Users and User Groups](/help/mobile/aem-mobile-configure-users.md)
    + [Previewing with Preflight](/help/mobile/aem-mobile-manage-ondemand-services.md)
    + [Mobile Apps](/help/mobile/administer-mobile-apps.md)
    + [Models Overview](/help/mobile/model-management.md)
  ...
  + Authoring Adobe PhoneGap Enterprise {#author-phonegap}
    + [PhoneGap](/help/mobile/phonegap.md)
    ...
    + [Creating an AEM Mobile app using create wizard](/help/mobile/phonegap-create-new-app.md)
  ...
  + Developing Adobe PhoneGap Enterprise {#developphonegap}
    + [PhoneGap](/help/mobile/developing-in-phonegap.md)
    ...
    + [Out of the Box App Handlers](/help/mobile/contentsync-app-handlers.md)
    ...
    + [Page Templates for Mobile Apps](/help/mobile/phonegap-apps-arch-page-templates.md)
    + [Configuring Adobe Target Cloud Service](/help/mobile/aem-mobile-configuring-cloud-service.md)
  ...
  + Administering Adobe PhoneGap Enterprise {#administering-phonegap}
    + [Mobile Quickstart](/help/mobile/phonegap-mobile-quickstart.md)
    + [Administering Content for Adobe PhoneGap Enterprise with AEM](/help/mobile/administer-phonegap.md)
    + [Configure your Adobe PhoneGap Build Cloud Service](/help/mobile/configure-phonegap-build-cloud.md)
    + [Setting Your Referrer Filter to Allow Empty](/help/mobile/setting-referrer-filter-empty.md)
    + [Configure your Adobe Mobile Services Cloud Service](/help/mobile/configure-adobe-mobile-cloud-service.md)
    + [Configure Your Users and User Groups](/help/mobile/configure-users-groups.md)
