...
>[!NOTE]
>
>To learn more about the author and publish architectural overview and how the content is authored on an AEM author instance and then forward-replicated to multiple publish instances, refer to [Author and Publish Architectural Overview](/help/screens/author-publish-architecture-overview.html?).
...
### Step 2: Creating a Screens Replication Agent {#step-creating-a-screens-replication-agent}
