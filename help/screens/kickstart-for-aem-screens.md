...
1. To download **AEM Screens Player**, click [here](https://download.macromedia.com/screens/).
   ...
   For implementation of Chrome OS Player, see [**Chrome Management Console**](/help/screens/implementing-chrome-os-player.html?cq_ck=1513900475345) for more information.
...
1. [Manage Devices](/help/screens/managing-devices.md)
1. [Create and Manage Schedules](/help/screens/managing-schedules.md)
