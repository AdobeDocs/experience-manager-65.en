...
+ Repository Restructuring {#restructuring}
    ...
    + [Common Repository Restructuring in AEM 6.5](all-repository-restructuring-in-aem-6-4.md)
    + [Sites Repository Restructuring in AEM 6.5](sites-repository-restructuring-in-aem-6-4.md)
    + [Assets Repository Restructuring in AEM 6.5](assets-repository-restructuring-in-aem-6-4.md)
    + [Dynamic Media Repository Restructuring in AEM 6.5](dynamicmedia-repository-restructuring-in-aem-6-4.md)
    + [Forms Repository Restructuring in AEM 6.5](forms-repository-restructuring-in-aem-6-4.md)
    + [E-Commerce Repository Restructuring in AEM 6.5](ecommerce-repository-restructuring-in-aem-6-4.md)
    + [Repository Restructuring for AEM Communities in 6.5](communities-repository-restructuring-in-aem-6-4.md)
+ eCommerce {#ecommerce}
