...
1. Navigate to the required page, select the page, then open the **Properties** dialog.

1. Select the **Advanced** tab.

1. Expand the **Export** field to select a configuration template. 
...
The template consists of a node structure. Each node has a `type` property that defines a specific action in the creation process of the zip file. For more details about the type property, refer to the Overview of configuration types section in the Content Sync framework page.
