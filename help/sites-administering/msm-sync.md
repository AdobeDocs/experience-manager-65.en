...
>[!NOTE]
>
>In the touch-optimized UI see also [Configuring MSM Locks on Page Properties (Touch-Optimized UI)](/help/sites-developing/extending-msm.md#configuringmsmlocksonpagepropertiestouchoptimizedui).
