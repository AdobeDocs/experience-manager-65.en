...
>
>* AEM must be [integrated with Adobe Target using Adobe I/O](/help/sites-administering/integration-target-ims.md).
>
...
AEM Experience Fragments can be exported to the default workspace in Adobe Target, or to user-defined workspaces for Adobe Target. This is done via Adobe I/O, for which AEM must be [integrated with Adobe Target using Adobe I/O](/help/sites-administering/integration-target-ims.md).
...
1. You have to [integrate AEM with Adobe Target using Adobe I/O](/help/sites-administering/integration-target-ims.md).
