...
>[!TIP]
>
>Alternativly the CIF add-on package can also be installed via Package Manager.

1. Start the AEM quickstart

Verify the setup via OSGI console: `http://localhost:4502/system/console/osgi-installer`. The list should include the CIF add-on related bundles, content-package, and OSGI configurations. Make sure all bundles are startet.
...
To connect your project to the commerce system AEM needs to be configured with the the GraphQL endpoint of your commerce system. 
