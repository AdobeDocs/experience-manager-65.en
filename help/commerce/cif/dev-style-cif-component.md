...
![What you will build](/help/commerce/cif/assets/style-cif-component/what-you-will-build.png)

## Prerequisites {#prerequisites}

A local development environment is required to complete this tutorial. This includes a running instance of AEM that is configured and connected to a Magento instance. Review the requirements and steps for [setting up a local development with AEM as a Cloud Service SDK](/help/commerce/cif/develop-ams.md).
...
1. At this point you should have a working version of a storefront that is connected to a Magento instance. Navigate to the `US` > `Home` page at: [http://localhost:4502/editor.html/content/venia/us/en.html](http://localhost:4502/editor.html/content/venia/us/en.html).
    ...
    ![Storefront Configured with Venia Theme](/help/commerce/cif/assets/style-cif-component/venia-store-configured.png)
...
![ui.frontend to ui.apps architecture](/help/commerce/cif/assets/style-cif-component/ui-frontend-architecture.png)
...
1. Navigate and expand the **ui.frontend** module and expand the folder hierarchy to: `ui.frontend/src/main/styles/commerce`:
    ...
    ![ui.frontend commerce folder](/help/commerce/cif/assets/style-cif-component/ui-frontend-commerce-folder.png)
...
1. Inspect the file `ui.frontend/dist/clientlib-site/site.css`:
    ...
    ![Compiled Site CSS](/help/commerce/cif/assets/style-cif-component/comiled-site-css.png)
...
1. In the `ui.apps` module inspect the file: `ui.apps/src/main/content/jcr_root/apps/venia/clientlibs/clientlib-site/css/site.css`:
    ...
    ![Compiled Site CSS in ui.apps](/help/commerce/cif/assets/style-cif-component/comiled-css-ui-apps.png)
...
1. Next inspect the other client libraries generated by the project:
    ...
    ![Other Client libraries](/help/commerce/cif/assets/style-cif-component/other-clientlibs.png)
...
1. Inspect the files `customheaderlibs.html` and `customfooterlibs.html` beneath `ui.apps/src/main/content/jcr_root/apps/venia/components/page`:
    ...
    ![Custom Header and Footer scripts](/help/commerce/cif/assets/style-cif-component/custom-header-footer-script.png)
...
1. Expand the Asset finder (the side rail) in **Edit** mode. Switch the Asset filter to **Products**.
    ...
    ![Expand the Asset Finder and filter by Products](/help/commerce/cif/assets/style-cif-component/drag-drop-product-page.png)

1. Drag and drop a new Product onto the home page in the main Layout Container:

    ![Product Teaser with pink border](/help/commerce/cif/assets/style-cif-component/pink-border-product-teaser.png)
...
1. Select the **Page Information** menu and click **View as Published**:
    ...
    ![View as Published](/help/commerce/cif/assets/style-cif-component/view-as-published.png)
...
1. Select the **Page Information** menu and click **Edit Template**:
    ...
    ![Edit the template](/help/commerce/cif/assets/style-cif-component/edit-template.png)
...
1. In the upper left-hand corner, select the **Page Information** icon and click **Page Policy**.
    ...
    ![Page policy menu item](/help/commerce/cif/assets/style-cif-component/page-policy-menu.png)

1. This will open the Page Policy for the Landing Page template:

    ![Page Policy - landing page](/help/commerce/cif/assets/style-cif-component/page-policy-properties.png)
...
1. Return to the IDE of your choice beneath the `ui.frontend` module open the file: `ui.frontend/src/main/static/index.html`
    ...
    ![Static HTML File](/help/commerce/cif/assets/style-cif-component/static-index-html.png)
...
1. Navigate to the [http://localhost:8080/](http://localhost:8080/) in a new tab with the same browser as a logged in instance of AEM. You should see the Venia home page via the webpack-dev-server:
    ...
    ![Webpack dev server on port 80](/help/commerce/cif/assets/style-cif-component/webpack-dev-server-port80.png)
...
1. Update the media query at the bottom, to stack the name and price in screens smaller than **992px**.
    ...
    ![Webpack Dev Server teaser changes](/help/commerce/cif/assets/style-cif-component/webpack-dev-server-teaser-changes.png)

    However, the changes have not been deployed to AEM yet. You can download the [solution file here](/help/commerce/cif/assets/style-cif-component/_productteaser.scss).
...
1. Return to your browser and re-fresh the Home page: [http://localhost:4502/editor.html/content/venia/us/en.html](http://localhost:4502/editor.html/content/venia/us/en.html). You should see the updated product teaser styles applied.
    ...
    ![Updated Product Teaser style](/help/commerce/cif/assets/style-cif-component/product-teaser-new-style.png)
...
1. Experiment by adding additional Product teasers. Use Layout Mode to change the width and offset of the components in order to display multiple teasers in a row.
    ...
    ![Multiple Product Teasers](/help/commerce/cif/assets/style-cif-component/multiple-teasers-final.png)
...
![Bonus Challenge - style System](/help/commerce/cif/assets/style-cif-component/bonus-challenge.png)
