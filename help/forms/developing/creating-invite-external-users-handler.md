...
description: Learn how to create an Invite External Users Handler. An Invite External Users handler enables the Rights Management service to invite external users to become Rights Management users.
role: Developer
