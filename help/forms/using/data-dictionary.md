...
1. In the Properties screen, add the following:
   ...
   <note>
   <p>Do not use underscore (_) in a data dictionary name. Using underscore in data dictionary name may result in data binding related errors when you create a letter that refers to the data dictionary. For more information, see <a href="/forms/using/cm-troubleshooting.md#main-pars_accordion_container" target="_blank">Correspondence Management troubleshooting</a>.</p>
   </note>
   -->
