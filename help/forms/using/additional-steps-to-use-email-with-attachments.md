...
1. Use the manifest file of `java.mail-1.0.jar` retrived from Step 1 to create a new custom jar file say as `java.mail-1.5.jar`.
...
1. Create a new custom jar (`java.mail-1.5.jar`) file by using following command in `C:\Adobe\Adobe_Experience_Manager_Forms\java\jdk\bin` folder as:
...
1. Stop **JBoss** from the **Services Console** and append the following properties to **Sling.properties** file:
