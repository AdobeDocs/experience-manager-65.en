...
When you use the [GuideBridge `baseUrl` configuration](#configure-base-url), configure CORS on the AEM publish instance so the AEM server returns appropriate headers for submission, prefill, and Document of Record endpoints.
