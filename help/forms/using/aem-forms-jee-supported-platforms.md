...
1. AEM Forms on JEE supports Oracle Java&trade; SE 11 (64 bit) SDK for application server JBoss EAP 7.4 only.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Intel&reg; Xeon&reg; E5-2680, 2.4 GHz processor or equivalent<br /> VMWare ESX 5.1 or later<br /> RAM: 6 GB (64-bit OS with 64-bit JVM)<br /> Free disk space: 15GB of temporary space plus 22GB<br /> for AEM Forms on JEE</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li><strong>Intel powered environment</strong>: Intel&reg; Xeon&reg; E5-2680, 2.4 GHz or greater. Using a dual core processor will further enhance performance</li>
...
- Hardware requirement: Intel&reg; Pentium&reg; 4 or AMD equivalent, 1 GHz processor
...
<table>
 <tbody>
  ...
  <tr>
   <td>Native Android browser on Android&trade; 4.4 and above</td>
   <td>All updates</td>
  </tr>
 </tbody>
</table>
...
- Sep 01, 2022
  ...
  - Added support for Oracle Java&trade; SE 11 (64 bit) SDK for application server JBoss EAP 7.4.
