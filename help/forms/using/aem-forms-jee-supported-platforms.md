...
- To get the most of your AEM deployment, Adobe recommends licensing the MongoDB Enterprise version to benefit from professional support.
    @@ -242,187 +206,150 @@ Adobe Experience Manager Forms requires a Java&trade; Virtual Machine to run, wh
...
<table>
 <tbody>
  ...
  <tr>
   <td><a href="https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html">Acrobat Pro DC</a> (Continuous track, latest version)</td>
...
<tbody>
 ...
 <tr>
  <td>Adobe Acrobat Pro DC (Continuous track, latest version)</td>
...
>[!NOTE]
>
>Adobe Acrobat 2020 (Classic track) is not supported with AEM Forms. Use Adobe Acrobat Pro DC (Continuous track, latest version) instead.
>
...
|Adobe Acrobat Pro DC (Continuous track, latest version) for PDF Generator and related document services |Adobe Acrobat 2020 (Classic track)|JBoss&reg; Enterprise Application Platform (EAP) 7.4.10  |
...
| Adobe Acrobat 2020 (Classic track) for PDF Generator and related document services | | Microsoft&reg; Office 2019 |
...
| Added Support | Removed Support | Deprecated Support |
| -------------- | --------------- | ------------------- |
| Microsoft&reg; Office 2021 | Microsoft&reg; Office Visio 2019 |  |
|  | Microsoft&reg; Publisher 2019 |  |
|  | Microsoft&reg; Project 2019 |  |
...
| Added Support | Removed Support | Deprecated Support |
| -------------- | --------------- | ------------------- |
| Oracle Java&trade; SE 11 (64 bit) SDK for application server JBoss&reg; EAP 7.4. | | Adobe Acrobat 2017|
|  | | Red Hat&reg; Enterprise Linux&reg; 7 (Kernel 3.x) (64-bit) |
|  | | Microsoft&reg; Windows Server 2016 (64-bit)|
|  | | Microsoft&reg; Office 2016 |
|  | | OpenOffice 4.1.2 |
