...
- **Service Pack Coverage**: Adobe provides technical support for AEM Forms environments running any service pack released within the last 18 months. If your current version falls outside this 18-month window, Adobe strongly recommends upgrading to the latest service pack to maintain optimal performance, security, and continuous support.
...
>[!NOTE] 
>
> For any query related to supported formats or platform versions, contact AEM Forms support. 
