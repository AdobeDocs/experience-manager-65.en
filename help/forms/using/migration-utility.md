...
description: The Migration utility allows you to Migrate AEM Forms assets and documents from AEM 6.3 Forms or prior versions to AEM 6.5 Forms.
seo-description: The Migration utility allows you to Migrate AEM Forms assets and documents from AEM 6.3 Forms or prior versions to AEM 6.5 Forms.
...
1. Do the following to perform the migration:
    ...
    * **Moves layouts and layout fragments to AEM 6.5 Forms user interface**: If you are upgrading from 6.2 to 6.4, the layout templates and layout fragments are added as forms in the AEM Forms 6.4 user interface section.
