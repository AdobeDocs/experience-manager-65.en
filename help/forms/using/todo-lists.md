...
>
>* If the drafts are forwarded after submitting the task in the AEM Forms workspace, email notifications are sent. If the drafts are forwarded from the startpoint of the AEM Forms workspace, no email notifications are sent.
