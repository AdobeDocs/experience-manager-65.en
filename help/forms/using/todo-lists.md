...
>
>* Email notifications for forwarding of Drafts appear only when the drafts are forwarded after the **submitComplete** task in the AEM Forms workspace. If the Drafts are forwarded from the startpoint of the AEM Forms workspace, no email notifications are sent for them.
