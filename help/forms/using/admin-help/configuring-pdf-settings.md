...
description: Learn how to configure Adobe PDF settings. This document explains how you can configure the conversion settings visible on the Adobe PDF Settings page. You can use any of the predefined PDF settings or create your own.
