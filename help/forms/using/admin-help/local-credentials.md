...
description: Learn how to manage local credentials. You can import and manage the local credentials using the Trust Store Management. AEM forms support RSA and DSA credentials in standard PKCS12 form.
contentOwner: admin
