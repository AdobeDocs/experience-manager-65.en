...
description: Learn how to build a secure AEM Forms app. You can build a secure AEM forms application for iOS by archiving the Xcode project. This creates an installer (an .ipa file) and a property list (a .plist file) file. 
