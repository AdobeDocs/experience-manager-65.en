...
If you are using the UNIX-based operating system, install the following 32-bit version packages from the installation media of the respective operating system:
