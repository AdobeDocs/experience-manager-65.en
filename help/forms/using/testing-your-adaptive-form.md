...
1. Open AEM Testing UI (AEM &gt; **[!UICONTROL Tools]** &gt; **[!UICONTROL Operations]** &gt; **[!UICONTROL Testing]**). The test suite - **We retail - Tests** - is listed in the UI.
...
1. In [!UICONTROL CRXDE lite], navigate to the `/content/forms/af/create-first-adaptive-form` folder. Right click the **[!UICONTROL create-first-adaptive-form]** folder node and click **[!UICONTROL Create]**> **[!UICONTROL Create File]**. In the **[!UICONTROL Name]** field, type `prefill.xml` and click **[!UICONTROL OK]**. Add the following code to the file:
...
1. To run all the tests of the Test Suite:
    ...
    1. In the [!UICONTROL Tests] panel, tap **[!UICONTROL We retail - Tests (1)]**. It The suite expands to display list of test.
...
1. Tap the test name, Prefill test, to review the results of the Test Case. It opens the [!UICONTROL Result] panel. Tap the name of your Test Case in the [!UICONTROL Result] panel to view all the details of the test.
