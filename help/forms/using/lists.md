...
uuid: d7a2f26d-f061-43a2-b6fa-f7758c0b7201
topic-tags: correspondence-management
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: f3cdedc4-1052-49b0-a382-e8fccd0daabe
index: y
internal: n
snippet: y
---
...
<!--
<related-links>
<a href="/help/forms/using/create-correspondence.md">Create correspondence</a>
<a href="/help/forms/using/manage-agent-signature-images.md">Manage agent signature images</a>
<a href="/help/forms/using/layout-design-details.md">Layout design details</a>
<a href="/help/forms/using/expression-builder.md">Expression builder</a>
<a href="/help/forms/using/cm-configuration-properties.md">Correspondence Management configuration properties</a>
<a href="/help/forms/using/submit-letter-topostprocess.md">Post processing of letters</a>
<a href="/help/forms/using/add-custom-action-asset-listing-view.md">Add custom action to Asset Listing view</a>
<a href="/help/forms/using/add-custom-properties-cm-assets.md">Add custom properties to Correspondence Management assets</a>
<a href="/help/forms/using/add-action-button-in-create-correspondence-ui.md">Add custom action/button in Create Correspondence UI</a>
<a href="/help/forms/using/customize-create-correspondence-ui.md">Customize Create Correspondence UI logo</a>
</related-links>
-->
