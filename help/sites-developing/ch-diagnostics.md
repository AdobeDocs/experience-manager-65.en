...
* **Configuration of ContextHub modules:** Opens the /etc/cloudsettings/default/contexthub.config.kernel.js file, which containstheJavascript object representation of the ContextHub store configurations.
