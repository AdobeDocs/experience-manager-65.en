...
The rendering process is exposed through ` [com.adobe.cq.dam.cfm.content.FragmentRenderService](/help/sites-developing/reference-materials/javadoc/com/adobe/cq/dam/cfm/ContentFragment.md)` and can be leveraged (for example) by custom components if required.