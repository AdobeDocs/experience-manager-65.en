...
1. Enable the update by defining the following settings for your instance using the configuration page:

   <!-- CHECK: need new screenshot -->

   <!--
   ![Configuration Page](assets/cfm-graphql-update-01.png "Configuration Page")
   -->
