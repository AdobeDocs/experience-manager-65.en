...
* Identify the choice for [shared UGC storage](/help/communities/working-with-srp.md) (**SRP**)
    ...
    * If JCR SRP [(JSRP)](/help/communities/jsrp.md)
        ...
        * Not a shared UGC (User-Generated Content) store:
            ...
            * UGC is only visible on an AEM instance or cluster in which it was entered.
...
AEM 6.5 Communities GA includes Communities package. To know more about updates to AEM 6.5 [Communities](/help/release-notes/release-notes.md#experiencemanagercommunities), see [AEM 6.5 Release Notes](/help/release-notes/release-notes.md#communities-release-notes.html).
