...
Ensure most checkboxes are deselected for [User Management](../../communities/using/sites-console.md#user-management) :
...
The tags which may be applied to community content are controlled by selecting AEM namespaces previously defined through the [Tagging Console](/help/sites-administering/tags.md#tagging-console) (such as the [Tutorial namespace](/communities/using/enablement-setup.md#create-tutorial-tags)).
