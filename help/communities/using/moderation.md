...
uuid: 4103b6b0-d6d9-4e29-857e-4371d22c5645
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: administering
content-type: reference
discoiquuid: ba781157-ac02-4f87-aa52-a214d3b2b07d
index: y
internal: n
snippet: y
---
...
Apart from the out of the box filters in [Filter Rail](../../communities/using/moderation.md#ootbfilters), additional custom filters on metadata can be added to moderation UI. Developers can use the sample code in Github to extend the existing moderation UI filters.
