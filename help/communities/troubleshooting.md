...
This warning can be safely ignored as `jknack.handlebars.Handlebars`, used by [SCF](scf.md#handlebarsjavascripttemplatinglanguage), comes with its own i18n helper utility. On startup, it is replaced with an AEM-specific [i18n helper](handlebars-helpers.md#i-n). This warning is generated by the third-party library to confirm the override of an existing helper.
