...
When closed, no further replies or moderation actions are allowed.
...
Moderators can see such a post and mark it not appear on the site. Moderation actions on these posts can be performed either in-context or through bulk moderation UI.
