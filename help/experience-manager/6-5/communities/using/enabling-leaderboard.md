...
uuid: f37f5199-7cbf-4081-8f99-64c70f66d04b
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: 211128e1-8e17-4f4f-83b4-3ac24bf334d0
index: y
internal: n
snippet: y
---
...
Prior to including the leaderboard component on a page, it is necessary to configure [Communities Scoring and Badges](../../../6-5/communities/using/implementing-scoring.md).

This section of the documentation describes

* adding the `Leaderboard` component to a [community site](../../../6-5/communities/using/overview.md#community-sites)
...
![](assets/chlimage_1-105.png) ![](assets/chlimage_1-106.png)
...
More information may be found on the [Leaderboard Essentials](/6-5/communities/using/leaderboard.md) page for developers.

Instructions for creating rules are provided on the [Communities Scoring and Badges](../../../6-5/communities/using/implementing-scoring.md) page for administrators.
