...
uuid: 42c8c655-6f0a-4968-9706-68fe7970932a
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: d2fdf42d-c444-418d-bbfe-e85594111e36
index: y
internal: n
snippet: y
---
...
When the [required client-side libraries](/6-5/communities/using/calendar-basics-for-developers.md#essentials-for-client-side) are included, this is how the `Calendar` component will appear.
...
![](assets/chlimage_1-207.png) ![](assets/chlimage_1-208.png)
...
Under the **User Moderation **tab, specify how the posted topics and replies (user generated content) are managed. For more information, see [Moderating User Generated Content](../../../6-5/communities/using/moderate-ugc.md).
...
>[!NOTE]
>
>Visit [Administering Tags](/6-5/sites/administering/using/tags.md) to learn how to add a new tag namespace (taxonomy).
...
When the signed in user has moderator or administrator privileges, they are able to perform [moderation tasks](../../../6-5/communities/using/moderate-ugc.md) (as permitted by the configuration of the component) on all calendar events and comments posted to an event.

![](assets/chlimage_1-209.png)

#### Members {#members}

When the signed in user is a community member or [privileged member](/6-5/communities/using/users.md#privileged-members-group) (depending on configuration), they are able to select `New Event` to create and post a new calendar event.
...
More information may be found on the [Calendar Essentials](/6-5/communities/using/calendar-basics-for-developers.md) page for developers.

For moderation of calendar events and comments, see [Moderating User Generated Content](../../../6-5/communities/using/moderate-ugc.md).

For tagging calendar events and comments, see [Tagging User Generated Content](/6-5/communities/using/tag-ugc.md).

For translation of calendar events and comments, see [Translating User Generated Content](/6-5/communities/using/translate-ugc.md).
