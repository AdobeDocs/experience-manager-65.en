...
uuid: 2105d17e-c21f-4c82-ae6d-8360dedd3d47
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: administering
content-type: reference
discoiquuid: 8a3ef5ec-43f0-4b3a-90f3-e85c13aa4427
...
The Groups console provides access to creating community groups when a community site's [template structure](../../../6-5/communities/using/sites-console.md#step1) includes the [groups function](../../../6-5/communities/using/functions.md#groups-function).

* AEM Communities support nesting of groups within other groups. Group nesting is possible when the [structure of the new group](../../../6-5/communities/using/tools-groups.md) contains the groups function.
...
>[!NOTE]
>
>Community groups, created in the publish environment before the [existence of the Community Groups console](/6-5/communities/using/version-history.md#featurepack1fp1), will not be listed in the Community Groups console, and thus, are not modifiable using the console.

>[!NOTE]
>
>This Groups console, only accessible from the Communities Sites console, is not to be confused with the member [Groups console](/6-5/communities/using/members.md) for managing member groups. 
>
>Member groups are user groups registered in the publish environment and accessed from the author environment using the [tunnel service](../../../6-5/communities/using/deploy-communities.md#tunnel-service-on-author).
...
* Select an instance of a community site within the folder
    ...
    * these screen shots are from the Getting Started tutorial after [creating groups on publish](../../../6-5/communities/using/published-site.md)
...
* **Community Group Template** menu: use the drop-down to choose an available [community group template](/6-5/communities/using/tools.md).
...
* **Restricted Membership** 
  If selected, the community group is a secret group. Community members must be explicitly invited. Invited members are entered in the search box. Members can be added later using the [Members and Groups consoles](/6-5/communities/using/members.md) the author environment. Default is not selected.
...
>[!NOTE]
>
>The group gets created in all the languages, as specified in [Step 1: Community Group Template](../../../6-5/communities/using/groups.md#step-community-group-template) in Additional Available Community Group Languages, in the Community Groups console of the respective community sites.
...
* On an instance of a community function in the site structure:
    ...
    * **`Gear icon`** 
      ...
      and [privileged members groups](/6-5/communities/using/users.md#privilegedmembersgroups).
