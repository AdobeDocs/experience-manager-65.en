...
uuid: e0c9c7b3-3e63-4bee-9649-8359cf4611f3
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: 9fe25907-adf0-4ccf-b826-3136731ed221
index: y
internal: n
snippet: y
---
...
When the [required client-side libraries](/6-5/communities/using/qna-essentials.md#essentials-for-client-side) are included, this is how the `QnA`component appears:
...
* **Allow Following** 
  If checked, include the following feature for forum posts, which allows members to be [notified](../../../6-5/communities/using/notifications.md) of new posts. Default is deselected.

* **Allow Pinning** 
  If checked, forum topics can be pinned to the top of the list of topics. Default is deselected.

* **Allow Email Subscriptions** 
  If checked, allow members to be notified of new posts by email ([subscription](/6-5/communities/using/subscriptions.md)). Requires Allow Following to be checked and [email configured](/6-5/communities/using/email.md). Default is deselected.
...
* **Display Badges** 
  If checked, display earned and assigned [badges](../../../6-5/communities/using/implementing-scoring.md) with a member's blog entry. Default is deselected.

* **Allow Featured Content** 
  if checked, the idea is able to be identified as [featured content](/6-5/communities/using/featured.md). Default is deselected.
...
Under the **User Moderation **tab, specify how the posted topics (questions) and answers (user generated content) are managed. For more information, see [Moderating User Generated Content](../../../6-5/communities/using/moderate-ugc.md).
...
More information can be found on the [QnA Essentials](/6-5/communities/using/qna-essentials.md) page for developers.
