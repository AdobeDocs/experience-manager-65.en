...
uuid: a6084941-34db-4a47-9f29-b11f7f1a05e0
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: administering
content-type: reference
discoiquuid: ef1f003c-9839-46f1-ac1b-e73833c65109
...
* [advanced awarding of badges](../../../6-5/communities/using/advanced.md) to identify members as experts (quality of content created)

**Note** that awarding of badges is [not enabled by default](../../../6-5/communities/using/implementing-scoring.md#main-pars-text-237875536).
...
The Communities [Badges console](../../../6-5/communities/using/badges.md) provides the ability to add custom badges which can be displayed for a member when earned (awarded) or when they take on a specific role in the community (assigned).
...
Assigned (and awared) badges are stored in the selected [SRP](/6-5/communities/using/srp.md) and are not directly accessible. Until a GUI is available, the only means for assigning role-based badges is to do so with code or cURL. For cURL instructions, see the section titled [Assign and Revoke Badges](#assign-and-revoke-badges).
...
Custom badges can be installed using the [Badges console](../../../6-5/communities/using/badges.md) and either assigned or specified in badging rules.
...
The scoring and bading rules are in effect only for instances of components that have enabled badging by editing the component configuration in [authoring mode](../../../6-5/communities/using/author-communities.md).

A boolean property, `allowBadges`, enables/disables the display of badges for a component instance. It is configurable in the [component edit dialog](../../../6-5/communities/using/author-communities.md) for forum, QnA and comment components through a checkbox labeled **Display Badges**.
   ...
   <td style="text-align: left;"> 
    <ul> 
     ...
     <li>if "advanced", specifies the scoring engine based on quality and quantity 
      <ul> 
       <li>requires an <a href="../../../6-5/communities/using/advanced.md">additional package</a></li> 
      </ul> </li> 
...
Included in the release are two scoring rules for the [Forum Function](../../../6-5/communities/using/functions.md#forum-function) (one each for the Forum and Comments components of the Forum feature) :
...
<table border="2" cellpadding="4" cellspacing="2" width="90%"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td style="text-align: center;">String</td> 
   <td style="text-align: left;"><em>(optional)</em> Identifies the scoring engine as either "basic" or "advanced". If the advanced scoring engine is desired, see <a href="../../../6-5/communities/using/advanced.md">Advanced Scoring and Badges</a>. The default is "basic".</td> 
  </tr> 
  <tr> 
...
Badges may be assigned to members either using the [members console](/6-5/communities/using/members.md#badges-tab) or programmatically using cURL commands.
...
>
>* may refer to an author instance if the [Tunnel Service](/6-5/communities/using/users.md#tunnel-service) is enabled
>* may be an obscure, random name - see [Security Checklist](../../../6-5/sites/administering/using/security-checklist.md#verify-that-you-are-not-disclosing-personally-identifiable-information-in-the-users-home-path) regarding authorizable ID
>
...
>[!NOTE]
>
>A new boolean property, `allowBadges`, enables/disables the display of badges for a component instance. It will be configurable in updated [component edit dialogs](../../../6-5/communities/using/author-communities.md) through a checkbox labeled **Display Badges**.

** [Calendar Component](../../../6-5/communities/using/calendar.md)** 
...
** [Comments Component](../../../6-5/communities/using/comments.md)** 
...
** [File Library Component](../../../6-5/communities/using/file-library.md)** 
...
** [Forum Component](../../../6-5/communities/using/forum.md)** 
...
** [Journal Component](../../../6-5/communities/using/blog-feature.md)** 
...
** [QnA Component](../../../6-5/communities/using/working-with-qna.md)** 
...
** [Reviews Component](/6-5/communities/using/reviews.md)** 
...
** [Rating Component](/6-5/communities/using/rating.md)** 
...
** [Voting Component](/6-5/communities/using/voting.md)** 
...
It is possible to quickly try scoring and badging using the [Getting Started Tutorial](../../../6-5/communities/using/getting-started.md) (engage) site :
...
Next, [republish](../../../6-5/communities/using/sites-console.md#publishing-the-site) the community site.
...
More information may be found on the [Scoring and Badges Essentials](../../../6-5/communities/using/configure-scoring.md) page for developers.

For information on the advanced scoring engine, see [Advanced Scoring and Badges](../../../6-5/communities/using/advanced.md).

The configurable Leaderboard [component](../../../6-5/communities/using/enabling-leaderboard.md) and [function](../../../6-5/communities/using/functions.md#leaderboard-function) simplifies the display of members and their scores on a community site.
