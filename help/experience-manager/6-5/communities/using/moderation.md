...
uuid: 069d1ef1-3d31-49d7-ade3-1632a5fe4d51
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: administering
content-type: reference
discoiquuid: 0d06fdc7-7cdb-452c-991a-b4db9821d027
index: y
internal: n
snippet: y
---
...
In AEM Communities, bulk [moderation of community content](../../../6-5/communities/using/moderate-ugc.md) is possible from both the author and publish environments by administrators and community moderators (trusted community members assigned as moderators).

Administrators and community moderators may also perform [in-context moderation](/6-5/communities/using/in-context.md) in the publish environment.

A feature of all [community sites](../../../6-5/communities/using/sites-console.md) is an `Administration`menu item available to users who sign in with administrative privileges. The `Administration`link provides access to the Moderation console.
...
For more detailed information visit [Managing Users and User Groups](/6-5/communities/using/users.md).
...
Only when signed in as an administrator, or a member with ` [moderator permissions](/6-5/communities/using/in-context.md#identifyingtrustedmembers)`, may moderation tasks be performed.
...
Only when signed in as an administrator, or as a member with ` [moderator permissions](/6-5/communities/using/in-context.md#identifyingtrustedmembers)`, may moderation tasks be performed. The only community content displayed is that which the signed in member is permitted to moderate.

>[!NOTE]
>
>UGC from the publish environment will only be visible on author if the chosen SRP implements a common store. For example, by default the storage is JSRP, which is not a common store for author and publish. See [Community Content Storage](../../../6-5/communities/using/working-with-srp.md).
...
The top navigation bar is constant for all consoles. For more information, see [Basic Handling](../../../6-5/sites/authoring/using/basic-handling.md).

### Toolbar {#toolbar}

The toolbar, located beneath the top navigation bar, provides the following toggle switch on the left side:

* [Filter rail](../../../6-5/communities/using/moderation.md#filterrail)  
...
* [sentiment](../../../6-5/communities/using/moderate-ugc.md#sentiment) associated with the post
...
>[!NOTE]
>
>When the bulk moderation console is accessed by an administrator, all references to UGC are shown, including sites not created with the [site creation wizard](../../../6-5/communities/using/sites-console.md), such as the Geometrixx samples.
>
...
[Sentiment](../../../6-5/communities/using/moderate-ugc.md#sentiment) limits the referenced UGC displayed to posts with a sentiment value that is either positive, negative or neutral.

![](assets/chlimage_1-64.png)

## Custom Filters {#custom-filters}

Apart from the out of the box filters in [Filter Rail](../../../6-5/communities/using/moderation.md#ootbfilters), additional custom filters on metadata can be added to moderation UI. Developers can use the sample code in Github to extend the existing moderation UI filters.
...
[Moderation actions](../../../6-5/communities/using/moderate-ugc.md#moderation-actions) can be performed on one or more selections made in the content area or when viewing content detail.
