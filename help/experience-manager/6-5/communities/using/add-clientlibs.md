...
uuid: ad2c32e5-21d2-4800-a9ab-f5d748800e77
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: developing
content-type: reference
discoiquuid: 55d02eb4-cf83-4e1b-a198-dbdb2bffda8b
index: y
internal: n
snippet: y
---
...
| ** [⇐ Develop Sandbox Application](/6-5/communities/using/develop-app.md)** |** [Develop Sandbox Content ⇒](/6-5/communities/using/develop-content.md)** |
|---|---|
...
In the **Properties** tab for the `clientlibs` node, enter the multi-value String property **embed**. This embeds the necessary [client-side libraries (clientlibs) for SCF components](/6-5/communities/using/client-customize.md#clientlibs-for-scf). For this tutorial many of the clientlibs necessary for the Communities components are added.
...
This package exists on the [Create a Sample Page](/6-5/communities/using/create-sample-page.md) tutorial for those who can't wait to just jump in and start playing!...
