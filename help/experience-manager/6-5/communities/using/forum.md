...
uuid: 0245a5a9-9f3c-46d9-9aa2-d8b082054e4a
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: 1c807f20-724a-4c0d-8a72-459e1cf6fada
index: y
internal: n
snippet: y
---
...
When the [required client-side libraries](/6-5/communities/using/essentials-forum.md#essentials-for-client-side) are included, this is how the `Forum`component will appear :
...
![](assets/chlimage_1-161.png) ![](assets/forum-config.png)
...
* **Allow Following** 
  If checked, include the following feature for forum posts, which allows members to be [notified](../../../6-5/communities/using/notifications.md) of new posts. Default is unchecked.
...
More information may be found on the [Forum Essentials](/6-5/communities/using/essentials-forum.md) page for developers.
...
For translation of posted topics and comments, see [Translating User Generated Content](/6-5/communities/using/translate-ugc.md).
