...
uuid: 429a7467-4d9d-4731-b34d-32b3bee4ef5b
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: 86308fa9-bd5a-4ca2-8286-1deb082b852a
index: y
internal: n
snippet: y
---
...
* Embedded social networking content ([oEmbed support](../../../6-5/communities/using/blog-developer-basics.md#allowing-rich-media))
* Draft mode
* Scheduled publishing
* Compose on-behalf (a [privileged member](/6-5/communities/using/users.md#privileged-members-group) can create content on behalf of a different communty member)
* [In-context and bulk moderation](../../../6-5/communities/using/moderate-ugc.md) of blog articles and comments
...
When the [required client-side libraries](../../../6-5/communities/using/blog-developer-basics.md#essentials-for-client-side) are included, this is how the `Blog`component will appear :
...
![](assets/chlimage_1-250.png) ![Blog settings](assets/blog-configure.png)
...
* **Allow Email Subscriptions** 
  If checked, allow members to be notified of new posts by email ([subscription](/6-5/communities/using/subscriptions.md)). Requires `Allow Following` to be checked and [email configured](/6-5/communities/using/email.md). Default is unchecked.

* **Display Badges** 
  If checked, display earned and assigned [badges](../../../6-5/communities/using/implementing-scoring.md) with a member's blog entry. Default is unchecked.

* **Do Not Get Replies on Listing Page**
* **Allow Featured Content** 
  if checked, the idea is able to be identified as [featured content](/6-5/communities/using/featured.md). Default is unchecked.
...
When the signed in user has moderator or administrator privileges, they are able to perform [moderation tasks](../../../6-5/communities/using/moderate-ugc.md) (as permitted by the configuration of the component) on all blog articles and comments posted to a blog.

![](assets/chlimage_1-251.png)

#### Members {#members}

When the signed in user is a community member or [privileged member](/6-5/communities/using/users.md#privileged-members-group) (depending on configuration), they are able to select `New Article` to create and post a new blog article.
...
![](assets/chlimage_1-252.png) ![](assets/chlimage_1-253.png)
...
More information may be found on the [Blog Essentials](../../../6-5/communities/using/blog-developer-basics.md) page for developers.

For moderation of blog entries and comments, see [Moderating User Generated Content](../../../6-5/communities/using/moderate-ugc.md).

For tagging blog entries and comments, see [Tagging User Generated Content](/6-5/communities/using/tag-ugc.md).

For translation of blog entries and comments, see [Translating User Generated Content](/6-5/communities/using/translate-ugc.md).
