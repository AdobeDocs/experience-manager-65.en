...
uuid: fe8fbeb7-607e-46b2-89c7-c76d558eaf32
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: developing
content-type: reference
discoiquuid: 990a74bb-735d-47cd-a757-b9a4ef873909
index: y
internal: n
snippet: y
---
...
Any changes to this behavior should be made in a customized script (either override or overlay). See [Client-side Customizaton](/6-5/communities/using/client-customize.md).
...
For detailed instructions, visit [Create a Custom Log File](../../../6-5/sites/deploying/using/monitoring-and-maintaining.md#create-a-custom-log-file).
...
It is possible to view the UGC related to scoring and badging when the chosen SRP is either JSRP or MSRP, but not ASRP. (If not familiar with these terms, see [Community Content Storage](../../../6-5/communities/using/working-with-srp.md) and [Storage Resource Provider Overview](/6-5/communities/using/srp.md).)

The descriptions for accessing scoring and badging data use JSRP, as the UGC is easily accessible using [CRXDE Lite](../../../6-5/sites/developing/using/developing-with-crxde-lite.md).

**JSRP on author** : experimenting in the author environment results in UGC that is only visible from the author environment.

**JSRP on publish** : similarly, if testing on the publish environment, it will be necessary to access CRXDE Lite with administrative privileges on a publish instance. If the publish instance is running in [production mode](/6-5/sites/administering/using/production-ready.md) (nosamplecontent runmode), it will be necessary to [enable CRXDE Lite](/6-5/sites/administering/using/enabling-crxde-lite.md).
...
The latest Javadocs for the installed [feature pack](/6-5/communities/using/version-history.md) are available to developers from the Adobe repository. See [Using Maven for Communities : Javadocs](/6-5/communities/using/maven.md#javadocs).
...
* using the Getting Started Tutorial (engage) site created during the [getting started tutorial](../../../6-5/communities/using/getting-started.md)
...
* using the [Community Components guide](/6-5/communities/using/components-guide.md)
* locate the forum page node
...
* [Leaderboard function](../../../6-5/communities/using/functions.md#leaderboard-function) for inclusion in a community site or group template.
* [Leaderboard component](../../../6-5/communities/using/enabling-leaderboard.md), the featured component of the Leaderboard function, for page authoring.
