...
uuid: 9ac05c90-6d2c-4a0f-87dc-339efb0e725d
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: administering
content-type: reference
discoiquuid: 72a4598c-2f3b-4801-8ab0-0eac9173bd25
index: y
internal: n
snippet: y
---
...
* [blog](../../../6-5/communities/using/blog-feature.md) : members post a blog article or comment
* [calendar](../../../6-5/communities/using/calendar.md) : members post a calendar event or comment
* [comments](../../../6-5/communities/using/comments.md) : members post a comment or reply to a comment  

* [forum](../../../6-5/communities/using/forum.md) : members post a new topic or reply to a topic
* [ideation](../../../6-5/communities/using/ideation-feature.md) : members post an idea or comment
* [QnA](../../../6-5/communities/using/working-with-qna.md) : members create a question or answer a question
* [reviews](/6-5/communities/using/reviews.md) : members post a comment when rating an item

Moderation of UGC is useful for recognizing positive contributions as well as limiting negative ones (such as spam and abusive language). UGC can be moderated from several environments : [](../../../6-5/communities/using/working-with-srp.md)

* [bulk moderation console](../../../6-5/communities/using/moderation.md)  
  The Moderation console is accessible by administrators and [community moderators](/6-5/communities/using/users.md) in the public environment as well as by administrators in the author environment. This is possible when community content is stored in a [common store](../../../6-5/communities/using/working-with-srp.md).

* [in-context moderation](/6-5/communities/using/in-context.md)  
...
* `Admin`  
  a user who is a member of [community-administrators](/6-5/communities/using/users.md) group

* `Moderator`  
  a member of a [community moderators](/6-5/communities/using/users.md#publishenvironmentusersandgroups) group (has [moderator permissions](/6-5/communities/using/in-context.md#moderatorpermissions))
...
When UGC is premoderated, the post will not appear on the published site until approved by a moderation action. During creation of a [community site](../../../6-5/communities/using/sites-console.md), checking the box ` [Content is Premoderated](../../../6-5/communities/using/sites-console.md#moderation)` will enable premoderation for the entire site. Once components are placed on a page, components which support moderation can be configured for premoderation using a setting in their edit dialog :

* [comments](../../../6-5/communities/using/comments.md) and [reviews](/6-5/communities/using/reviews.md)  
  on **User Moderation** tab, check **Pre-Moderation**

* [forum](../../../6-5/communities/using/forum.md), [ideation](../../../6-5/communities/using/ideation-feature.md), [QnA](../../../6-5/communities/using/working-with-qna.md), and [calendar](../../../6-5/communities/using/calendar.md)  
...
However, to customize or extend the default spam words create a set of words in the /apps directory following the structure of the default spam words by means of [overlay](../../../6-5/communities/using/overlay-comments.md).
...
From the [bulk moderation console](../../../6-5/communities/using/moderation.md), it is possible to filter and view UGC based on whether the sentiment is negative, neutral, or positive.
