...
uuid: d1162fd9-af54-4f7c-a69b-a39a028f6164
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/COMMUNITIES
topic-tags: authoring
content-type: reference
discoiquuid: 06cc6943-4949-4f92-8058-aabfe4767f02
index: y
internal: n
snippet: y
---
...
When the [required client-side libraries](/6-5/communities/using/ideation.md#essentials-for-client-side) are included, this is how the `Ideation`component will appear :
...
![](assets/chlimage_1-137.png) ![](assets/ideation-settings.png)
...
* **Allow Following** 
  If checked, include the following feature for idea posts, which allows members to be [notified](../../../6-5/communities/using/notifications.md) of new posts. Default is unchecked.
...
* **Display Badges** 
  If checked, display earned and assigned [badges](../../../6-5/communities/using/implementing-scoring.md) with a member's idea. Default is unchecked.
...
Under the **User Moderation **tab, specify how the posted ideas and comments (user generated content) are managed. For more information, see [Moderating User Generated Content](../../../6-5/communities/using/moderate-ugc.md).
...
More information may be found on the [Ideation Essentials](/6-5/communities/using/ideation.md) page for developers.
