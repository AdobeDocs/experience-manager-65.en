...
uuid: 174a41b1-4b42-4e28-a8a0-f9a987660d8b
discoiquuid: e64df925-66cd-4672-b272-506378c437c2
index: y
internal: n
snippet: y
---
  ...
  <tr>
   ...
   <td>
    <ul> 
     ...
     <li>Install AEM Forms add-on. For detailed information see, <a href="../../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md" target="_blank">Install and configure AEM Forms</a>.</li> 
     ...
     <li>Create/import and enable <a href="../../../../6-5/forms/using/web-channel-print-channel.md">Templates for print and web channel</a>.</li> 
     <li>Ensure you have the <a href="/6-5/forms/using/document-fragments.md">Document fragments based on the FDM</a>.</li> 
    </ul> </td> 
  </tr>
 </tbody>
</table>
