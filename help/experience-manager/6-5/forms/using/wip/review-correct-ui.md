...
uuid: d0b1dbc2-f76a-4a56-93d0-ab458325d018
contentOwner: vishabgu
discoiquuid: fabdd364-5303-4792-b52d-9588305b0923
index: y
internal: n
snippet: y
---
...
1. [Add new component](../../../../6-5/forms/using/wip/review-correct-ui.md#add-new-component)
1. [Transform existing component](../../../../6-5/forms/using/wip/review-correct-ui.md#transform-component)
1. [Ungroup and group components](../../../../6-5/forms/using/wip/review-correct-ui.md#ungroup-and-group-components)
1. [Delete component](../../../../6-5/forms/using/wip/review-correct-ui.md#delete-component)
...
1. Tap **[!UICONTROL **Save**]**button to save the modifications in your AEM instance. You can call the Automated Forms Conversion service to begin reconversion once all the modifications are applied. See [Call Automated Forms Conversion service for reconversion](../../../../6-5/forms/using/wip/review-correct-ui.md#call-automated-forms-conversion-service-for-reconversion) for details.
