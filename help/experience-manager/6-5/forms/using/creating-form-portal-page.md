...
uuid: e3efdb31-6bf1-43c5-8bad-bd9c51ed753c
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: publish
discoiquuid: 3f8af959-912b-4775-a877-8cb92a0fbe8f
index: y
internal: n
snippet: y
---
...
Forms portal components equips Web Developers with components to create and customize a forms portal on websites authored using Adobe Experience Manager (AEM). For a quick overview of forms portal, see [Introduction to publishing forms on a portal](../../../6-5/forms/using/introduction-publishing-forms.md).

## Prerequisites {#prerequisites}

Forms portal components are not available for use by default. Ensure that the following forms portal component categories are enabled as described in [Enabling forms portal components](/6-5/forms/using/enabling-forms-portal-components.md).
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Add Item</td> 
   <td>Configures the folders where assets are uploaded using AEM Forms UI. By default, it lists all uploaded assets. For more information about AEM Forms UI, see <a href="../../../6-5/forms/using/introduction-managing-forms.md" target="_blank">Introduction to managing forms</a>.</td> 
  </tr> 
  <tr> 
...
To link a form from anywhere on the page, use the Link component. For more information about link component, see [Embedding link component in a page](../../../6-5/forms/using/embedding-link-component-page.md).

To list the forms that are in a draft state and the forms which are already submitted, use the **[!UICONTROL **Drafts and Submissions**]** component. For more information, see [Customizing Drafts and Submissions component](../../../6-5/forms/using/draft-submission-component.md).
...
You can customize a forms portal page to provide a distinct appearance to the page. You can also add metadata to improve search experience, change layout of the page, and add custom CSS styles. For more information, see [Customizing templates for Forms Portal Components](../../../6-5/forms/using/customizing-templates-forms-portal-components.md).

AEM Forms UI allows you to add custom metadata to forms. Custom metadata is useful in providing a listing and searching forms experience to the end users. For more information about Custom metadata, see [Customizing templates for Forms Portal Components](../../../6-5/forms/using/customizing-templates-forms-portal-components.md).

Out of the box, forms portal provides rendering actions. You can customize forms portal to add more actions. For detailed information, see [Adding custom action on form lister items.](../../../6-5/forms/using/add-custom-action-form-lister.md)

<!--
<related-links>
<a href="../../../6-5/forms/using/creating-form-portal-page.md">Creating a forms portal page</a>
<a href="../../../6-5/forms/using/embedding-link-component-page.md">Embedding link component in a page</a>
<a href="/6-5/forms/using/listing-forms-webpage-using-apis.md">Listing forms on a webpage using APIs</a>
<a href="../../../6-5/forms/using/draft-submission-component.md">Drafts and Submissions component</a>
</related-links>
-->
