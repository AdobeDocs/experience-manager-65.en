...
uuid: a96e2fb0-592d-45fe-89d6-4c5f43f293ac
contentOwner: anujkapo
discoiquuid: ca5b9ed8-f8e3-499d-9982-21b9962c7d53
index: y
internal: n
snippet: y
---
...
1. **Review the prerequisites. See [AEM SSL Configuration](../../../6-5/forms/using/forms-install-configure-gov-reference-site.md#aemsslconfig) for required SSL configuration.**
1. Navigate to:
...
1. Enter the following details:
    ...
    1. **Authentication Settings** (see [MS Dynamics cloud configuration settings](../../../6-5/forms/using/forms-install-configure-gov-reference-site.md#dynamicsconfig) to collect this information):
...
1. From the same page, click “We.Gov Adobe Analytics Framework (Analytics Framework)” if you wish to update the framework configurations (see [Enable AEM authoring](../../../6-5/forms/using/forms-install-configure-gov-reference-site.md#enableauthoring) to enable Authoring).
...
You can also refer to [Templates customization style system](../../../6-5/forms/using/forms-install-configure-gov-reference-site.md#customizetemplates) for documentation on supported styles.
...
* [https://helpx.adobe.com/experience-manager/6-4/forms/using/inline-style-adaptive-forms.html](https://helpx.adobe.com/experience-manager/6-4/forms/using/inline-style-adaptive-forms.html)
* [https://helpx.adobe.com/ca/experience-manager/6-4/forms/using/themes.html](https://helpx.adobe.com/ca/experience-manager/6-4/forms/using/themes.html)
...
* By default, the demo package includes several OSGI service configuration to control the overall behavior of the target server hosting the demo. These configuration include a WCM Filter service configuration which by default makes the server operate in a **disabled author** mode (equivalent to ?wcmmode=disabled). See [Enable AEM authoring](../../../6-5/forms/using/forms-install-configure-gov-reference-site.md#enableauthoring) to allow page authoring.
...
Now you are all set to explore the We.Gov reference site. For more information about We.Gov reference site workflow and steps, see [We.Gov reference site walkthrough](../../../6-5/forms/using/forms-gov-reference-site-user-demo.md).
