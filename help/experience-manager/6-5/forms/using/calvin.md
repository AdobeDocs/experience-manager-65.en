...
uuid: 01040517-f375-4e59-9bd5-a6a8f220fb63
contentOwner: gtalwar
content-type: reference
topic-tags: adaptive_forms
topic-tags: develop
discoiquuid: bb8f9519-597b-414e-869f-d23980c8201b
index: y
internal: n
snippet: y
---
...
Calvin allows you to automate testing of your adaptive forms in the web browser. Calvin utilizes [Hobbes](../../../6-5/sites/developing/using/hobbes.md)'s user interface for running the tests and provides the following tools:
...
1. Right-click the folder you have created for the test form (here testForm) and select **Create** &gt; **Create File**. Name the file scriptingTest.js and add the following code to the file and click **Save All.**
   ...
   The test case is created. Proceed to run the test case to test adaptive forms through Hobbes. For steps for running the test cases, see [Executing Tests in Testing Your UI Using Automated Tests](../../../6-5/sites/developing/using/hobbes.md).
