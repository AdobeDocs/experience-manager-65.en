...
uuid: d22eeb8b-5d24-4633-8f68-eb7250ffeaee
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: process-reporting
discoiquuid: 392b594d-4ac2-429f-87b1-d8a2ebc1df47
index: y
internal: n
snippet: y
---
...
For details on the pre-defined reports, see [Pre-defined Reports in Process Reporting](../../../../6-5/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md).

**Adhoc Queries:** This item contains options to perform filter-based search for processes and tasks.

For details on ad-hoc queries, see [Ad-hoc Queries in Process Reporting](../../../../6-5/forms/using/process-reporting/adhoc-queries-in-process-reporting.md).

**Custom:** The Custom node displays custom reports that you create.

For the procedure to create and display custom reports, see [Custom Reports in Process Reporting](../../../../6-5/forms/using/process-reporting/process-reporting-custom-reports.md).
...
For details on the data publishing service and how to schedule this service, see [Schedule process data publishing](../../../../6-5/forms/using/process-reporting/install-start-process-reporting.md#p-schedule-process-data-publishing-p) in the article Getting Started with Process Reporting.
