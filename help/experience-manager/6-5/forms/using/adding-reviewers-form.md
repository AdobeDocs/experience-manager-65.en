...
uuid: c2d2ecbf-c4b3-4042-aa40-c226c12a07f9
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: author
discoiquuid: 670b8caf-10fb-4150-8bf4-3acd7b13266e
index: y
internal: n
snippet: y
---
...
Before you perform the following steps, see [Prerequisite](../../../6-5/forms/using/adding-reviewers-form.md#prerequisite).

To create a group and add members to it, navigate to **Tools** &gt; **Operations** &gt; **Security** &gt; **Groups**.  
For more information, see [User Administration and Services](../../../6-5/sites/administering/using/security.md).   
