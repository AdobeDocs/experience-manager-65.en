...
uuid: f5fc6339-8440-4984-bd8b-c19bd2cfac50
contentOwner: anujkapo
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 054d86e4-cd9c-4f5e-a467-80d0bedc42d6
index: y
internal: n
snippet: y
---
...
For more information about form data integration and form data model, see [AEM Forms Data Integration](/6-3/forms/using/data-integration.md).
...
* [Set up the database](../../../6-5/forms/using/create-form-data-model0.md#step-set-up-the-database)
* [Configure MySQL database as data source](../../../6-5/forms/using/create-form-data-model0.md#step-configure-mysql-database-as-data-source)
* [Create form data model](../../../6-5/forms/using/create-form-data-model0.md#step-create-form-data-model)
* [Configure form data model](../../../6-5/forms/using/create-form-data-model0.md#step-configure-form-data-model)
* [Test form data model](../../../6-5/forms/using/create-form-data-model0.md#step-test-form-data-model-and-services)
...
* MySQL database with sample data as stated in the [Set up the database](../../../6-5/forms/using/create-form-data-model0.md#step-set-up-the-database) section.
* OSGi bundle for MySQL JDBC driver as explained in [Bundling the JDBC Database Driver](/6-3/sites/developing/using/jdbc.md#bundling-the-jdbc-database-driver)
...
AEM Forms provide an intuitive user interface to [create a form data mode](/6-3/forms/using/data-integration.md#main-pars_header_1524967585)l from configured data sources. You can use multiple data sources in a form data model. For the use case in this tutorial, you will use MySQL as the data source.
...
* [adding data model objects and services](../../../6-5/forms/using/create-form-data-model0.md#add-data-model-objects-and-services)
...
* usage charges = call charges + conference call charges + SMS charges + mobile internet charges + roaming national + roaming international + VAS (all these properties exist in the bills data model object)  
  For more information on the **usagecharges** child computed property, see [Plan the Interactive Communication](/6-5/forms/using/planning-interactive-communications.md).
