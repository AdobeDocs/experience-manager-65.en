...
uuid: 39bf09f3-8df1-4fc5-a13f-4d3d34a05de2
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: integrations
discoiquuid: 255962d2-e80e-49d5-ad34-76c65a1e7cfc
index: y
internal: n
snippet: y
---
...
The analytics feature in AEM Forms is available as part of the AEM Forms add-on package. For information about installing the add-on package, see [Installing and configuring AEM Forms](../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md).
...
Once you have the AEM Forms add-on package and an Adobe Analytics account, integrate Adobe Analytics account with AEM Forms and enable tracking on your forms or documents as described in [Configure analytics and reports](../../../6-5/forms/using/configure-analytics-forms-documents.md).
...
For more information on A/B testing, see [Create and manage A/B test for adaptive forms](../../../6-5/forms/using/ab-testing-adaptive-forms.md).

<!--
<related-links>
<a href="/6-5/forms/using/customizing-form-event-tracking.md" target="_blank">Customizing form event tracking</a>
</related-links>
-->
