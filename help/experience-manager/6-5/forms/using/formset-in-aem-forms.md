...
uuid: 2cd86b33-edfa-440a-8d24-c2fe043df013
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: hTML5_forms
discoiquuid: 02ea0f3c-393c-4278-86b4-684f16625461
index: y
internal: n
snippet: y
---
...
Use [AEM Forms user interface](../../../6-5/forms/using/introduction-managing-forms.md) to manage all your forms, form sets, and related assets.
...
For more information on AEM Forms app, see [AEM Forms app overview](/6-5/forms/using/mobile-workspace-overview.md).
