...
uuid: 8ac64fb6-c88a-48ad-89b9-84b0a9be4dd1
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: hTML5_forms
discoiquuid: 95ef9bb4-fff8-497b-b172-bba212364b52
index: y
internal: n
snippet: y
---
...
This article provides step-by-step information to change style of an HTML5 form and [Introduction to Styles](/6-5/forms/using/css-styles.md) article contains detailed information about various styling aspects of HTML5 forms. Ensure that you read Introduction to styles article before performing steps mentioned in this article.
...
1. **Choose a profile to add custom styles**
   ...
   Access the CRX DE interface at the URL: **http://&lt;server&gt;:&lt;port&gt;/crx/de** and create a profile or choose an existing profile. To know how to create a profile, see [Creating a new Profile](/6-5/forms/using/custom-profile.md)
...
1. **Create a CSS style sheet for styling the HTML5 forms**
   ...
   To know which CSS classes to create for a particular component in your HTML5 forms, see [Introduction to Styles](/6-5/forms/using/css-styles.md).  
