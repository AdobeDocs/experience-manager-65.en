...
uuid: ac5aa1f5-0d60-40a3-be52-74b057edd8b7
topic-tags: integration
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: e19d7572-a72f-45ee-a490-4f57165cd9b9
index: y
internal: n
snippet: y
---
...
1. Go to **[!UICONTROL Tools > Cloud Services > Data Sources]**. Tap to select the folder where you want to create a cloud configuration.
   ...
   See [Configure folder for cloud service configurations](../../../6-5/forms/using/configure-data-sources.md#cloud-folder) for information about creating and configuring a folder for cloud service configurations.
...
>[!NOTE]
>
>For step-by-step guide to configure Microsoft Dynamics 365, online or on-premises, see [Microsoft Dynamics OData Configuration](/6-4/forms/using/ms-dynamics-odata-configuration.md).
...
You have configured the data sources. Next you can create a form data model or if you have already created a form data model without a data source, you can associate it with the data sources you just configured. See [Create form data model](/6-4/forms/using/create-form-data-models.md) for details.
