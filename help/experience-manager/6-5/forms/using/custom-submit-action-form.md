...
uuid: a5945eb0-691a-4266-9340-70f709874e59
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: customization
discoiquuid: ab9912db-1d89-492a-8c69-f8b04b72a4e3
index: y
internal: n
snippet: y
---
...
Adaptive forms require Submit actions to process user-specified data. A Submit action determines the task performed on the data that you submit using an adaptive form. Adobe Experience Manager (AEM) includes [OOTB Submit actions](../../../6-5/forms/using/configuring-submit-actions.md) that demonstrate custom tasks you can perform using the user-submitted data. For example, you can perform tasks, such as sending email or storing the data.
...
>[!NOTE]
>
>An author provides the Redirect URL (using the Thank You Page Configuration). [OOTB Submit Actions](../../../6-5/forms/using/configuring-submit-actions.md) use the Redirect URL to redirect the browser from the resource that the forward path references. 
>
...
<a href="../../../6-5/forms/using/submit-form-data-livecycle-process.md" target="_blank">Configuring AEM to submit form data to LiveCycle processes</a>
<a href="/6-5/forms/using/submit-store-data-crx-repository.md" target="_blank">Submitting and storing content in JCR repository</a>
</related-links>
-->
