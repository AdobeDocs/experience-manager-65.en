...
uuid: 8cccb868-de4c-48eb-9393-2903b475c237
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: correspondence-management
discoiquuid: 796b1ff7-9789-4e85-9dfc-28419d5e043a
index: y
internal: n
snippet: y
---
...
1. **Forms Workflow:** These are the AEM Forms on JEE process management workflows. Instructions for setting up [Forms Workflow](../../../6-5/forms/using/submit-letter-topostprocess.md#main-pars-header-3).

1. **AEM Workflow: **AEM workflows can also be used as post processes for submitted letters. Instructions for setting up [AEM Workflow](../../../6-5/forms/using/aem-forms-workflow.md).
...
1. Configure the AEM DS Settings. See [Configuring AEM DS settings](../../../6-5/forms/using/configuring-the-processing-server-url-.md).
...
For more information on saving a draft letter, see [Saving drafts and submitting letter instances](../../../6-5/forms/using/create-correspondence.md#savingdrafts).

<!--
Comment Type: draft

<note>
<p>For more information, see <a href="/6-5/forms/using/cm-apis-to-access-letter-instances.md" target="_blank">APIs to access letter instances</a> and <a href="../../../6-5/forms/using/integrating-create-correspondence-UI-with-your-portal.md" target="_blank">Integrating Create Correspondence UI with your custom portal</a>.</p>
</note>
-->
...
<a href="/6-5/forms/using/document-fragments.md" target="_blank">Document fragments</a>
