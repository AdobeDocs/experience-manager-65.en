...
uuid: 95966d5a-f239-4d3a-a976-4f70753d4023
topic-tags: forms-manager
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 6f0a7c14-7449-4a44-be2e-f5909f727a22
index: y
internal: n
snippet: y
---
...
* (Optional) Configure Transaction Flush Period and Outboxes [](/6-4/forms/using/installing-configuring-aem-forms-osgi.md)
...
Transaction reports use reverse replication to consolidate count of transactions from publish instances to author instances. Set up the reverse replication on all the publish instances. For detailed instructions to setup reverse replication, see [replication](/6-4/sites/deploying/using/replication.md).
...
Only members of the fd-administrator group can view transaction reports. To allow a user to view transaction reports, make users member of the fd-administrator group. For instructions about making a user a member of an AEM group, see [User, Group and Access Rights Administration](/6-4/sites/administering/using/user-group-ac-admin.md).
...
* Use the categories: **Document Processed**, **Documents Rendered**, and **Forms Submitted** to view corresponding transactions. For the type of transactions accounted in these categories, see [Billable Transaction Reports APIs](../../../6-5/forms/using/transaction-reports-billable-apis.md).
