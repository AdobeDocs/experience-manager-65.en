...
uuid: 8e85df80-6bf7-44b6-b44c-f5628ed12c5d
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: customization
discoiquuid: a0815f56-a62c-4149-b7eb-b81e276a10d9
index: y
internal: n
snippet: y
---
...
With AEM Forms, you can now create a theme and apply it to your form. Theme editor lets you specify styling of form components in one place. When you create a theme, you specify styling at a component level. For more information on themes, see [Themes in AEM Forms](../../../6-5/forms/using/themes.md).
...
<!--
<related-links>
<a href="/6-5/forms/using/creating-custom-adaptive-form-themes.md">Create custom Adaptive form themes</a>
<a href="../../../6-5/forms/using/dynamically-populate-dropdowns.md">Dynamically populating drop-down lists</a>
</related-links>
-->
