...
uuid: cec8f216-5e83-451e-bb39-3babcbc68f5d
topic-tags: correspondence-management
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 86d64627-bb2c-499d-a9c9-2e0039948039
index: y
internal: n
snippet: y
---
...
1. Tap **Next**. Correspondence Management displays the Editor page where you can add text paragraphs and data elements to the text.
   ...
   You can also use the various keyboard shortcuts in the text editor to manage, edit, and format text. For more information on [Text Editor](/6-4/forms/using/keyboard-shortcuts.md#p-formatting-p) keyboard shortcuts in Correspondence Management Keyboard Shortcuts. 
...
1. If required, insert special characters in the document fragment. For example, you can use the Special Characters palette to insert:
   ...
   Correspondence Management has built in support for 210 special characters. The admin can [add support for more/custom special characters by customization](/6-4/forms/using/custom-special-characters.md). 
...
1. You can use inline conditions and repeat to make your letter highly contextual and well structured. For more information on inline condition and repeat, see [Inline conditions and repeat in letters](/6-4/forms/using/cm-inline-condition.md).
1. Tap **Save**.
...
1. Tap **Edit** to change the asset or edit the expression.
    ...
    * To open the Expression Builder to insert an expression, tap the folder icon under the Expression column. For more information on Expression Builder, see [Expression Builder](/6-4/forms/using/expression-builder.md).
...
A layout fragment is based on XDPs created in Designer. For creating layout fragments, you need to create the XDPs and [upload them to AEM Forms](/6-4/forms/using/import-export-forms-templates.md).
...
For instructions on uploading/importing an XDP to Correspondence Management, see [Importing and exporting assets to AEM Forms](/6-4/forms/using/import-export-forms-templates.md).
...
While designing a layout in Designer, ensure that the formats for date fields match the date formats specified in Data Display Formats in [Correspondence Management Configuration Properties](/6-4/forms/using/cm-configuration-properties.md). For more information, see “Formatting field values and using patterns” in Designer Help.
...
1. Create a Data Dictionary (DD) that you want to use in the example, as represented in the graphic.
   ...
   For more information on working with Data Dictionary and test data, see [Data Dictionary](/6-4/forms/using/data-dictionary.md#p-working-with-test-data-p).
...
1. Create a letter using both the layout fragments in it. When you insert the dynamic XDP in the letter, set the binding of its fields to the Data Dictionary's collection elements.
   ...
   For more information on creating Letters and Letter templates, see [Create Letter](/6-4/forms/using/create-letter.md).
...
1. Tap Copy. The UI displays the Paste icon. You can also choose to go inside a folder before you paste. Different folders can contain assets with same names. For more information on folders, see [Folders and organizing assets](/6-4/forms/using/import-export-forms-templates.md#folders-and-organizing-assets). 
