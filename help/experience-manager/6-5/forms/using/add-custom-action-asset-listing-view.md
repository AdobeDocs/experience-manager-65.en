...
uuid: 86beede6-577f-4714-bdfd-24a1c3d6b398
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: correspondence-management
discoiquuid: 65b38153-7b46-4486-9dd5-0f65a85e9bbf
index: y
internal: n
snippet: y
---
...
1. Create a file named POST.jsp with the code for action handling of the command at the following location:
   ...
   /apps/fd/cm/ma/gui/components/admin/clientlibs/admin
    ...
    1. Add the following code to POST.jsp file and click **Save All**:
       ...
       For more information on AEM libraries, see AEM [Components](/6-5/sites/developing/using/components.md).
...
<!--
<related-links>
<a href="../../../6-5/forms/using/customize-create-correspondence-ui.md">Add Custom logo in Create Correspondence UI</a>
