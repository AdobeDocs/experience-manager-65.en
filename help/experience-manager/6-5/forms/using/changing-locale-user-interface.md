...
uuid: f05785cd-d4b9-4539-b49c-91f414e2a158
contentOwner: robhagat
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: forms-workspace
discoiquuid: db559c99-9541-48c6-ab5e-fe93214d23b0
index: y
internal: n
snippet: y
---
...
Before performing above steps, ensure that you follow the steps listed at [Generic steps for AEM Forms workspace customization](../../../6-5/forms/using/generic-steps-html-workspace-customization.md).

>[!NOTE]
>
>To change the language of the login screen of AEM Forms workspace, see [Creating a new login screen](../../../6-5/forms/using/creating-new-login-screen.md).
...
1. Perform all the semantic changes listed in the [Workspace Customization](../../../6-5/forms/using/introduction-customizing-html-workspace.md) article.
...
You require development package to localize the *datepicker *API. For detailed information about creating development package, see [Building AEM Forms workspace code](../../../6-5/forms/using/introduction-customizing-html-workspace.md#main-pars-heading-3).
