...
uuid: 76475ac8-9613-4561-adfe-f77578215f1e
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: Configuration
discoiquuid: 7e402dfd-240f-4d64-8435-b7150b0f9228
index: y
internal: n
snippet: y
---
...
1. [Add a locale to the GuideLocalizationService service](../../../6-5/forms/using/supporting-new-language-localization.md#p-add-a-locale-to-the-guide-localization-service-br-p)  

1. [Add XFA client library for a locale](../../../6-5/forms/using/supporting-new-language-localization.md#p-add-xfa-client-library-for-a-locale-br-p)  

1. [Add adaptive form client library for a locale](../../../6-5/forms/using/supporting-new-language-localization.md#p-add-adaptive-form-client-library-for-a-locale-br-p)
1. [Add locale support for the dictionary](../../../6-5/forms/using/supporting-new-language-localization.md#p-add-locale-support-for-the-dictionary-br-p)
1. [Restart the server](../../../6-5/forms/using/supporting-new-language-localization.md#p-restart-the-server-p)
...
<!--
<related-links>
<a href="../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md" target="_blank">Installing and configuring AEM Forms</a>
