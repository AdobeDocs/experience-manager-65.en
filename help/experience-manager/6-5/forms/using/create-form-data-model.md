...
uuid: 6038f7e7-73e7-4e8a-9901-698688546d00
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.3/FORMS
discoiquuid: 08160e7d-617f-423b-ba5f-4e6f5b9f38ff
index: y
internal: n
snippet: y
---
...
| This tutorial is a step in the [Create Your First Adaptive Form](../../../6-5/forms/using/create-your-first-adaptive-form.md) series. It is recommended to follow the series in chronological sequence to understand, perform, and demonstrate the complete tutorial use case. |
|---|
...
For more information about form data integration and form data model, see [AEM Forms Data Integration](../../../6-5/forms/using/data-integration.md).
...
* MySQL database with sample data as stated in the Prerequisites section of [Create your first adaptive form](../../../6-5/forms/using/create-your-first-adaptive-form.md)
* OSGi bundle for MySQL JDBC driver as explained in [Bundling the JDBC Database Driver](/6-5/sites/developing/using/jdbc.md#bundling-the-jdbc-database-driver)
* Adaptive form as explained in the first tutorial [Create an adaptive form](/6-5/forms/using/create-adaptive-form.md)
...
AEM Forms provides an intuitive user interface to [create a form data mode](../../../6-5/forms/using/data-integration.md#main-pars-header-1524967585)l from configured data sources. You can use multiple data sources in a form data model. For our use case, we will use the configured MySQL data source.
