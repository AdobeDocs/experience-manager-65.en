...
uuid: 0387f137-043f-491a-9ebe-7b9593c1ac3d
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: author
discoiquuid: 8daa6205-271d-4166-a15f-5c1b92811fa3
index: y
internal: n
snippet: y
---
...
The [protected mode](../../../6-5/forms/using/get-xdp-pdf-documents-aem.md) is on, by default. Keep it enabled for the production environments. You can disable it for a development environment to preview HTML5 Forms in desinger. Perform the following steps to disable it:
