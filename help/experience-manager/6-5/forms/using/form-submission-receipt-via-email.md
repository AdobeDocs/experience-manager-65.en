...
uuid: 2dd82f46-803a-4d73-8373-aab617a05455
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: publish
discoiquuid: 24a51e66-5a1b-4611-9f8c-8851b4cda898
index: y
internal: n
snippet: y
---
...
Adaptive forms provides several out-of-the-box [submit actions](../../../6-5/forms/using/configuring-submit-actions.md) workflows for submitting the form data to different endpoints.
...
>[!NOTE]
>
>To use the Email action, you need to configure the AEM mail service as described in [Configuring the mail service](/6-5/sites/administering/using/notification.md#configuring the mail service).
...
1. Specify valid email IDs in the Mailto, CC, and BCC fields.
   ...
   You can also specify variable placeholders in the fields, in which case, the values of the fields are processed when the form is successfully submitted by an end user. For more information, see [Using adaptive form field names to dynamically create email content](../../../6-5/forms/using/form-submission-receipt-via-email.md#p-using-adaptive-form-field-names-to-dynamically-create-email-content-p).
