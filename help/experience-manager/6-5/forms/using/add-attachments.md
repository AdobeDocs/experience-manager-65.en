...
uuid: b16448c5-7ced-4731-8503-26486569240a
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: forms-app
discoiquuid: 8c9f857a-f76b-4c75-b6f9-b99d37d4d35e
index: y
internal: n
snippet: y
---
...
In case of adaptive forms, you can view the attached files in the document of record (DoR). See, [Generate Document of Record for non-XFA adaptive forms](../../../6-5/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md).

[**Contact Support**](https://www.adobe.com/account/sign-in.supportportal.html)

<!--
<related-links>
<a href="/6-5/forms/using/open-task.md" target="_blank">Opening a task</a>
<a href="/6-5/forms/using/working-with-form.md" target="_blank">Working with a Form</a>
<a href="../../../6-5/forms/using/add-attachments.md" target="_blank">Adding attachments</a>
<a href="/6-5/forms/using/save-as-draft.md" target="_blank">Saving a task (Save as Draft)</a>
</related-links>
-->
