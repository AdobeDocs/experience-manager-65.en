...
uuid: 7c383742-efa2-4657-8110-c4f8962587f6
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: publish
content-strategy: max-2018
discoiquuid: c1d83859-4f79-49c2-9c0c-cc64af6fef04
index: y
internal: n
snippet: y
---
...
AEM Forms let you create, publish, and unpublish forms easily. For more information about AEM Forms, see [Introduction to managing forms](../../../6-5/forms/using/introduction-managing-forms.md).
...
1. When the Publish process starts, a confirmation dialog appears listing all the related assets and resources. In the dialog box that contains related assets, tap **[!UICONTROL Publish]**. The asset is published and the Publish Assets Success dialog appears.
   ...
   After publishing an asset, you can use the Forms Portal to display all the assets on a web page. For more information, see [Introduction to publishing forms on a portal](../../../6-5/forms/using/introduction-publishing-forms.md).
...
AEM Forms let you schedule asset publishing and unpublishing for Forms & Documents. You can specify the schedule in the Metadata Editor. For more information about managing form metadata, see [Managing form metadata.](../../../6-5/forms/using/manage-form-metadata.md)
