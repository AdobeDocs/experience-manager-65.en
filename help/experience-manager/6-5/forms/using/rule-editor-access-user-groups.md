...
uuid: e996616a-bf82-4397-bb58-9e74c7610b8b
content-type: reference
topic-tags: adaptive_forms
topic-tags: develop
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 2b0bc1a1-6c94-4e87-b52b-7946e6339fae
index: y
internal: n
snippet: y
---
...
AEM Forms allows you to limit rule editor access to users based on their role or function. In the Adaptive Forms Configuration Service settings, you can specify the [user groups](../../../6-5/sites/administering/using/security.md) that can view and access rule editor.
...
1. Use the following property to specify the name of a group that can access rule editor (For example, RuleEditorsUserGroup) and click **Save All**.
   ...
   For instructions on adding users to groups, see [User Administration and Security](../../../6-5/sites/administering/using/security.md).

<!--
<related-links>
<a href="../../../6-5/forms/using/rule-editor.md" target="_blank">Rule Editor</a>
