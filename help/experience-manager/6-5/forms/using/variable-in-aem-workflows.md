...
uuid: 088a6073-6d00-4599-85ba-42169670c1d9
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: publish
discoiquuid: 8025c7c8-2225-4566-94f8-c1c23b2364d8
index: y
internal: n
snippet: y
---
...
* [Create a variable](../../../6-5/forms/using/variable-in-aem-workflows.md#create-a-variable) of a data type based on the information type that you want to store in it.
* [Set a value for the variable](../../../6-5/forms/using/variable-in-aem-workflows.md#set-a-variable) using the Set Variable workflow step.
* [Use the variable](../../../6-5/forms/using/variable-in-aem-workflows.md#use-a-variable) in all AEM Forms workflow steps to retrieve the stored value and in OR Split and Goto steps to define a routing expression.
...
In this example, before defining the routing expression, use [example 2](../../../6-5/forms/using/variable-in-aem-workflows.md#example2) to set the value for the **totalvalue** variable. Branch 1 is active if the value of the **totalvalue** variable is greater than 50000. Similarly, you can define a rule to make the Branch 2 active if the value of the **totalvalue** variable is less than 50000.
...
For more examples on using variables in AEM Forms workflow steps, refer to [Variables in AEM workflows](/kt/forms/using/authoring_variables_in_aem_forms-workflow1.md).
