...
uuid: 7fa7db8e-f796-4732-850d-665d6b0337cd
contentOwner: khsingh
topic-tags: publish
discoiquuid: 6df3e43c-057c-4503-b01c-6965feecff98
index: y
internal: n
snippet: y
---
...
1. You can use Form-centric AEM Workflows on OSGi to sign an already filled adaptive form. Form-centric AEM Workflows on OSGi supports out of the form signing. The [in-form signing](../../../6-5/forms/using/working-with-adobe-sign.md#create-in-form-signing-experience) experience is not supported.   
...
1. AEM forms JEE Workflows do not have a separate step for Adobe Sign. You require an Adobe Sign enabled adaptive form for AEM forms JEE Workflows. For more details, see [Adobe Sign documentation](../../../6-5/forms/using/working-with-adobe-sign.md#add-and-configure-the-signature-step-component).
1. You can use the [Invoke Form Data Model Service](../../../6-5/forms/using/aem-forms-workflow-step-reference.md#p-invoke-form-data-model-service-step-p) step to invoke a web-service service and post or retrieve data from a third-party application. 
1. You can use the [Send Email](../../../6-5/forms/using/aem-forms-workflow-step-reference.md#send-email-step) step to send emails.

## Differences between AEM Inbox and AEM Forms app features {#differences-between-aem-inbox-and-aem-forms-app-features}

Two of the prominent ways to launch a Forms-centric workflow are using [AEM Inbox](../../../6-5/forms/using/manage-applications-inbox.md) and AEM Forms app. The capabilities of AEM Inbox and AEM Forms app, however, differ. AEM Inbox works only with [Forms-centric workflows](../../../6-5/forms/using/aem-forms-workflow.md) while the AEM Forms app works with both Forms-centric workflows as well as process management.
