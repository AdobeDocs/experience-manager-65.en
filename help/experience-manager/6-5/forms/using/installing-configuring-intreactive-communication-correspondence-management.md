...
uuid: dacbf0ce-f4fa-435c-9b3f-3364db22743e
topic-tags: installing
discoiquuid: 155886dd-ff1c-4bd8-9208-6dc3edba55af
index: y
internal: n
snippet: y
---
...
If you are upgrading from a previous version and have already invested in correspondence management, you can install the [compatibility package](../../../6-5/forms/using/installing-configuring-intreactive-communication-correspondence-management.md#install-compatibility-package) to continue using correspondence management. For information about the differences between interactive communication and correspondence management, see [Interactive Communication Overview](/6-5/forms/using/interactive-communications-overview.md#interactive-communications-vs-correspondence-management).

AEM Forms is a powerful enterprise-class platform. Interactive communication is only one of the capability of AEM Forms. For the complete list of capabilities, see [Introduction to AEM Forms](../../../6-5/forms/using/introduction-aem-forms.md).
...
<p>To use Adobe Analytics with AEM Forms, see <a href="../../../6-5/forms/using/configure-analytics-forms-documents.md" target="_blank">Configuring analytics and reports</a>.<br /> </p>
-->
...
* [Correspondence management overview](/6-5/forms/using/interactive-communications-overview.md)  

* [Create an interactive communication](../../../6-5/forms/using/create-interactive-communication.md)  

* [Create a correspondence management letter](../../../6-5/forms/using/create-letter.md)
