...
uuid: 42346a5a-abff-449f-ab50-bc32e43e408d
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: integrations
discoiquuid: eaac8ce9-8b43-4faa-a2da-fd314f14817e
index: y
internal: n
snippet: y
---
...
For detailed steps, see [Configuring analytics and reports for adaptive forms](../../../6-5/forms/using/configure-analytics-forms-documents.md).

**Configure Target**

To create and run A/B tests for your adaptive forms, configure Target in AEM Forms as described in [Set up and integrate Target in AEM Forms](../../../6-5/forms/using/ab-testing-adaptive-forms.md#p-set-up-and-integrate-target-in-aem-forms-p).
...
For more details about forms analytics reports, see [Viewing and understanding AEM Forms analytics reports](../../../6-5/forms/using/view-understand-aem-forms-analytics-reports.md).
...
For more information about creating an A/B test for an adaptive form, see [A/B testing of adaptive forms](../../../6-5/forms/using/ab-testing-adaptive-forms.md).
