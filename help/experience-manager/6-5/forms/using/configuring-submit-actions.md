...
uuid: b0389108-a996-422f-9f7e-7bbb35596860
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: author
discoiquuid: 959f1148-152a-41a2-9b10-81e942779bd4
index: y
internal: n
snippet: y
---
...
A submit action is triggered when a user clicks the Submit button on an adaptive form. You can configure the submit action on adaptive form. Adaptive forms provide a few out of the box submit actions. You can copy and extend the default submit actions to create you own submit action. However, based on your requirements, you can write and register your own submit action to process data in the submitted form. The submit action can use [synchronous or asynchronous submission](../../../6-5/forms/using/asynchronous-submissions-adaptive-forms.md).
...
>[!CAUTION]
>
>If you [prefill](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md) a form template, form data model, or schema based adaptive form with XML or JSON data complaint to a schema (XML schema, JSON schema, form template, or form data model) that is data does not contain &lt;afData&gt;, &lt;afBoundData&gt;, and &lt;/afUnboundData&gt; tags, then the data of unbounded fields (Unbounded fields are adaptive form fields without [bindref](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md) property) of the adaptive form is lost.

You can write a custom submit action for adaptive forms to fulfil your use case. For more information, see [Writing custom Submit action for adaptive forms](../../../6-5/forms/using/custom-submit-action-form.md).
...
<p>For more information, see <a href="../../../6-5/forms/using/form-submission-receipt-via-email.md" target="_blank">Sending a form submission acknowledgement via email</a>.</p>
-->
...
<p>For more information about configuring the Email PDF action and submit action, see <a href="../../../6-5/forms/using/form-submission-receipt-via-email.md" target="_blank">Sending a form submission acknowledgement via email</a>.</p>
-->
...
For information about how to configure the Submit to forms workflow submit action, see [Submitting and processing your form data using forms workflows](../../../6-5/forms/using/submit-form-data-livecycle-process.md).
...
For information about form data model, see [AEM Forms Data Integration](../../../6-5/forms/using/data-integration.md).

## Forms Portal Submit Action {#forms-portal-submit-action}

The **Forms Portal Submit Action** option makes form data available through an AEM Forms portal.

For more information about the Forms Portal and submit action, see [Drafts and submissions component](../../../6-5/forms/using/draft-submission-component.md).
...
Before using the **Invoke an AEM Workflow** submit action, [configure the AEM DS settings](../../../6-5/forms/using/configuring-the-processing-server-url-.md). For information about creating an AEM Workflow, see [Form-centric workflows on OSGi](../../../6-5/forms/using/aem-forms-workflow.md).
...
For more information, see [Customizing Pages shown by the Error Handler](/6-5/sites/developing/using/customizing-errorhandler-pages.md).
