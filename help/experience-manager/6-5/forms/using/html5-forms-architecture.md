...
uuid: 55a95def-ae29-4a39-9c13-408613458475
contentOwner: robhagat
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: hTML5_forms
discoiquuid: 65be0ed8-afd5-45d4-abe7-8bdd2031afea
index: y
internal: n
snippet: y
---
...
For details on REST endpoint and supported request parameters, see [Rendering Form Template](/6-5/forms/using/rendering-form-template.md).
...
When a user submits the form, the browser sends state of form in JSON format to the [submit service proxy](../../../6-5/forms/using/service-proxy.md); then the submit service proxy generates a data XML using JSON data and submits that data XML to submit endpoint.

## Components {#components}

You require AEM Forms add-on package to enable HTML5 forms. For information about installing AEM Forms add-on package, see [Installing and configuring AEM Forms](../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md).
...
You can configure the cache size or disable the cache using configuration service. You can also enable debugging using Debug Options parameter. More information about debugging forms can be found at [Debugging HTML5 forms](/6-5/forms/using/debug.md).
...
For more details, see the [Form Bridge](/6-5/forms/using/form-bridge-apis.md) article.
...
For more details on widgets and the corresponding contracts, see [Custom Widgets for HTML5 forms](/6-5/forms/using/introduction-widgets.md).
...
For more details on default styling and classes, see [Introduction to styles](/6-5/forms/using/css-styles.md).
...
For more details on creating custom profiles, see [Creating a Custom Profile](/6-5/forms/using/custom-profile.md).   
[**Contact Support**](https://www.adobe.com/account/sign-in.supportportal.html)

<!--
<related-links>
<a href="../../../6-5/forms/using/html5-forms-architecture.md">Architecture of HTML5 forms</a>
<a href="../../../6-5/forms/using/feature-differentiation-html5-forms-pdf-forms.md">Feature differentiation between HTML5 forms and PDF Forms</a>
<a href="../../../6-5/forms/using/introduction.md">Introduction to HTML5 forms</a>
<a href="../../../6-5/forms/using/Best-practices-for-HTML5-forms.md" target="_blank">Best practices for HTML5 forms</a>
</related-links>
-->
