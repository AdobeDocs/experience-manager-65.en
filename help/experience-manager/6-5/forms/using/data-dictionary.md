...
uuid: 6e897a3b-310a-4eaf-827c-c802a720a850
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: correspondence-management
discoiquuid: edfa89d4-4285-4bbb-bc97-ebb203ad1815
index: y
internal: n
snippet: y
---
...
1. In the Properties screen, add the following:
   ...
   <note>
   <p>Do not use underscore (_) in a data dictionary name. Using underscore in data dictionary name may result in data binding related errors when you create a letter that refers to the data dictionary. For more information, see <a href="/6-5/forms/using/cm-troubleshooting.md#main-pars_accordion_container" target="_blank">Correspondence Management troubleshooting</a>.</p>
   </note>
   -->
