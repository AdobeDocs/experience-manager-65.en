...
uuid: 865f5048-530d-4a01-9a88-919ad4adfba2
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: publish
discoiquuid: 1f431725-94f5-4062-974d-d895de365aa0
index: y
internal: n
snippet: y
---
...
The link component is a member of the Document Services category. Ensure that the Document Services category is visible in the AEM components browser. If the category is not listed, follow the steps listed at [Enabling forms portal components](/6-5/forms/using/enabling-forms-portal-components.md).
