...
uuid: 06205b98-fe9e-45ac-83df-84a8eb6fd576
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: author
discoiquuid: 5e6c954b-544c-49ae-a0b9-4a6753dadb3e
index: y
internal: n
snippet: y
---
...
1. Complete the remaining steps to create the form template. For more information, see [Creating a custom adaptive form template](../../../6-5/forms/using/custom-adaptive-forms-templates.md).
...
<!--
<related-links>
<a href="../../../6-5/forms/using/introduction-forms-authoring.md" target="_blank">Introduction to authoring forms</a>
<a href="../../../6-5/forms/using/creating-adaptive-form.md" target="_blank">Creating an adaptive form</a>
<a href="/6-5/forms/using/enabling-eSign-your-adaptive-forms.md" target="_blank">Enabling eSign services in adaptive forms</a>
</related-links>
-->
