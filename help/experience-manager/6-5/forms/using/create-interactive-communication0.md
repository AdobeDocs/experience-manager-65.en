...
uuid: d0ecb380-a33a-4c87-aa1d-db8ed7e9dbd1
contentOwner: anujkapo
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 0d6e8cc2-9f94-4cfc-8e8d-98db1e118db2
index: y
internal: n
snippet: y
---
...
**Print template:** [create_first_ic_print_template](../../../6-5/forms/using/create-templates-print-web.md)

**Form Data Model:** [FDM_Create_First_IC](../../../6-5/forms/using/create-form-data-model0.md)

**Document Fragments:** [bill_details_first_ic, customer_details_first_ic, bill_summary_first_ic, summary_charges_first_ic](../../../6-5/forms/using/create-document-fragments.md)

**Layout Fragments:** [table_lf](../../../6-5/forms/using/create-templates-print-web.md)
...
**Web template:** [Create_First_IC_Web_Template](../../../6-5/forms/using/create-templates-print-web.md)
...
1. Tap **Edit** to open the Interactive Communication in the right pane.
1. Execute steps 6 - 15 of [Create Interactive Communication for Print channel](../../../6-5/forms/using/create-interactive-communication0.md#create-interactive-communication-for-print-channel) section.
...
1. Repeat steps 13 - 18 of [Create Interactive Communication for Web channel](../../../6-5/forms/using/create-interactive-communication0.md#create-interactive-communication-for-web-channel) to insert the **Pay Now** and **Subscribe** hyperlinks in the Web channel of the Interactive Communication.
