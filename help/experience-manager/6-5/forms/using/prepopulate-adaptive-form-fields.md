...
uuid: 5bf2305b-3a90-4420-aa10-0b6d5be915fc
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: develop
discoiquuid: 1b8686af-34f8-4102-98df-e6132a862a2d
index: y
internal: n
snippet: y
---
...
* For adaptive forms using the [XFA form template](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md), use the prefill XML compliant with the data schema of the XFA template.
* For adaptive forms using [XML schema](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md#main-pars-header-3), use the prefill XML compliant with the XML schema structure.
* For adaptive forms using [JSON schema](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md#json-schema-based-adaptive-forms), use the prefill JSON compliant with the JSON schema.
* For adaptive forms using FDM schema, use the prefill JSON compliant with FDM schema.
* For adaptive forms with [no form model](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md#p-adaptive-form-with-no-form-model-p), there is no bound data. Every field is an unbound field and is prefilled using the unbound XML.
...
For adaptive forms based on JSON schema, the structure of prefill JSON and submitted JSON is described below. For more information, see [Creating adaptive forms using JSON schema](../../../6-5/forms/using/adaptive-form-json-schema-form-model.md).
...
* SERVICE_NAME refers to the name of the OSGI prefill service. Refer [Create and run a prefill service](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md#create-and-run-a-prefill-service).
...
* [Download the boilerplate package](../../../6-5/forms/using/prepopulate-adaptive-form-fields.md#main-pars-download-section-711716493)  
...
<!--
<related-links>
<a href="../../../6-5/forms/using/creating-accessible-adaptive-forms.md" target="_blank">Introduction to authoring adaptive forms</a>
