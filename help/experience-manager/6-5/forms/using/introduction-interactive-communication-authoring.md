...
uuid: 4e5556af-bb9d-47b4-b18e-7e85a981ff81
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: interactive-communications
discoiquuid: 6a16020c-fca5-4920-9245-2f0335746e62
index: y
internal: n
snippet: y
---
...
The user interface for authoring [Interactive Communication](/6-5/forms/using/interactive-communications-overview.md) is intuitive and provides the following for authoring print and web channel of the Interactive Communication:
...
When you [create a new or edit an existing Interactive Communication](../../../6-5/forms/using/create-interactive-communication.md), you use the following user interface elements:
...
J. **View SOM Expression: **Lets you view the [SOM expression](../../../6-5/forms/using/using-som-expressions-adaptive-forms.md) for the component.

K: **Group objects in Panel: **Lets you group the components in a panel to be able to perform operations on those components simultaneously. For details, see [Group objects in Panel](../../../6-5/forms/using/create-interactive-communication.md#main-pars-header-1815149576).
...
<a href="/6-5/forms/using/creating-forms-repeatable-sections.md" target="_blank">Creating forms with repeatable sections</a>
<a href="../../../6-5/forms/using/authoring-in-field-help.md" target="_blank">Authoring in-context help for form fields</a>
<a href="../../../6-5/forms/using/synchronizing-adaptive-forms-xfa.md" target="_blank">Synchronizing adaptive forms with XFA form templates</a>
<a href="../../../6-5/forms/using/introduction-form-sequence.md" target="_blank">Introduction to multi-step form sequence</a>
...
<a href="../../../6-5/forms/using/configuring-redirect-page.md" target="_blank">Configuring redirect page</a>
<a href="../../../6-5/forms/using/configuring-submit-actions.md" target="_blank">Configuring the submit action</a>
<a href="/6-5/forms/using/enabling-eSign-your-adaptive-forms.md" target="_blank">Enabling eSign signatures in adaptive forms</a>
<a href="../../../6-5/forms/using/layout-capabilities-adaptive-forms.md" target="_blank">Layout capabilities of adaptive forms</a>
<a href="../../../6-5/forms/using/custom-adaptive-forms-templates.md" target="_blank">Creating a custom adaptive form template</a>
</related-links>
</draft-comment>
-->
