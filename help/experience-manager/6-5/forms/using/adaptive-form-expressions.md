...
uuid: 9acaa95d-9e13-4628-b279-c7db21dcf774
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: develop
discoiquuid: ee065e88-9379-44c7-b8dd-17c38bc70a24
index: y
internal: n
snippet: y
---
...
Repeating panels are instances of a panel that are added or removed dynamically, using scripting API or pre-populated data. For detailed information about using repeating panel, see [creating forms with repeatable sections](/6-5/forms/using/creating-forms-repeatable-sections.md).
...
* ** [Access expressions](../../../6-5/forms/using/adaptive-form-expressions.md#main-pars-header-4)**: to enable/disable a field.
* ** [Calculate expressions](../../../6-5/forms/using/adaptive-form-expressions.md#p-calculate-expression-p)**: to auto-compute value of a field.
* ** [Click expression](../../../6-5/forms/using/adaptive-form-expressions.md#p-click-expression-p)**: to handle actions on click event of a button. 
* ** [Initialization Script](../../../6-5/forms/using/adaptive-form-expressions.md#p-initialization-script-p):** perform an action on initialization of a field.  

* ** [Options expression](../../../6-5/forms/using/adaptive-form-expressions.md#p-options-expression-p)**: to dynamically fill a drop-down list.
* [**Summary expression**](#summary): to dynamically compute the title of an accordion.
* ** [Validate expressions](../../../6-5/forms/using/adaptive-form-expressions.md#p-validate-expression-p)**: to validate a field.
* ** [Value Commit Script](../../../6-5/forms/using/adaptive-form-expressions.md#p-value-commit-script-p):** to change the components of a form after the value of a field is changed.  

* ** [Visibility expression](../../../6-5/forms/using/adaptive-form-expressions.md#p-visibility-expression-p)**: to control visibility of a field and panel.
* ** [Step completion expression](../../../6-5/forms/using/adaptive-form-expressions.md#p-step-completion-expression-p)**: to prevent a user from going to next step of a wizard.
...
Whenever the value of **marital_status** field changes, the expression is retriggered. You can also populate the dropdown from a REST service. For detailed information, see [Dynamically populating dropdowns](../../../6-5/forms/using/dynamically-populate-dropdowns.md).
...
<!--
<related-links>
<a href="../../../6-5/forms/using/adaptive-form-xml-schema-form-model.md" target="_blank">Creating adaptive forms using XML Schema</a>
<a href="../../../6-5/forms/using/creating-accessible-adaptive-forms.md" target="_blank">Creating accessible adaptive forms</a>
</related-links>
-->
