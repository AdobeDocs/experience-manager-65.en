...
uuid: 45e0c5d6-3495-4b20-8b6f-114e88d147cb
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: develop
discoiquuid: a343245b-48fc-4b95-ab9b-cf03eaf50043
noindex: true
index: y
internal: n
snippet: y
...
* Ensure AEM Forms cloud service is configured to use Adobe Sign. For details, see [Integrate Adobe Sign with AEM Forms](../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md).
...
1. [Edit adaptive form properties for Adobe sign](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)
1. [Add Adobe Sign fields to an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-868561487)
1. [Enable Adobe Sign for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
1. [Select Adobe Sign Cloud Service for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)  

1. [Add Adobe Sign Signers to an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
1. [Select Submit Action for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header)
...
[Create an adaptive form for Adobe Sign](../../../6-5/forms/using/working-with-adobe-sign.md#create-an-adaptive-form-for-adobe-sign) describes the steps to create a basic adaptive form. See [Creating an adaptive form](../../../6-5/forms/using/creating-adaptive-form.md) for other options available while creating a adaptive form.
...
1. In the ****[!UICONTROL Basic]**** tab:
    ...
    1. Select the [configuration container](../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) created while configuring Adobe Sign with AEM Forms.
...
1. In the ****[!UICONTROL Basic]**** tab, select the [configuration container](../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) created while configuring Adobe Sign with AEM Forms.
...
1. Select a cloud service from the already configured list of Adobe Sign Cloud Services.
   ...
   If the **Adobe Sign Cloud Service** list is empty, follow the [Configure Adobe Sign with AEM Forms](../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md) artilce to configure the service. 
...
1. [Add Signers to an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) and tap the Done ![](assets/aem_6_3_forms_save.png) icon to save the changes.
...
After [editing adaptive form properties for Adobe sign](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-46741052), perform the following steps to add cloud signature field to an adaptive form:
...
1. Tap the **Adobe Sign Field** ![](assets/aem_6_3_adobesign.png) icon. It displays options to select and add Adobe Sign fields.
    ...
    * [Enable Adobe Sign for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
    * [Select Adobe Sign Cloud Service for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)  
    
    * [Add Adobe Sign Signers to an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
    * [Select Submit Action for an adaptive form](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. [Add and configure the Signature Step component](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828).
1. [Add the Summary Step component](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-473098029).
...
1. Select the newly added Signature step component and tap the **Configure ** ![](assets/configure.png) icon. It opens properties browser and displays Signature step properties. Configure the following properties:
    ...
    * **Use legacy E-sign component**: If you are using the respective adaptive form in [AEM Forms Workspace](../../../6-5/forms/using/introduction-html-workspace.md), AEM Forms app, or the underlying adaptive form has legacy e-sign component, select the **Use legacy E-sign component** option.  
...
**Ans:** Yes, you can use text tags in a text component to add Adobe Sign fields to a [Document of Record](../../../6-5/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md) (Auto generated document of record option only) enabled adaptive form. To learn about the procedure and rules to create a text tag, see [Adobe Sign Documentation](https://helpx.adobe.com/sign/help/text-tags.html). Also note, Adaptive forms has a limited support for text tags. You can use the text tags to create only those fields that [Adobe Sign Block](../../../6-5/forms/using/working-with-adobe-sign.md#main-pars-header-1373840282) supports.
...
* Check the [configuration of Adobe Sign cloud service](../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md) used in the adaptive form. 
...
* [Using Adobe Sign with AEM Forms (Video)  
  ](/kt/forms/using/adobe-sign-integration-feature-video.md)

<!--
<related-links>
<a href="../../../6-5/forms/using/adobe-sign-integration-adaptive-forms.md">Integrate Adobe Sign with AEM Forms</a>
</related-links>
-->
