...
<!--
<related-links>
<a href="../../../6-5/forms/using/custom-layout-components-forms.md" target="_blank">Creating custom layout components for adaptive forms</a>
...
<a href="../../../6-5/forms/using/import-export-forms-templates.md" target="_blank">Importing and exporting adaptive forms and templates</a>
<a href="/6-5/forms/using/change-applied-template-adaptive-form.md" target="_blank">Changing the template applied to an adaptive form</a>
</related-links>
-->
