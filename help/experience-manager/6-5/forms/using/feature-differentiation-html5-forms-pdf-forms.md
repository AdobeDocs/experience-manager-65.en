...
uuid: 50b8578d-f1d7-4709-ac9d-7ef30e7df263
contentOwner: robhagat
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: hTML5_forms
discoiquuid: dd36e20b-01c7-4a7e-93a5-65bba0ac2643
index: y
internal: n
snippet: y
---
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   ...
   <td>Supports the most commonly used XFA script constructs. For details list of supported constructs, see <a href="/6-5/forms/using/scripting-support.md">scripting support</a>.</td> 
   <td>Supports all XFA script constructs.</td> 
  </tr>
  <tr>
   <td>Acrobat Script APIs </td> 
   <td>HTML5 forms support most commonly used APIs. For details, see <a href="/6-5/forms/using/scripting-support.md">scripting support</a>.</td> 
...
Follow the best practices to enable a form template for HTML5 renditions and ensure that the behavior and appearance of HTML5 forms and XFA-based PDF is consistent. For detailed list of best practices, see [Best practices to design an HTML5 form.](/6-5/forms/using/best-practices-design-html5-forms.md)
