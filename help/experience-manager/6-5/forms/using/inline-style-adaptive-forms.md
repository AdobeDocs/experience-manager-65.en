...
uuid: 8ef0f5ee-857d-4b21-91a5-e2d07ac4064a
products: SG_EXPERIENCEMANAGER/6.5/FORMS
topic-tags: author
discoiquuid: c99846b0-c785-4750-9138-e15338a17037
index: y
internal: n
snippet: y
---
...
You can define the overall appearance and style of an adaptive form by specifying styles using [theme editor](../../../6-5/forms/using/themes.md). Also, you can apply inline CSS styles to individual adaptive form components and preview the changes on the fly. Inline styles override styling provided in the theme.
...
<note>
<p>You can only style the appearance of the label. To change lable text, use the Title propertly of the text box in the edit mode. For more information, see <a href="../../../6-5/forms/using/introduction-forms-authoring.md#page-toolbar" target="_blank">Page Toolbar</a>. </p>
</note>
-->
