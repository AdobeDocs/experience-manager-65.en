...
uuid: a81f3669-4f5a-4b9b-9f59-9b89399a5a04
contentOwner: admin
content-type: reference
geptopics: SG_AEMFORMS/categories/managing_services
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: c55d6895-9f83-4ce9-b045-dc6f274249a4
index: y
internal: n
snippet: y
---
...
1. Stop the service before changing it. (See [Starting and stopping services](/6-5/forms/using/admin-help/starting-stopping-services.md#starting_and_stopping_services).)
...
1. If the service has an Endpoints tab, use it to change the endpoint settings. See [Managing Endpoints](/6-5/forms/using/admin-help/topics/managing-endpoints.md).
...
The Watched Folder service ( `WatchedFolder`) configures attributes that are common for all watched folder endpoints. It also provides default values for watched folder endpoints. (See [Configuring watched folder endpoints](../../../../6-5/forms/using/admin-help/configuring-watched-folder-endpoints.md#configuring-watched-folder-endpoints).) It is not invoked by external client applications or used in processes created in Workbench.
...
If the path is not absolute but relative, the folder is created inside the watched folder. For more information about file patterns, see [About file patterns](../../../../6-5/forms/using/admin-help/configuring-watched-folder-endpoints.md#about-file-patterns).
