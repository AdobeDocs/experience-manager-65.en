...
uuid: cac3b4c4-5ad3-4213-b594-11af25298ff1
contentOwner: anujkapo
products: SG_EXPERIENCEMANAGER/6.5/FORMS
content-type: reference
topic-tags: Configuration
discoiquuid: 4c640afc-9f6e-4d0f-86fa-0832c735e775
index: y
internal: n
snippet: y
---
...
You can [create groups](../../../6-5/sites/administering/using/user-group-ac-admin.md#group-administration) and assign policies and [users](../../../6-5/sites/administering/using/user-group-ac-admin.md#user-administration) to the groups in AEM. These policies control privileges of the users that are part of the group.

Once you install [AEM Forms add-on package](../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md), the groups mentioned in this article, such as forms-user and forms-power-user, are automatically available for assignment. The following table lists the tasks a user can perform for AEM Forms on OSGi based on the group assignments:
