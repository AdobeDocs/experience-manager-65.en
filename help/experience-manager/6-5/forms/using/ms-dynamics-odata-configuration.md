...
uuid: e4046ab2-3c81-41ce-8cfb-b82a95bf25a6
topic-tags: integration
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: 0de68672-a2e3-465e-84eb-2c9ed0b1a8ab
index: y
internal: n
snippet: y
---
...
* Installed the [AEM Forms add-on package](../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md)
...
* [Registered the application for Microsoft Dynamics online service with Microsoft Azure Active Directory](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/developer/walkthrough-register-dynamics-365-app-azure-active-directory). Take a note of the values for the client ID (also referred to as application ID) and client secret for the registered service. These values are used while [configuring cloud service for your Microsoft Dynamics service](../../../6-5/forms/using/ms-dynamics-odata-configuration.md#configure-cloud-service-for-your-microsoft-dynamics-service).
...
For more information about creating and using form data model in business workflows, see [Data Integration](../../../6-5/forms/using/data-integration.md).
