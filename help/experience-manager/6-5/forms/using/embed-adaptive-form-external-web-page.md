...
uuid: 9a8f8fb0-db82-452e-aa0c-7e1c6bfdcf78
products: SG_EXPERIENCEMANAGER/6.3/FORMS
topic-tags: author
discoiquuid: 67546760-d13e-418f-9897-9e40efa61221
index: y
internal: n
snippet: y
---
...
1. In the embedded code:
    ...
    * Replace *options.dataRef* with attributes to pass with the URL. You can use the dataref variable to [prefill an adaptive form](/6-4/forms/using/prepopulate-adaptive-form-fields.md). 
