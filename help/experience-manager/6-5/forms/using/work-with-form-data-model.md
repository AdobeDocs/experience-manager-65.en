...
uuid: 22d8a35b-72c5-4d52-86b3-140f876381a1
topic-tags: integration
products: SG_EXPERIENCEMANAGER/6.5/FORMS
discoiquuid: fefcb5bb-e9e2-475f-9908-7669a8d9d942
index: y
internal: n
snippet: y
---
...
* [AEM Forms Data Integration](/6-4/forms/using/data-integration.md)
* [Configure data sources](/6-4/forms/using/configure-data-sources.md)
* [Create form data model](/6-4/forms/using/create-form-data-models.md)
...
1. Tap ![](assets/aem_6_3_edit.png) for the read service argument to [bind the argument to a User Profile Attribute, Request Attribute, or Literal value](../../../6-5/forms/using/work-with-form-data-model.md#main-pars-header-2140694395) and specify the binding value.
...
Next, you can use the sample data to prefill and test interactive communications based on the form data model. For more information, see [Use form data model](/6-4/forms/using/using-form-data-model.md).
...
You have a working form data model that is now ready for use in adaptive forms and interactive communications workflows. For more information, see [Use form data model](/6-4/forms/using/using-form-data-model.md).
