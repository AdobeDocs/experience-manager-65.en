...
uuid: c083f125-4499-4afc-823b-0a5c53a2f68f
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/FORMS
geptopics: SG_AEMFORMS/categories/jee
discoiquuid: d0e98986-10d2-4413-84fc-5bfa501e7f8b
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>* For a complete list of exceptions to supported server platforms, see [Exceptions to supported server platforms](../../../6-5/forms/using/AEM-forms-JEE-supported-platforms.md#p-exceptions-to-supported-server-platforms-p).
...
<table border="0" cellpadding="0"> 
 <tbody> 
  ...
  <tr> 
   <td>Oracle</td> 
   <td><p>Oracle Database 12.2.0.1.0 JDBC driver</p> <p>ojdbc8.jar (version 12.2.0.1.0)<br /> </p> </td> 
...
* Cluster-based installations do not support TarMK persistence. For information about supported persistence, see [Choosing a persistence type for an AEM Forms installation](/6-5/forms/using/choosing-persistence-type-for-aem-forms.md).
* AEM Forms on JEE supports various third-party software as per our [Third-party software support Policy](../../../6-5/forms/using/AEM-forms-JEE-supported-platforms.md#p-third-party-patch-support-policy-p).
...
* For the list of removed or updated platforms, see [AEM 6.5 Forms New Feature Summary](../../../6-5/forms/using/whats-new.md) document.
