...
uuid: 450846b6-c230-4657-8348-410314a4bc46
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: e-commerce
content-type: reference
discoiquuid: 3e7f2d57-aa7c-4931-b1da-bdb57b9e744b
index: y
internal: n
snippet: y
---
...
* [Administering (generic)](../../../../6-5/sites/administering/using/generic.md)
* [SAP Commerce Cloud](/6-5/sites/administering/using/hybris.md)
* [Salesforce Commerce Cloud](/6-5/sites/administering/using/demandware.md)
* [Magento](/6-5/sites/administering/using/magento.md)
...
The [Concepts](../../../../6-5/sites/administering/using/concepts.md) section covers the framework in more detail, but the following provides a high-level, high-speed view of the framework:
