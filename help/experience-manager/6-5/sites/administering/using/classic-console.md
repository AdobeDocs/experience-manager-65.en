...
uuid: c6827aec-759f-4a66-8b2e-528349962474
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: content
content-type: reference
discoiquuid: f8e4af9a-b58d-4d7f-8a8f-062beadff299
index: y
internal: n
snippet: y
---
...
The Touch-optimized UI Tagging Console is [here](/6-5/sites/administering/using/tags.md#tagging-console).
...
To add a new language to the dialog, please refer to the section [Adding a New Language to the Edit Tag Dialog](/6-5/sites/developing/using/building.md#adding-a-new-language-to-the-edit-tag-dialog) in the **Tagging for Developers** section.
...
In general, the language of the tag is taken from the page language if the page language is available. When the [ `tag` widget](/6-5/sites/developing/using/building.md#tagging-on-the-client-side) is used in other cases (for example in forms or in dialogs), the tag language depends on the context.
