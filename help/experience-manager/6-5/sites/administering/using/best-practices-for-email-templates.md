...
uuid: f76565f9-a398-42fe-903a-9ba2fb720a50
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: integration
content-type: reference
topic-tags: best-practices
discoiquuid: cb752ede-1100-49d9-8a67-e0137dc6c626
index: y
internal: n
snippet: y
---
...
There are currently [seven components available for use inside campaign templates](../../../../6-5/sites/authoring/using/adobe-campaign-components.md). These components are all based on the Adobe markup language **HTL**.
...
These components are described in detail in [Adobe Campaign components](../../../../6-5/sites/authoring/using/adobe-campaign-components.md).
