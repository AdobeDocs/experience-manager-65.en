...
uuid: 38dd3886-598c-4b49-8e44-95d03011dc8d
contentOwner: jsyal
discoiquuid: 08cc5d77-8cfc-4f97-b646-8f5d3c1c1008
index: y
internal: n
snippet: y
---
...
* [Preparing content for translation](/6-5/sites/administering/using/tc-prep.md)
* [Managing translation projects](/6-5/sites/administering/using/tc-manage.md)
...
You can opt into usage statistics collection by using either the Touch UI or the Web Console. For detailed instructions, see [Opting into aggregated usage statistics collection](../../../../6-5/sites/deploying/using/opt-in-aggregated-usage-statistics.md).
...
Please refer to [Understanding Reasons to Upgrade AEM](/kt/platform-repository/using/upgrade-aem-article-understand.md) that describes high-level breakdown of key features for customers considering upgrading to the latest version of Adobe Experience Manager.
...
To setup and configure Asset Insights for Experience Manager deployed via Adobe Activation (DTM), please refer to [Set up Asset Insights with AEM Assets](/kt/assets/using/asset-insights-tutorial-setup.md).

#### How to customize admin consoles? {#how-to-customize-admin-consoles}

AEM provides various mechanisms to enable you to customize the consoles and the page authoring functionality of your authoring instance. To learn how to create a custom console and customize a default view for a console, please refer to [Customizing the Consoles](../../../../6-5/sites/developing/using/customizing-consoles-touch.md).
...
To learn about search boost/ranking and further implementation information, please refer to [Simple search implementation guide](/kt/sites/using/search-tutorial-develop.md).
...
Refer to [AEM Assets vs. AEM MediaLibrary](../../../../6-5/assets/using/medialibrary.md) for more information.
...
Refer to [Asset Selector](../../../../6-5/assets/using/asset-selector.md) for more information.
...
Refer to [Search Facets](/6-5/assets/using/search-facets.md) to learn more.
