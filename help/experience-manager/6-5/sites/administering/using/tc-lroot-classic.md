...
uuid: edb3afbf-d7a1-4e4f-ade1-81be2633a965
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: site-features
content-type: reference
discoiquuid: 03cf13ee-8226-4166-b89a-b0e68dd4a13d
index: y
internal: n
snippet: y
---
...
The following procedure uses the classic UI to create a language root of a site. For more information, see [Creating a Language Root](/6-5/sites/administering/using/tc-prep.md#creating-a-language-root).
