...
uuid: 70a13989-5257-4b90-9a1a-9d27e91dfd13
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: Security
content-type: reference
discoiquuid: 7f79eba4-350e-4da9-a449-a7ff861f480a
index: y
internal: n
snippet: y
---
...
Equally, a given tree can be marked with an authentication requirement without changing the efective permission setup. The combinations and results are listed in the [Combining CUG Policies and the Authentication Requirement](../../../../6-5/sites/administering/using/closed-user-groups.md#combining-cug-policies-and-the-authentication-requirement) section.
...
>[!NOTE]
>
>Setting the login path property is optional and only needed if the tree which requires authentication cannot fall back to the default or an otherwise inherited login page. See the [Evaluation of Login Path](../../../../6-5/sites/administering/using/closed-user-groups.md#evaluation-of-login-path) below.
...
Finding all nested CUGs that have been defined at a given path irrespective on whether they take effect or not. For more info, see the [Configuration Options](../../../../6-5/sites/administering/using/closed-user-groups.md#configuration-options) section.
...
You also need to configure the [Sling Referrer Filter](../../../../6-5/sites/administering/using/security-checklist.md#the-sling-referrer-filter) with all hostnames that may be used to access AEM; for example, via CDN, Load Balancer, and any others.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    </ul> <p>Also, see <a href="../../../../6-5/sites/administering/using/closed-user-groups.md#configuration-options" target="_blank">Configuration Options</a> below.</p> </td> 
  </tr> 
  <tr> 
...
See the above [Apache Jackrabbit FileVault](../../../../6-5/sites/administering/using/closed-user-groups.md#apache-jackrabbit-filevault) section.
...
>[!NOTE]
>
>If you run into issues, it is possible to set up a specific logger at **DEBUG** level on `com.day.cq.auth.impl.cug` to get the output of the migration tool. See [Logging](/6-5/sites/deploying/using/configure-logging.md) for more information on how to do this.
