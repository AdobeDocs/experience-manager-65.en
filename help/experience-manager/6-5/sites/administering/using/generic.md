...
uuid: ef6187bb-5553-4dcc-8e11-e200dc432b52
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: e-commerce
content-type: reference
discoiquuid: 86a22011-0015-4f9c-ab0d-4214ee3756c5
index: y
internal: n
snippet: y
---
...
* [Products](../../../../6-5/sites/administering/using/concepts.md#products)
* [Product Variants](../../../../6-5/sites/administering/using/concepts.md#product-variants)  

* [Catalog(s)](../../../../6-5/sites/administering/using/concepts.md#catalogs)
* [Promotions](../../../../6-5/sites/administering/using/concepts.md#promotions)
* [Vouchers](../../../../6-5/sites/administering/using/concepts.md#vouchers)
* [Orders](../../../../6-5/sites/administering/using/concepts.md#shopping-cart-and-orders)
* [Proxy Pages](../../../../6-5/sites/administering/using/concepts.md#proxy-pages)
...
Before creating products you need to define a [scaffold](/6-5/sites/authoring/using/scaffolding.md). This specifies the fields you need to define the products and how they are edited.
...
1. Specify:
    ...
    * **Importer** 
      The importer for the specific [commerce provider](../../../../6-5/sites/administering/using/concepts.md#commerce-providers), by default `Geometrixx`.  
...
1. Specify:
    ...
    * **Commerce Provider** 
      The importer for your [commerce provider](../../../../6-5/sites/administering/using/concepts.md#commerce-providers); by default Geometrixx.  
...
>[!NOTE]
>
>The standard product management is basic, because the Geometrixx-Outdoors product set has been kept basic. The complexity is based on the product [scaffolding](/6-5/sites/authoring/using/scaffolding.md), so with your own product scaffolding it is possible to achieve more sophisticated editing.
...
1. The wizard will open. Use the **Basic** and **Product Tabs** to enter the [product attributes](../../../../6-5/sites/administering/using/concepts.md#product-attributes) for the new product or product variant.
...
>
>This means that, by default, they are blocked by the [dispatcher](/dispatcher/using/dispatcher-configuration.md), so configure as required.
...
1. Using either:
    ...
    * [selection mode](../../../../6-5/sites/authoring/using/basic-handling.md#navigatingandselectionmode)

   Select the **View Product Data** icon:

   ![](do-not-localize/chlimage_1-2.png)

1. The [product attributes](../../../../6-5/sites/administering/using/concepts.md#product-attributes) will be shown. Use **Edit** and **Done** to make any changes.
...
1. Select the asset you want to add.
   ...
   >[!NOTE]
   >
   >The assets you can select are from [Assets](/aem-previous-versions.md#assets).
...
1. Using either:
   ...
   ![](do-not-localize/chlimage_1-5.png) ![](do-not-localize/chlimage_1-6.png)
...
1. Drag and drop an image in the component from the [assets browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#assetsbrowsertouchoptimizedui).
1. You can either:
...
1. Click the shape.
1. Clicking the browse icon opens the [Asset Picker](../../../../6-5/assets/using/asset-selector.md#usingassetpicker).
...
1. Switch to [preview](../../../../6-5/sites/authoring/using/editing-content.md#previewingpagestouchoptimizedui) mode.
...
>[!NOTE]
>
>The following example deals with a promotion held directly in a [campaign](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md), this is used for vouchers.
>
...
1. The wizard will open. Use the **Basic**, **Content**, **Payment** and **Fulfilment** tabs**** to enter the [information about the new order](../../../../6-5/sites/administering/using/concepts.md#order-information).  
...
1. The [order information](../../../../6-5/sites/administering/using/concepts.md#order-information) will be shown. Use **Edit** and **Done** to make any changes.
