...
uuid: e0c6f69b-efdb-4735-8481-6cf5f85230e4
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: Security
content-type: reference
discoiquuid: 838fac30-5371-4f65-8373-cb9a856a1c14
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>AEM automatically generates user groups for role-assignment (Owner, Editor, Viewer) in [Collections](../../../../6-5/assets/using/managing-collections-touch-ui.md). However, manually adding ACLs for such groups can introduce security vulnerabilities within AEM. Adobe recommends that you avoid adding ACLs manually.
...
Before modifying either permission, be sure you understand how they work and inter-relate. See the CRX documentation to illustrate how AEM WCM [evaluates access rights](../../../../6-5/sites/administering/using/user-group-ac-admin.md#how-access-rights-are-evaluated) and examples on setting up access control lists.
...
With the [**Impersonate** functionality](../../../../6-5/sites/authoring/using/user-properties.md#user-settings) a user can work on behalf of another user.
...
>
>For more information on how to achieve this, see [Permissions in AEM](../../../../6-5/sites/administering/using/security.md#permissions-in-aem).
...
>[!NOTE]
>
>You cannot use the Security console to change the admin password. To change the password for the admin account, use the [Users console](/6-5/sites/administering/using/granite-user-group-admin.md#changing-the-password-for-an-existing-user) that Granite Operations provides. 
>
...
When the deployment is a [publish farm](../../../../6-5/sites/deploying/using/recommended-deploys.md#tarmk-farm), users and groups need to be synchronized among all publish nodes.

To learn about user sync and how to enable it, see [User Sychronization](../../../../6-5/sites/administering/using/sync.md).

## Managing Permissions {#managing-permissions}

>[!NOTE]
>
>Adobe has introduced a new Touch UI based principal view for permissions management. For more details on how to use it, see [this page](../../../../6-5/sites/administering/using/touch-ui-principal-view.md).
