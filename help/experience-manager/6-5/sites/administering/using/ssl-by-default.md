...
uuid: e98288f5-8c92-4ba2-a5c5-5bfc33f526c4
contentOwner: User
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: Security
discoiquuid: afe97899-e5ac-4401-8852-f518799f98c5
index: y
internal: n
snippet: y
---
...
1. Once you enter the credentials, click **Next** in the upper right corner of the page. Then, upload the associated private key and certificate for the SSL connection.
   ...
   >[!NOTE]
   >
   >For info on how to generate a private key and a certificate to use with the wizard, see [this procedure](../../../../6-5/sites/administering/using/ssl-by-default.md#generating-a-private-key-certificate-pair-to-use-with-the-wizard) below.
