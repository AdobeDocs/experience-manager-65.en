...
uuid: a361fca1-dfb0-4387-9fdf-3a77f382815c
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: integration
content-type: reference
discoiquuid: b98fc1b6-f668-43ab-af65-a450d3cd62bf
index: y
internal: n
snippet: y
---
...
>To ensure that your videos play on the page, consult ** [this tutorial](../../../../6-5/sites/authoring/using/default-components-foundation.md#video)** for information about how to transcode video files in AEM.
...
1. [Create an Adobe Analytics configuration and framework](../../../../6-5/sites/administering/using/adobeanalytics.md).
...
1. Select a tracking method:
    ...
    * [Milestones](../../../../6-5/sites/administering/using/adobeanalytics.md)
    * [Non-legacy Milestones](../../../../6-5/sites/administering/using/adobeanalytics.md)
    * [Legacy Milestones](../../../../6-5/sites/administering/using/adobeanalytics.md)
    * [Legacy Seconds](../../../../6-5/sites/administering/using/adobeanalytics.md)
...
1. [Add the framework](../../../../6-5/sites/administering/using/adobeanalytics.md) to the page.
...
1. Map these variables to prop1, prop2 and prop3
   ...
   *The call is similar to the Legacy Milestones call above. Please see the information on pev3 ** [provided there](../../../../6-5/sites/administering/using/adobeanalytics.md)**.*
