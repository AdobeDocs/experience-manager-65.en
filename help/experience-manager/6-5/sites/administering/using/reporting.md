...
uuid: 181f40dc-46a7-4b70-8281-a305c059d975
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: operations
content-type: reference
discoiquuid: a4bfb039-07da-4461-9f83-dbb3cd4029d0
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>In addition to the standard AEM reports that are available out of the box, you can [develop your own (completely new) reports](/6-5/sites/developing/using/dev-reports.md).
...
>* [Workflow report](../../../../6-5/sites/administering/using/reporting.md#workflow-report) gives an overview of the workflows running on your instance.
>
...
>[!NOTE]
>
>The preconfigured reports are not perfomance intensive, but it is still recommended to use daily snapshots on a production environment. If possible run these daily snapshots at a time of day when there is not much activity on your website; this can be defined with the `Daily snapshots (repconf.hourofday)` parameter for **Day CQ Reporting Configuration**; see [OSGI Configuration](/6-5/sites/deploying/using/configuring-osgi.md) for more details on how to configure this.
...
The **Generic** column is available in the User Report so that you can access customized information, usually from the [user profiles](../../../../6-5/sites/administering/using/identity-management.md#profiles-and-user-accounts); for example, [Favorite Color as detailed under Adding Fields to the Profile Definition](../../../../6-5/sites/administering/using/identity-management.md#adding-fields-to-the-profile-definition).
