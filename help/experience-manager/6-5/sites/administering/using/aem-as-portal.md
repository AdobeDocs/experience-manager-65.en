...
uuid: 31b9a36d-b55a-4da0-841c-41402d215e12
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: integration
content-type: reference
discoiquuid: ee3f2f7b-937d-4cab-8b3a-1dd74997b9c6
index: y
internal: n
snippet: y
---
...
>
>See [Configuring OSGi](/6-5/sites/deploying/using/configuring-osgi.md) for full details.
...
1. Use Package Manager to [Upload and install](../../../../6-5/sites/administering/using/package-manager.md#uploading-packages-from-your-file-system) the cq-portlets-components.zip package.
...
1. Configure the portlet, as necessary. For example, you may need to change the URL for the author and publish instances and the URL for the start path. Default configurations are described in [Portlet Preferences](../../../../6-5/sites/administering/using/aem-as-portal.md#portlet-preferences).
