...
uuid: 3e5a11d1-37be-4240-87f2-c7da02b8aa49
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: integration
content-type: reference
discoiquuid: 561f3064-5548-462c-a0df-c3cc8f49c75b
index: y
internal: n
snippet: y
---
...
Use the [Web Console to configure the OSGi bundle](/6-5/sites/deploying/using/configuring-osgi.md#osgi-configuration-with-the-web-console) **Adobe AEM Analytics HTTP Client**. Add the **Data Center URL** for the data center that hosts a report suite for which your AEM pages collect data. 
...
1. 
    ...
    * **Do not add tracking tag to page**: Select this option when you are using Adobe Analytics reports in the [Content Insights](/6-5/sites/authoring/using/content-insights.md) feature, and you are also using [Dynamic Tag Management](/6-5/sites/administering/using/dtm.md) (DTM) with AEM, and the DTM web property has the Adobe Analytics tool installed. In this case, selecting this option prevents two instances of the tracking code being added to pages.
...
To be able to see and use the [Activity Map in the page editor](../../../../6-5/sites/authoring/using/page-analytics-using.md#analyticsvisiblefromthepageeditor), you need to configure:
...
>
>* The videos at [Set up Adobe Anslytics Activity Map with AEM Sites](/kt/sites/using/activity-map-feature-video-setup.md).  
>
...
1. Open the ** [Page Properties](../../../../6-5/sites/authoring/using/editing-page-properties.md)**, either directly from the console, or the page editor.
...
1. Select **Save & Close**.
1. ** [Publish](../../../../6-5/sites/authoring/using/publishing-pages.md)** the page to activate the page and any connected configurations/files.
...
See [Seeing Page Analytics Data](../../../../6-5/sites/authoring/using/page-analytics-using.md) for further details.
...
To configure this OSGi service, you can either use the [Web Console](/6-5/sites/deploying/using/configuring-osgi.md#osgi-configuration-with-the-web-console) or an [osgiConfig node in the repository](/6-5/sites/deploying/using/configuring-osgi.md#osgi-configuration-in-the-repository) (the service PID is `com.day.cq.polling.importer.impl.ManagedPollConfigImpl`).  
