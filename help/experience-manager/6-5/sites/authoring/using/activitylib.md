...
uuid: 1abad5a5-4aa3-4c93-bf04-68127945be22
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 4ab150b9-39dc-4498-83ac-00fb75aedc58
index: y
internal: n
snippet: y
---
...
The Activities console enables you to create, organize, and manage the marketing [activities](/6-5/sites/authoring/using/personalization.md#activities) of your brands:
...
Activities are available in Targeting mode for [authoring targeted content](../../../../6-5/sites/authoring/using/content-targeting-touch.md), where you can also create activities. Activities that you create in Targeting mode appear in the Activities console.
...
>
>See [Prerequisites for Integrating with Adobe Target](../../../../6-5/sites/administering/using/target-requirements.md#securingtheactivitysettings) for detailed information.
...
When you create a brand using the Activities console, it also appears in the [Offers console](../../../../6-5/sites/authoring/using/offerlib.md) where you can create offers for the experiences of your activities.
...
* **Targeting Engine:** Either [AEM](/6-5/sites/authoring/using/personalization.md#aem) or [Adobe Target](/6-5/sites/authoring/using/personalization.md#adobe-target) as the engine for targeted content.
