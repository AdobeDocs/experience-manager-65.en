...
uuid: dc2c89b2-7041-4de7-98f7-88f2345374f8
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 73e3cccd-d9df-47c7-8de8-7408ae1719c9
index: y
internal: n
snippet: y
---
...
1. If you want to drill down further, select the Rail symbol (top left) to open the side panel **Filters & Options**.
   ...
   >    * Your instance as the [Search Forms](/6-5/sites/administering/using/search-forms.md) can be customized (appropriate to the location within AEM).
   >    
   >
