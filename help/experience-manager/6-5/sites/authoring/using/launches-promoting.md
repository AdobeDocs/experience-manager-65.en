...
uuid: cb269b85-ed0e-4991-b4f9-4b98ef7c6bc8
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: f92370d1-0633-46c4-a6a7-f231d8ce52b0
...
>* [Launches - the Order of Events](../../../../6-5/sites/authoring/using/launches.md#launches-the-order-of-events) for further details about automatic promotion and publication.
>
...
1. Open:
    ...
    * the **Sites** console:
        ...
        1. Open the [references rail](../../../../6-5/sites/authoring/using/author-environment-tools.md#showingpagereferences) and select the required source page using [selection mode](../../../../6-5/sites/authoring/using/basic-handling.md) (or select and open the references rail, the order is not important). All references will be shown.
...
To start a workflow automatically when pages are promoted, [configure a workflow launcher](/6-5/sites/administering/using/workflows-starting.md#workflows-launchers) for the package node.
