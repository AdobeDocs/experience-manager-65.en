...
uuid: 8e8c0006-70b3-454b-9846-37eaa20c7bc4
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: ca0f97a0-5e09-45f4-8512-9d35e18f8d3c
...
Page analytics data is displayed in [List View](../../../../6-5/sites/authoring/using/basic-handling.md#list-view) of the Sites console. When the pages are displayed in list format, the following columns are available by default:
...
>[!NOTE]
>
>To change the update period, [configure the import interval](../../../../6-5/sites/administering/using/adobeanalytics-connect.md#configuring-the-import-interval).

1. Open the **Sites** console; for example [http://localhost:4502/sites.html/content](http://localhost:4502/sites.html/content)
1. In the far right of the toolbar, (upper right corner), click or tap the icon to select **List View** (the icon shown will depend on the [current view](../../../../6-5/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources)).  
...
Open [Content Insight](/6-5/sites/authoring/using/content-insights.md) from the Sites console to further investigate page effectiveness.
...
>[!NOTE]
>
>This will be shown if the [Activity Map has been configured](../../../../6-5/sites/administering/using/adobeanalytics-connect.md#configuring-for-the-activity-map) for your website.

>[!NOTE]
>
>Data for the Activity Map is taken from Adobe Analytics.

When your website has been [configured for Adobe Analytics](../../../../6-5/sites/administering/using/adobeanalytics-connect.md), you can use the [mode Activity Map](../../../../6-5/sites/authoring/using/author-environment-tools.md#page-modes) to view relevant data. For example:

![](assets/aa-07.png) 

### Accessing the Activity Map {#accessing-the-activity-map}

After selecting the [Activity Map](../../../../6-5/sites/authoring/using/author-environment-tools.md#page-modes) mode, you will be requested to enter your Adobe Analytics credentials.
