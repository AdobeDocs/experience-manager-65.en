...
uuid: bddcb0a2-885d-4efe-bdbc-b9ae752d8425
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: 0a156877-e694-4f24-8622-2a9f864b7910
index: y
internal: n
snippet: y
---
...
Open the [Content Insight](/6-5/sites/authoring/using/content-insights.md) page to analyze the performance of the page that you are authoring. Configure the reporting period to focus your analysis.
...
1. In the toolbar, click or tap** Analytics and Recommendations**.
   ...
   >[!NOTE]
   >
   >Analytics and Recommendations for a page only appear if you have configured AEM to [integrate with Adobe Analytics](../../../../6-5/sites/administering/using/adobeanalytics-connect.md).
...
The tools for changing the time-related aspects of the reports appear at the top of the Content Insight page. ![](assets/chlimage_1-23.png)
...
When created, the task appears in the user's Tasks list. For information about tasks, see [Track Content Changes Using Task Management](/6-5/sites/administering/using/task-manager.md) and [Working with Tasks](/6-5/sites/authoring/using/task-content.md).
