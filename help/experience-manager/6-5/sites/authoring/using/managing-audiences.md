...
uuid: 22aacb95-d72d-4d41-bbd2-950914f2b512
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 1613610b-f5d4-4965-9cbb-c9bfbf92bca4
index: y
internal: n
snippet: y
---
...
For further detail about creating segments using ContextHub, please see the [Configuring Segmentation with ContextHub](/6-5/sites/administering/using/segmentation.md) documentation.
...
1. Make any edits in the segment editor. See [Client Context](../../../../6-5/sites/administering/using/campaign-segmentation.md) or [ContextHub](/6-5/sites/administering/using/contexthub-config.md) documentation.
