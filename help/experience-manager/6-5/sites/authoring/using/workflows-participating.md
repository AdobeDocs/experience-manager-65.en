...
uuid: 6a3e7898-3e2f-4d0c-be95-d825057da5d1
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: 3cfaac5b-5604-4155-9274-0e1b3bc89025
index: y
internal: n
snippet: y
---
...
* Your [notification](/6-5/sites/authoring/using/inbox.md) indicator (toolbar) will be incremented:

  ![](do-not-localize/wf-57.png)

* The item will be listed in your notification [Inbox](/6-5/sites/authoring/using/inbox.md):
...
1. Open the ** [AEM Inbox](/6-5/sites/authoring/using/inbox.md)**.
...
1. Open the [page for editing](../../../../6-5/sites/authoring/using/managing-pages.md#opening-a-page-for-editing).
...
1. Click/tap on the alert banner to show available actions. Select **Roll back**:
   ...
   ![](assets/screen-shot_2019-03-05at121131.png)
...
* **WORKFLOW INFO**
  ...
  If [Workflow Stages](/6-5/sites/developing/using/workflows.md#workflow-stages) have been configured for the model, you can view the progress according to these:
