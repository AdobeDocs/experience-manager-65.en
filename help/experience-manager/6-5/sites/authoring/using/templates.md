...
uuid: 81406a3a-e4eb-4c8a-8d44-335e35e295b1
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: f5a454e2-bc45-4e88-94eb-eba31dbda1d9
index: y
internal: n
snippet: y
---
...
For detailed information about how editable templates work at a technical level, please see the developer document [Page Templates - Editable](../../../../6-5/sites/developing/using/page-templates-editable.md) for more information.
...
* [Editable Templates](../../../../6-5/sites/authoring/using/templates.md#creatingandmanagingnewtemplates)
...
* Static Templates
    ...
    * They are [provided by your developers](../../../../6-5/sites/developing/using/page-templates-static.md), so they cannot be created or edited by authors.
    ...
    * Use [Design Mode](/6-5/sites/authoring/using/default-components-designmode.md) to persist design properties.
    * Because editing static templates is the exclusive task of a developer, please see the developer document [Page Templates - Static](../../../../6-5/sites/developing/using/page-templates-static.md) for more information.
...
When using a template to [create a new page](../../../../6-5/sites/authoring/using/managing-pages.md#creating-a-new-page) there is no visible difference and no indication between static and editable templates. For the page author, the process is transparent.
...
* [Edit the template](#editingtemplates) to define the:
    ...
    * [Styles](/6-5/sites/authoring/using/style-system.md) - Define the styles to be used with the template and its components.
...
A template folder should be created for your project to hold your project-specific templates. This is an admin task and is described in the document [Page Templates - Editable](../../../../6-5/sites/developing/using/page-templates-editable.md#template-folders).
...
1. Open the **Templates Console** (via **Tools -&gt;** **General**) then navigate to the required folder.
   ...
   >
   >
   >It is recommended best practice to use a [template folder created for your project](../../../../6-5/sites/developing/using/page-templates-editable.md#template-folders).
...
1. Pick a **Template Type**, then select **Next**.
   ...
   >[!NOTE]
   >
   >Template types are predefined template layouts and can be thought of as templates for a template. These are predefined by developers or the system administrator. More information can be found in the developer document [Page Templates - Editable](../../../../6-5/sites/developing/using/page-templates-editable.md#template-type).
...
* Image
    ...
    * Image to be used as a [thumbnail of the template](../../../../6-5/sites/authoring/using/templates.md#template-thumbnail-image) to aid selection such as in the Create Page wizard.
...
1. You can now use your template when [creating a new page](../../../../6-5/sites/authoring/using/managing-pages.md#creating-a-new-page), though you will probably want to [edit the template](#editingatemplate) according to your requirements.
...
1. Open the [Page Properties](../../../../6-5/sites/authoring/using/editing-page-properties.md) for the root page of the branch where you want the template to be available.  
...
1. Under **Template Settings** use **Add field** to specify the path(s) to your template(s).
   ...
   >
   >
   >See [Template Availability](/6-5/sites/developing/using/templates.md#template-availability) - the principles for allowed templates remain the same.
...
* [Layout](#editingatemplatelayout)
  ...
  Here you can predefine the template layout for the required device formats. **Layout** mode for template authoring has the same functionality as the [**Layout** mode for page authoring](/6-5/sites/authoring/using/responsive-layout.md#defining-layouts-layout-mode).
...
* [Styles](/6-5/sites/authoring/using/style-system.md)
  ...
  See the [Style System documentation](/6-5/sites/authoring/using/style-system.md) for more information.
...
* **Add components**
  ...
  >[!NOTE]
  >
  >Although not identical, adding components and assets to a template has many similiarities to similar actions when [page authoring](../../../../6-5/sites/authoring/using/editing-content.md).
...
* **Policy & Properties (General)**
  ...
  ***Policy***
  ...
  >[!NOTE]
  >
  >If multiple components of the same type are added as initial content, the same policy applies to all the components. This mirrors the same restriction in [**Design Mode** for static templates](/6-5/sites/authoring/using/default-components-designmode.md).
...
>[!NOTE]
>
>**Initial Content** mode can be thought of edit mode for pages created with that template. Therefore policies are not defined in **Initial Content** mode but rather in [**Structure** mode](../../../../6-5/sites/authoring/using/templates.md#editing-a-template-structure-template-author).
...
* If a container component has been unlocked (in **Structure** mode) then you can add new components to the container (in **Initial Content** mode). Components added in **Initial Content** mode can be moved on or deleted from resulting pages.
  ...
  ![](assets/chlimage_1-49.png) ![](assets/chlimage_1-50.png)
...
You can define the template layout for a range of devices. [Responsive layout](/6-5/sites/authoring/using/responsive-layout.md) for templates operates as it does for page authoring.
...
1. The **Page Design** dialog opens and is divided into two sections:
    ...
    * The left half defines the [page policies](../../../../6-5/sites/authoring/using/templates.md#page-policies)
    * The right half defines the [page properties](../../../../6-5/sites/authoring/using/templates.md#page-properties)
...
Using the **Initial Page Properties** option, you can define the initial [page properties](../../../../6-5/sites/authoring/using/editing-page-properties.md) to be used when creating resultant pages.
