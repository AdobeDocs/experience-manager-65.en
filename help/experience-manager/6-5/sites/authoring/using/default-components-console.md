...
uuid: 5ea0d5bb-7ed1-4870-bb1f-0040a6ca5ebb
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: e453a669-6d3a-43a1-92fc-122a5b7d5d03
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>The Component Console shows all components in the system. The [Component Browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#components-browser) shows components that are available to authors and hides any component groups that begin with a period ( `.`).
...
* **Properties**
  ...
  On the Properties tab you can:
    ...
    * View how the [icon or abbreviation has been defined](/6-5/sites/developing/using/components-basics.md#component-icon-in-touch-ui) for the component.
...
* **Documentation**
  ...
  If the developer has provided [documentation for the component](../../../../6-5/sites/developing/using/developing-components.md#documenting-your-component), it will appear on the **Documentation** tab. If there is no documentation available, the **Documentation** tab will not be shown.
