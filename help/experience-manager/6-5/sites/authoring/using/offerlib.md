...
uuid: f23b9db4-a1bd-4003-8cee-efcafa017187
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 22e985e8-1447-4cb4-be70-6833718cd4ac
index: y
internal: n
snippet: y
---
...
Use the Offers console to create offers that you can [use in activity experiences](../../../../6-5/sites/authoring/using/content-targeting-touch.md). Creating offers in the Offers console saves time when several experiences require the same offer:
...
When you create a brand using the Offers console, it also appears in the [Activities console](../../../../6-5/sites/authoring/using/activitylib.md) where you can add and administer activities for the brand.
...
<p>See <a href="../../../../6-5/sites/authoring/using/search.md">Searching</a> for detailed information.</p>
-->
...
1. Enter your keyword to search for offers. Select from the results.
   ...
   <p>For more information on how to add criteria see <a href="../../../../6-5/sites/authoring/using/search.md">Searching</a>.</p>
   -->
