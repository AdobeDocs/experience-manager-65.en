...
uuid: ad510669-01c5-4855-81a9-bc980b29dc5b
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: e7c5706c-2278-4f28-806d-92cb6dae804f
index: y
internal: n
snippet: y
---
...
* When you use Omnichannel Commerce.
    ...
    * Sharing commerce-related content on [social media](../../../../6-5/sites/developing/using/experience-fragments.md#social-variations) channels at scale
...
1. From the required folder, select **Create** then **Experience Fragment** to open the **Create Experience Fragment** wizard.
   ...
   >[!NOTE]
   >
   >See [Templates for Experience Fragments](../../../../6-5/sites/developing/using/experience-fragments.md#templates-for-experience-fragments) for further details.
...
>[!NOTE]
>
>See [Editing Page Content](../../../../6-5/sites/authoring/using/editing-content.md) for more information on how to use the page editor.

The following example procedure illustrates how to create a teaser for a product:

1. Drag and drop a **Teaser** from the [Components Browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#components-browser).

   ![](assets/xf-05.png)

1. Select ** [Configure](../../../../6-5/sites/authoring/using/editing-content.md#edit-configure-copy-cut-delete-paste)** from the component toolbar.
...
1. Open your fragment for [editing](../../../../6-5/sites/authoring/using/experience-fragments.md#editing-your-experience-fragment).
...
1. Details are shown in all views of the **Experience Fragments** console, with the **List View** including details of an [export to Target](../../../../6-5/sites/administering/using/experience-fragments-target.md):
...
1. When you open the **Properties** of the Experience Fragment:
   ...
   >
   >
   >If you **Open Properties** when editing an Experience Fragment, the appropriate [Page Properties](../../../../6-5/sites/authoring/using/editing-page-properties.md) are shown.
...
>[!NOTE]
>
>Although this is directly available from the browser, [the primary purpose is to allow other applications (for example, third party web apps, custom mobile implementations) to access the content of the Experience Fragment directly, using only the URL](../../../../6-5/sites/developing/using/experience-fragments.md#the-plain-html-rendition).
...
For export to Adobe Target, JSON can also be used. See [Target Integration with Experience Fragments](../../../../6-5/sites/administering/using/experience-fragments-target.md) for full information.
