...
uuid: e41da8ee-9119-4d97-b914-b72f207dc712
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: f26af300-321e-490e-b109-55c4df0b52ba
index: y
internal: n
snippet: y
---
...
>* Keyboard shortcuts are available throughout AEM. In particular when [using consoles](/6-5/sites/authoring/using/keyboard-shortcuts.md) and [editing pages](/6-5/sites/authoring/using/page-authoring-keyboard-shortcuts.md).  
>
...
* ** [Navigation](../../../../6-5/sites/authoring/using/basic-handling.md#navigation-panel)** - Represented by a compass
* ** [Tools](../../../../6-5/sites/authoring/using/basic-handling.md#tools-panel)** - Represented by a hammer
...
<table border="0" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   <td>Assets<br /> </td> 
   <td>These consoles let you import and <a href="/6-5/assets/user-guide.md">manage digital assets</a> such as images, videos, documents and audio files. These assets can then be used by any website running on the same AEM instance. </td> 
  </tr> 
  <tr> 
   <td>Communities</td> 
   <td>This console allows you to create and manage <a href="../../../../6-5/communities/using/sites-console.md">community sites</a> for <a href="../../../../6-5/communities/using/overview.md#engagement-community">engagement</a> and <a href="../../../../6-5/communities/using/overview.md#enablement-community">enablement</a>.</td> 
  </tr> 
  <tr> 
   <td>Commerce</td> 
   <td>This allows you to manage products, product catalogs and orders related to your <a href="../../../../6-5/sites/administering/using/ecommerce.md">Commerce</a> sites.</td> 
  </tr> 
  <tr> 
   <td>Experience Fragments</td> 
   <td>An <a href="../../../../6-5/sites/authoring/using/experience-fragments.md">experience fragment</a> is a stand-alone experience that can be re-used across channels and have variations, saving the trouble of repeatedly copying and pasting experiences or parts of experiences.</td> 
  </tr> 
  <tr> 
   <td>Forms</td> 
   <td>This console allows you to create, manage, and process your <a href="/6-5/forms/user-guide.md">forms and documents</a>.</td> 
  </tr> 
  <tr> 
   <td>Personalization</td> 
   <td>This console provides a <a href="/6-5/sites/authoring/using/personalization.md">framework of tools for authoring targeted content and presenting personalized experiences</a>.</td> 
  </tr> 
  <tr> 
   <td>Projects</td> 
   <td>The <a href="/6-5/sites/authoring/using/touch-ui-managing-projects.md">Projects console gives you direct access to your projects</a>. Projects are virtual dashboards. They can be used to build a team, then give that team access to resources, workflows and tasks, allowing people to work on a common goal. <br /> </td> 
  </tr> 
  <tr> 
   <td>Screens</td> 
   <td><a href="/6-5/screens/using/authoring-screens.md">Screens</a> will allow you to manage all your customer-facing screens, of any size and in any location.</td> 
  </tr> 
  <tr> 
   <td>Sites</td> 
   <td>The Sites consoles let you <a href="../../../../6-5/sites/authoring/using/page-authoring.md">create, view and manage websites</a> running on your AEM instance. Through these consoles you can create, edit, copy, move and delete website pages, start workflows, and publish pages.<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
In the Tools panel, each option in the side panel contains a range of sub-menus. The [Tools consoles](../../../../6-5/sites/administering/using/tools-consoles.md) available here provide access to a number of specialized tools and consoles that help you administer your websites, digital assets and other aspects of your content repository.
...
* [Search](../../../../6-5/sites/authoring/using/search.md)
  ...
  You can also use the [shortcut key](/6-5/sites/authoring/using/keyboard-shortcuts.md) `/` (forward slash) to invoke search from any console.
...
* [Notifications](/6-5/sites/authoring/using/inbox.md)
  ...
  >[!NOTE]
  >
  >Out-of-the-box AEM comes pre-loaded with administrative tasks assigned to the administrator user group. See [Your Inbox - Out-of-the-Box Administrative Tasks](/6-5/sites/authoring/using/inbox.md#out-of-the-box-administrative-tasks) for details.

* [User Properties](../../../../6-5/sites/authoring/using/user-properties.md)

  ![](do-not-localize/screen_shot_2018-03-23at103603.png)

* [Rail selector](../../../../6-5/sites/authoring/using/basic-handling.md#rail-selector)
...
* [Views](../../../../6-5/sites/authoring/using/basic-handling.md#viewingandselectingyourresourcescardlistcolumn)
...
* **Navigation**
  ...
  The first time you navigate the system, [a series of slides introduce AEM navigation](../../../../6-5/sites/authoring/using/basic-handling.md#product-navigation).
...
* **Page Editor**
  ...
  Navigate this overview as you would the [product navigation overview](../../../../6-5/sites/authoring/using/basic-handling.md#product-navigation) when first accessing any console.

  From the [**Page Information** menu you can select **Help**](../../../../6-5/sites/authoring/using/author-environment-tools.md#accessing-help) to show this again at any time.
...
How you [select a resource](../../../../6-5/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources) depends on the view.
...
* Card view displays information cards for each item at the current level. These provide information such as:
    ...
    * If appropriate, when you are required to take action as part of a workflow.
        ...
        * Markers that indicate required actions may be related to entries in your [Inbox](/6-5/sites/authoring/using/inbox.md).

* [Quick actions](#quick-actions) are also available in this view such as selection and common actions such as edit.

  ![](assets/bh-13-1.png)

* You can navigate down the tree by tapping/clicking on cards (taking care to avoid the quick actions) or up again by using the [breadcrumbs in the header](../../../../6-5/sites/authoring/using/basic-handling.md#the-header).
...
* You can navigate down through the tree by tapping/clicking on the resource name and back up by using the [breadcrumbs in the header](../../../../6-5/sites/authoring/using/basic-handling.md#the-header).  
...
>[!NOTE]
>
>[Keyboard shortcuts](/6-5/sites/authoring/using/keyboard-shortcuts.md) are available to quickly switch between rail display options.
...
>
>Refer to the [keyboard shortcuts](/6-5/sites/authoring/using/keyboard-shortcuts.md) for more information.
...
* [View various events](#timelineviewevents) related to a selected item.
    ...
    * The event types can be selected from the drop-down list:
        ...
        * [Versions](../../../../6-5/sites/authoring/using/working-with-page-versions.md)
        * [Workflows](../../../../6-5/sites/authoring/using/workflows-applying.md)

            * with the exception of [transient workflows](/6-5/sites/developing/using/workflows.md#transient-workflows) as no history information is saved for these
...
* Specific consoles have additional functionality. For example, in the Sites console you can:
    ...
    * [Save a version](../../../../6-5/sites/authoring/using/working-with-page-versions.md#creatinganewversiontouchoptimizedui).
    * [Start a workflow](../../../../6-5/sites/authoring/using/workflows-applying.md#startingaworkflowfromtherail).
...
**References** shows any connections to the selected resource. For example, in the **Sites** console [references](../../../../6-5/sites/authoring/using/author-environment-tools.md#showingpagereferences) for pages shows:

* [Launches](../../../../6-5/sites/authoring/using/launches.md#launches-in-references-sites-console)
* [Live copies](/6-5/sites/administering/using/msm-livecopy-overview.md#openingthelivecopyoverviewfromreferences)
* [Language copies](/6-5/sites/administering/using/tc-prep.md#seeing-the-status-of-language-roots)
* Content references:
...
This will open a panel similar to [search](../../../../6-5/sites/authoring/using/search.md) with the appropriate location filters already set, allowing you to further filter the content you wish to view.
