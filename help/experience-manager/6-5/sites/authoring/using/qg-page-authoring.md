...
uuid: d928de9e-a9ee-4342-8fe5-6cf5a6e6b813
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: fd0c689a-8a03-49b4-b361-2390be26e9d5
index: y
internal: n
snippet: y
---
...
* Re-ordering pages in a folder
    ...
    * This can be done in [List View](../../../../6-5/sites/authoring/using/basic-handling.md#list-view). The changes will be applied and be visible in other views.

#### Page Authoring {#page-authoring}

* Navigating Links

    * ***Links are not available for navigation*** when you are in **Edit** mode. To navigate with links you need to [preview the page](../../../../6-5/sites/authoring/using/editing-content.md#previewing-pages) using either:

        * [Preview Mode](../../../../6-5/sites/authoring/using/editing-content.md#preview-mode)
        * [View as Published](../../../../6-5/sites/authoring/using/editing-content.md#view-as-published)

* Versions are not started/created from the page editor; this is now done from the Sites console (via either **Create** or [Timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline) for a selected resource).

>[!NOTE]
>
>There are a number of keyboard shortcuts that can make the authoring experience easier.
>
>* [Keyboard Shortcuts When Editing Pages](/6-5/sites/authoring/using/page-authoring-keyboard-shortcuts.md)
...
1. Open the **Sites** console (using the **Sites** option in the [Global Navigation](../../../../6-5/sites/authoring/using/basic-handling.md#global-navigation) - this is triggered (drop down) when you select the Adobe Experience Manager link (top left).  

1. Navigate down the tree by tapping/clicking on the appropriate page. How the page resources are represented depends on the view you are using - [Card, List, or Column](../../../../6-5/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources):

   ![](assets/screen_shot_2018-03-21at160214.png)

1. Navigate up the tree using [the breadcrumb in the header](../../../../6-5/sites/authoring/using/basic-handling.md#theheaderwithbreadcrumbs), which allows you to return to the selected location:

   ![](assets/qgtap-01.png)

1. You can also [Search](../../../../6-5/sites/authoring/using/search.md) for a page. You can select your page from the results shown.

   ![](assets/qgtap-03.png)

### Creating a New Page {#creating-a-new-page}

To [create a new page](../../../../6-5/sites/authoring/using/managing-pages.md#creating-a-new-page):
...
1. This opens the wizard that will guide you through collecting the information needed when [creating your new page](../../../../6-5/sites/authoring/using/managing-pages.md#creating-a-new-page). Follow the on screen instructions.
...
1. Card View:
    ...
    * Enter selection mode by [selecting the required resource](../../../../6-5/sites/authoring/using/basic-handling.md#viewingandselectingyourresources) with:

        * Mobile device: tap-and-hold
        * Desktop: the [quick action](../../../../6-5/sites/authoring/using/basic-handling.md#quick-actions) - tick icon:
...
[Quick actions](../../../../6-5/sites/authoring/using/basic-handling.md#quick-actions) are available:
...
1. [Open your page for editing](../../../../6-5/sites/authoring/using/managing-pages.md#opening-a-page-for-editing) using the Edit (pencil) icon:
...
1. When the editor opens you can:
    ...
    * [Add a new compenent to your page](../../../../6-5/sites/authoring/using/editing-content.md#inserting-a-component) by:

        * opening the side panel
        * selecting the components tab (the [components browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#components-browser))
    ...
    * [Edit the content of an existing component](../../../../6-5/sites/authoring/using/editing-content.md#edit-configure-copy-cut-delete-paste) on the page:
    ...
    * [Configure the properties of an existing component](../../../../6-5/sites/authoring/using/editing-content.md#component-edit-dialog)

        * Open the component toolbar with either tap or click. Use the **Configure** (wrench) icon to open the dialog.

    * [Move a component](../../../../6-5/sites/authoring/using/editing-content.md#moving-a-component) either:
    ...
    * [Copy (and Paste)](../../../../6-5/sites/authoring/using/editing-content.md#edit-configure-copy-cut-delete-paste) a component:
    ...
    * [Delete](../../../../6-5/sites/authoring/using/editing-content.md#edit-configure-copy-cut-delete-paste) a component:

        * Open the component toolbar with either tap or click, then use the **Delete** icon.

    * [Add annotations](/6-5/sites/authoring/using/annotations.md#annotations) to the page:
    ...
    * [Preview a page](../../../../6-5/sites/authoring/using/editing-content.md#preview-mode) (to see how it will appear in the publish environment)
   ...
   >[!NOTE]
   >
   >To navigate using links in the content you must use [Preview mode](../../../../6-5/sites/authoring/using/editing-content.md#preview-mode).

### Editing the Page Properties {#editing-the-page-properties}

There are two (main) methods of [editing page properties](../../../../6-5/sites/authoring/using/editing-page-properties.md):
...
There are two main methods of [publishing your page](../../../../6-5/sites/authoring/using/publishing-pages.md) (and also of unpublishing):
...
* From the **Sites** console:
    ...
    1. Select the **Quick Publish** icon from either:
        ...
        * [Quick Actions (Card View/Desktop Only)](#quick-actions-card-view-desktop-only) for the approprate resource.
        * The toolbar when your [page has been selected](#selectiingyourpageforfurtheraction) (also gives access to [Publish Later](../../../../6-5/sites/authoring/using/publishing-pages.md#main-pars-title-12)).
...
* Unpublishing a page from the console can only be done via the **Manage Publication** option, which is only available on the toolbar (not via the quick actions).
  ...
  See [Publishing Pages](../../../../6-5/sites/authoring/using/publishing-pages.md#unpublishing-pages) for more information.
...
[Locking a page](../../../../6-5/sites/authoring/using/editing-content.md#locking-a-page) prevents other authors from working on it while you are. The Lock (and Unlock) icon/button can be found:
...
[Quick access to references](../../../../6-5/sites/authoring/using/author-environment-tools.md#references) to/from a page are available in the References Rail.
...
1. Select **References** using the toolbar icon (either before or after [selecting your page](#selecting-your-page-for-further-action)):
   ...
   ![](assets/screen-shot_2019-03-05at114412.png)
...
To create a [version](../../../../6-5/sites/authoring/using/working-with-page-versions.md) of your page:

1. To open the Timeline rail, select ** [Timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline)** using the toolbar icon (either before or after [selecting your page](#selecting-your-page-for-further-action)):
...
1. Tap/click on the up-arrow at the bottom right of the Timeline column to reveal extra buttons, including **Save as Version**.
   ...
   ![](assets/screen-shot_2019-03-05at114600.png)
...
1. Select ** [Timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline)** using the toolbar icon (either before or after [selecting your page](#selecting-your-page-for-further-action)):
