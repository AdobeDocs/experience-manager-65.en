...
uuid: e9625305-42f9-411c-b8e1-c324cfed669d
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: personalization
discoiquuid: f55a26ce-81d8-4976-b4c8-1bbf6623d9b2
index: y
internal: n
snippet: y
---
...
You can use either AEM or Adobe Target as the targeting engine (you must have a valid Adobe Target account to use Adobe Target). If you are using Adobe Target, you must configure the integration first. See [instructions for integrating with Adobe Target](/6-5/sites/administering/using/target.md).

![](assets/chlimage_1-65.png)

The activities and experiences that you see in Target mode reflect the [Activites console](../../../../6-5/sites/authoring/using/activitylib.md):
...
When you add an activity, it also appears in the [Activities console](../../../../6-5/sites/authoring/using/activitylib.md).
...
1. Use the **Brand** drop-down menu to select the brand for which you want to create the activity.
   ...
   >[!NOTE]
   >
   >It is recommended to [create brands through the activities console](../../../../6-5/sites/authoring/using/activitylib.md#creating-a-brand-using-the-activities-console).
   >
   >
...
1. In the **Targeting** engine drop-down menu, select your targeting engine.
    ...
    * If you select **Adobe Target**, you can select a configuration (by default, it is the configuration you provided when you [configured the account](/6-5/sites/administering/using/opt-in.md)) and Activity Type.
    
    * If you are using the AEM/Adobe Campaign integration and are sending targeted content (newsletters), select **Adobe Campaign**. See [Integrating with Adobe Campaign](/6-5/sites/administering/using/campaign.md) for more information.
...
Offers that are [authored on the page](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-a-custom-offer) and used for a single experience are called custom offers. The following image is superimposed on the content of a custom offer:

![](assets/chlimage_1-72.png)

Offers that are [added from an offer library](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-an-offer-from-an-offer-library) are superimposed with the following image:
...
Using the Create step of [the targeting process](../../../../6-5/sites/authoring/using/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings), you can add and remove experiences. In addition, you can duplicate an experience and also rename it.
...
* [Target an existing component](../../../../6-5/sites/authoring/using/content-targeting-touch.md#creating-a-default-offer-by-targeting-an-existing-component). The content becomes the offer of the Default Experience.
* [Add a Target component](../../../../6-5/sites/authoring/using/content-targeting-touch.md#creating-an-offer-by-adding-a-target-component), then add content to the component.

After a component is targeted, you can add offers for each experience:

* [Add custom offers](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-a-custom-offer).
* [Add offers from a library](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-an-offer-from-an-offer-library).

The following tools are available for working with offers:

* [Add a custom offer to an offer library](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-a-custom-offer-to-a-library).
* [Convert a library offer to a custom offer](../../../../6-5/sites/authoring/using/content-targeting-touch.md#converting-a-library-offer-to-a-custom-library).
* [Open a library offer and edit the content](../../../../6-5/sites/authoring/using/content-targeting-touch.md#editing-a-library-offer).
...
Perform the following procedure after [starting the targeting process](../../../../6-5/sites/authoring/using/content-targeting-touch.md#the-targeting-process-create-target-and-goals-settings).
...
See [Configuring Target component options](../../../../6-5/sites/authoring/using/content-targeting-touch.md#configuring-target-component-options) for information on customizing this component.

>[!NOTE]
>
>Offers that you create using the [Offers console](../../../../6-5/sites/authoring/using/offerlib.md) can also contain several components. These offers belong to an offer library and can be used for multiple experiences.
...
1. Create the offer:
    ...
    * For non-default experiences, either [add a custom offer](#adding-a-custom-offer) or [add a library offer](../../../../6-5/sites/authoring/using/content-targeting-touch.md#adding-an-offer-from-an-offer-library).
...
Add an offer from the [offer library](../../../../6-5/sites/authoring/using/offerlib.md) to an experience. You can add any offer from the library of the brand that you are currently targeting.
...
Add a custom offer to the [offer library](../../../../6-5/sites/authoring/using/offerlib.md) when you want to reuse it as the offer for multiple experiences. You can add offers to the library of the current brand that you are targeting.

For information about using the Offers console to create a reusable offer, see [Add an Offer to an Offer Library](../../../../6-5/sites/authoring/using/offerlib.md#add-an-offer-to-an-offer-library).
...
For information targeting engines, see [Targeting Engine](/6-5/sites/authoring/using/personalization.md#targeting-engine).
...
After configuring, you can [view the performance of your activities](../../../../6-5/sites/authoring/using/activitylib.md#viewing-performance-and-converting-winning-experiences-a-b-test) that use Adobe Target (either experience or A/B test targeting). In addition, with A/B test targeting, you can [convert the winners.](../../../../6-5/sites/authoring/using/activitylib.md#viewing-performance-and-converting-winning-experiences-a-b-test)
...
* The [Activities that are On](../../../../6-5/sites/authoring/using/activitylib.md).
* The [rules that define the segments](../../../../6-5/sites/administering/using/campaign-segmentation.md).
* The content of the experiences in the Target components.
* The [configuration of the Targeting engine](../../../../6-5/sites/authoring/using/activitylib.md).
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   You select **Adobe Campaign** as the engine if you are integrating AEM with Adobe Campaign. See [Integrating AEM with Adobe Campaign](/6-5/sites/administering/using/campaign.md) for more information.

   Select **ContextHub** as the engine if you are using ContextHub for targeting. See [Configuring ContextHub.](/6-5/sites/administering/using/contexthub-config.md)
