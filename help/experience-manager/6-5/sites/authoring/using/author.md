...
uuid: 6a141e14-95fd-40c3-8b6a-f355a876e76d
contentOwner: Janice Kendall
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 7a4c5c24-c5d7-4d85-8c65-7ac68d03c55f
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>AEM is also [administered](/6-5/sites/administering/user-guide.md) (for a majority of tasks) from the author environment.
...
To optimize performance for visitors to your website, the ** [dispatcher](/dispatcher/user-guide.md)** implements load balancing and caching.
