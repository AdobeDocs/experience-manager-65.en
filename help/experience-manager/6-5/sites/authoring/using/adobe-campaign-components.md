...
uuid: 463739f3-1442-4754-baa7-a28a76a7a831
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: personalization
discoiquuid: e0e61a53-a392-4774-8c29-321c8b809334
index: y
internal: n
snippet: y
---
...
All the Campaign components follow the best practices outlined in [Best Practices for Email Templates](../../../../6-5/sites/administering/using/best-practices-for-email-templates.md) and are based on the Adobe markup language [HTL](/htl/using/overview.md).
...
After the image is uploaded (and not before) you can use [inplace editing](../../../../6-5/sites/authoring/using/editing-content.md#editcontenttouchoptimizedui) to crop/rotate the image as required:
...
Click **Edit** to configure the component. You can configure the settings described in this section. This Scene7 Image template is described in detail in [Scene7 Image Template component](/6-5/assets/using/scene7.md#image-template).
...
The Text & Personalization (Campaign) component lets you enter a text block using a WYSIWYG editor, with functionality provided by the [Rich Text editor](../../../../6-5/sites/authoring/using/rich-text-editor.md). In addition, this component lets you use context fields and personalization blocks available from Adobe Campaign; also see [Inserting Personalization](/6-5/sites/authoring/using/campaign.md#inserting-personalization).

The selection of icons allow you to format your text, including font characteristics, alignment, links, lists and indentation. The functionality is basically the same in [both UIs](../../../../6-5/sites/authoring/using/editing-content.md), although the look-and-feel is different:

![](assets/chlimage_1-108.png)

In the inplace editor you can add text, change the justification, add and remove links, add context fields or personalization blocks, and enter full-screen mode. When finished adding text/personalization, select the check mark to save your changes (or x to cancel). See [Inplace editing](../../../../6-5/sites/authoring/using/editing-content.md#editcontenttouchoptimizedui) for more information.
...
>
>See [Inserting Personalization](/6-5/sites/authoring/using/campaign.md#inserting-personalization).
...
You use Adobe Campaign components to create a form that users fill out to either subscribe to a newsletter, unsubscribe from a newsletter, or update their user profiles. See [Creating Adobe Campaign Forms](/6-5/sites/authoring/using/adobe-campaign-forms.md) for more information.
