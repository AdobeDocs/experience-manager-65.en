...
uuid: b53e543f-bf66-4d1e-a9d2-40880a189879
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: c2e7b006-4f98-45e3-a16f-5d9f099a9172
index: y
internal: n
snippet: y
---
...
1. Select the page in [selection mode](../../../../6-5/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources).
...
1. Select **Preview**. The page will be shown in a new tab.
   ...
   >    
   >    
   >    * If you experience problems with a preview, check the [Timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline) for the page to see whether the page has been moved.
   >    
   >
...
1. Select **Compare to Current**. The [page diff](../../../../6-5/sites/authoring/using/page-diff.md) will open and display the differences.
...
Timewarp is a [mode](../../../../6-5/sites/authoring/using/author-environment-tools.md#page-modes) of the page editor. To start it, simply switch it as you would any other mode.
