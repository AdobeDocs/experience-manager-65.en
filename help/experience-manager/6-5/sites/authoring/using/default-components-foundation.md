...
uuid: c43a4a0f-8f10-4780-ba72-27545287ccf0
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: f3f935ee-8c48-4150-a067-f63eb61df2e6
...
>[!CAUTION]
>
>Most Foundation Components are now deprecated wtih AEM 6.5. See the [release notes](../../../../6-5/release-notes/deprecated-removed-features.md) for further informtaion.
>
>Adobe recommends leveraging the more modern and extensible [Core Components](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) in AEM projects. These are part of the [We.Retail sample content](/6-5/sites/developing/using/we-retail.md) and can also be [installed separately and used for development](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/get-started/using.html) by your administrator.
>
...
Some are immediately available through component browser, various others are also available by using [design mode](/6-5/sites/authoring/using/default-components-designmode.md) (if the page is based on a static template) or by [editing the template](../../../../6-5/sites/authoring/using/templates.md) (if the page is based on an editable template).
...
The components are available on the **Components** tab of the side panel of the page editor when [editing a page](../../../../6-5/sites/authoring/using/editing-content.md).

You can select a component and drag it to the required location on your page. You can then edit it using:

* [Configure Properties](../../../../6-5/sites/authoring/using/editing-page-properties.md)
* [Edit Content](../../../../6-5/sites/authoring/using/editing-content.md)  

* [Edit Content - Full Screen Mode](../../../../6-5/sites/authoring/using/editing-content.md#edit-content-full-screen-mode)
...
For information about customizing the Adaptive Image component, see [Understanding the Adaptive Image Component](/6-5/sites/developing/using/responsive.md#using-adaptive-images).
...
* **List ** 
  Here you specify how pages are included in your Carousel:
    ...
    * **Build list using** 
      ...
      Note that no matter which method you choose, the pages you include in your list should each already have an image associated with the page, it is this image that will be displayed in the Carousel. If there is no image for a given page under that page's Page Properties, you should associate an image with the page before beginning, as otherwise the Carousel will display a blank (or mostly blank) page. See [Editing Page Properties](../../../../6-5/sites/authoring/using/editing-page-properties.md).  
      Depending on the item you choose a new panel will appear:
        ...
        * **Options for Advanced Search**
            ...
            * **Querybuilder predicate notation** 
              ...
              See [QueryBuilder API](/6-5/sites/developing/using/querybuilder-api.md) for full discussion of query expressions and further examples.
...
>[!NOTE]
>
>You can create a custom carousel component for Adobe Experience Manager that displays digital assets located in the AEM DAM. For information, see [Creating Custom Carousel components for Adobe Experience Manager](/using/custom-carousel-components.md).
...
![](assets/chlimage_1-144.png) ![](assets/dc_chart_use.png)

>[!NOTE]
>
>You can create a custom AEM chart control that displays data located in the AEM JCR. For information, see [Displaying Adobe Experience Manager Data in a Chart](/using/displaying-experience-manager-data-chart.md).
...
[Content fragments](../../../../6-5/sites/authoring/using/content-fragments.md) are created and managed as page-independent assets. You can then use these fragments, and their variations, when authoring your content pages.
...
>[!NOTE]
>
>Depending on your use case, other options are available for integration of external applications, for example. the [Integration of Portlets](../../../../6-5/sites/administering/using/aem-as-portal.md).
...
You can either drag and drop an image from the [Assets Browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#assets-browser) directly onto the component or its [Configure dialog](../../../../6-5/sites/authoring/using/editing-content.md#component-edit-dialog). You can also upload an image from the Configure dialog; this dialog also controls all definitions and manipulation of the image:

![](assets/chlimage_1-146.png)

Once the image is uploaded (and not before) you can use [inplace editing](../../../../6-5/sites/authoring/using/editing-content.md#edit-content) to crop/rotate the image as required:
...
>
>Depending on your instance, minimum and maximum restrictions may also be imposed by the [design of the page](/6-5/sites/developing/using/designer.md); these are developed during project implementation.
...
>
>See the [Certified Platforms](../../../../6-5/release-notes.md#certifiedplatforms) section for more information about HTML5 features used by AEM.
...
<note type="note">
<p>This component has been implemented with <a href="/htl/user-guide.md">HTML Template Language (HTL)</a>.<br /> </p>
</note>
-->

### Layout Container {#layout-container}

This component provides a grid-paragraph system to allow you to add and position components within a [responsive grid](/6-5/sites/authoring/using/responsive-layout.md). This allows you to define differing content layouts based on the width of target devices, including a range of phones, tablets and the desktop.

![](assets/chlimage_1-148.png)

>[!NOTE]
>
>This component has been implemented with [HTML Template Language (HTL)](/htl/user-guide.md).
...
<note type="caution">
<p>This Foundation Component has been deprecated. Adobe recommends leveraging the <a href="https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/list.html">List Core Component</a> instead.<br /> </p>
</note>
-->
...
>[!NOTE]
>
>The **Table** Fourndation Component is based on the [Rich Text editor](../../../../6-5/sites/authoring/using/rich-text-editor.md), as is the ** [Text](#text)** Foundation Component.
...
For more information about applying tags, visit [Using Tags](../../../../6-5/sites/authoring/using/tags.md).
...
>[!NOTE]
>
>The **Text** Fourndation Component is based on the [Rich Text editor](../../../../6-5/sites/authoring/using/rich-text-editor.md), as is the **Table** Foundation Component.

The Text component lets you enter a text block using a WYSIWYG editor, with functionality provided by the [Rich Text editor](../../../../6-5/sites/authoring/using/rich-text-editor.md). A selection of icons allow you to format your text, including font characteristics, alignment, links, lists and indentation.
...
For more detailed information about the Text component and the functionality provided by the Rich Text editor, see the [Rich Text Editor](../../../../6-5/sites/authoring/using/rich-text-editor.md) page.

#### Inplace Editing {#inplace-editing}

In addition to the dialog based Rich Text editing mode, AEM also provides [Inplace Editing](../../../../6-5/sites/authoring/using/editing-content.md), which allows direct editing of the text as it is displayed in the layout of the page.
...
<note type="caution">
<p>This Foundation Component has been deprecated. Adobe recommends leveraging the <a href="https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/text.html">Text Core Component</a> instead.<br /> </p>
</note>
-->
...
<note type="caution">
<p>This Foundation Component has been deprecated. Adobe recommends leveraging the <a href="https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/image.html">Image</a> and <a href="https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/text.html">Text Core Component</a> instead.<br /> </p>
</note>
-->
...
<note type="caution">
<p>This Foundation Component has been deprecated. Adobe recommends leveraging the <a href="https://docs.adobe.com/content/help/en/experience-manager-core-components/using/components/list.html">Title Core Component</a> instead.<br /> </p>
</note>
-->
...
See also [Configure your Video Profiles](/6-5/sites/administering/using/config-video.md#configuringvideoprofiles) for use with HTML5 elements.
...
>[!NOTE]
>
>See [AEM Forms Help](/6-5/forms/user-guide.md) for information about AEM Forms.
...
>[!NOTE]
>
>Information about developing and customizing your forms further is available on the [Developing Forms page](../../../../6-5/sites/developing/using/developing-forms.md). This includes adding actions, constraints, preloading fields and using scripts to call a service to take action, amongst others.
...
>[!NOTE]
>
>The foundation components form component only supports the use of other foundation components form components (button, text, hidden, etc.). Using [core components](/core-components/user-guide.md) form components within a foundation component form (and vice versa) is not supported.
...
* **Advanced**
    ...
    * **Load Path** 
      ...
      Using **Load Path** you can preload the form with values in the required fields. See [Preloading Form Values](../../../../6-5/sites/developing/using/developing-forms.md#preloading-form-values).
...
>
>See [Preloading Form Fields with Multiple Values](../../../../6-5/sites/developing/using/developing-forms.md#preloading-form-fields-with-multiple-values).
...
>[!NOTE]
>
>You can create a custom upload component to upload files to a Sling Servlet. For information, see [Uploading files to Adobe Experience Manager](/using/uploading-files-aem1.md).
...
>
>See [Showing and Hiding Form Components](../../../../6-5/sites/developing/using/developing-forms.md#showing-and-hiding-form-components).
