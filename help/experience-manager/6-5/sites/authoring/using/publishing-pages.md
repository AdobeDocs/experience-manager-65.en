...
uuid: 81bdc412-5b1d-416e-9fc5-2d06efb77f23
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 52b42d8f-3b57-41db-a742-676439a754cf
index: y
internal: n
snippet: y
---
...
Once you have created and reviewed your content on the author environment, the goal is to [make it available on your public website](../../../../6-5/sites/authoring/using/author.md#concept-of-authoring-and-publishing) (your publish environment).
...
>* This [workflow may have been customized](../../../../6-5/sites/developing/using/workflows-models.md#main-pars-procedure-6fe6) by your development team.
...
* [From the page editor](../../../../6-5/sites/authoring/using/publishing-pages.md#publishing-from-the-editor)
* [From the sites console](../../../../6-5/sites/authoring/using/publishing-pages.md#publishing-from-the-console)
...
* [Quick Publish](../../../../6-5/sites/authoring/using/publishing-pages.md#quick-publish)
* [Manage Publication](../../../../6-5/sites/authoring/using/publishing-pages.md#manage-publication)
...
1. The **Manage Publication** wizard starts. The first step, **Options**, allows you to:
   ...
   If you want to cancel a publish/unpublish later, go to the [Workflow Console](/6-5/sites/administering/using/workflows.md) to terminate the corresponding workflow.
...
1. In the next step of the Manage Publication wizard, **Scope**, you can define the scope of the publication/unpublication such as including to include child pages and/or including references.
   ...
   Clicking the Add Content button starts the [path browser](../../../../6-5/sites/authoring/using/author-environment-tools.md#path-browser) to allow content selection.
...
1. If the published pages are associated with workflows, they may be shown in a final **Workflows** step of the publication wizard.
   ...
   >[!NOTE]
   >
   >The **Workflows** step will be shown based on what rights your user may or may not have. See the [previous note on this page](../../../../6-5/sites/authoring/using/publishing-pages.md#main-pars-note-0-ejsjqg-refd) regarding publishing privileges as well as [Managing Access to Workflows](/6-5/sites/administering/using/workflows-managing.md) and [Applying Workflows to Pages](../../../../6-5/sites/authoring/using/workflows-applying.md#main-pars-text-5-bvhbkh-refd) for details.

   The resources are grouped by the workflows triggered and each given options to:

    * Define the title of the workflow.
    * Keep the workflow package, provided that the workflow has [multi-resourse support](../../../../6-5/sites/developing/using/workflows-models.md#configuring-a-workflow-for-multi-resource-support).
...
In a [manner similar to publishing](../../../../6-5/sites/authoring/using/publishing-pages.md#publishing-pages), one or more pages can be unpublished:

* [From the page editor](../../../../6-5/sites/authoring/using/publishing-pages.md#unpublishing-from-the-editor)
* [From the sites console](../../../../6-5/sites/authoring/using/publishing-pages.md#unpublishing-from-the-console)

### Unpublishing from the Editor {#unpublishing-from-the-editor}

When editing a page, if you wish to unpublish that page, select **Unpublish Page** in the **Page Information** menu, much as you would [publish the page](../../../../6-5/sites/authoring/using/publishing-pages.md#publishing-from-the-editor).

### Unpublishing from the Console {#unpublishing-from-the-console}

Just as you [use the Manage Publication option to publish](../../../../6-5/sites/authoring/using/publishing-pages.md#manage-publication), you can also use it to unpublish.
...
1. To complete the unpublication, continue through the wizard as you would to [publish the page](../../../../6-5/sites/authoring/using/publishing-pages.md#manage-publication).
...
You can use the [Manage Publication](../../../../6-5/sites/authoring/using/publishing-pages.md#manage-publication) option on the sites console to do this.
...
* In the [resource overview information on the sites console](../../../../6-5/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources)

  ![](assets/screen-shot_2019-03-05at112019.png)

  The publication status is shown in [card](../../../../6-5/sites/authoring/using/basic-handling.md#card-view), [column](../../../../6-5/sites/authoring/using/basic-handling.md#column-view), and [list](../../../../6-5/sites/authoring/using/basic-handling.md#list-view) views in the sites console.

* In the [timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline)

  ![](assets/screen_shot_2018-03-21at154420.png)

* In the [Page Information menu](../../../../6-5/sites/authoring/using/author-environment-tools.md#page-information) when editing a page
