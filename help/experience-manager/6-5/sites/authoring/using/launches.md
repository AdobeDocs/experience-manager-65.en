...
uuid: b49dbbc1-e570-43f3-b5d6-6f537c685ae9
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: site-features
discoiquuid: 0e6bb2e5-af91-4b97-8bb6-260a8d15e618
index: y
internal: n
snippet: y
---
...
This section descibes how to create, edit and promote (and if necessary [delete](/6-5/sites/authoring/using/launches-creating.md#deleting-a-launch)) launch pages from within the Sites console or [the Launches console](#the-launches-console):

* [Creating Launches](/6-5/sites/authoring/using/launches-creating.md)
...
* [Create a nested launch](/6-5/sites/authoring/using/launches-creating.md#creating-a-nested-launch) - a launch within a launch:

    * The source is an existing launch.
    * You can [promote a nested launch](../../../../6-5/sites/authoring/using/launches-promoting.md#promoting-a-nested-launch) to any target; this can be a parent launch or the top-level source pages (Production).
