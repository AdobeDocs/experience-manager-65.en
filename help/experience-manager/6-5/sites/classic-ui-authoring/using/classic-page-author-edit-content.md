...
uuid: a3499fe3-c095-4130-b1b1-99767ec5de5b
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 751785b5-aebc-4be0-a8fc-4c63e0a0b141
index: y
internal: n
snippet: y
---
...
Content is added using [components](/6-5/sites/classic-ui-authoring/using/classic-page-author-conponent-console.md) (appropriate to the content type) that can be dragged onto the page. These can then be edited in place, moved, or deleted.

>[!NOTE]
>
>Your account needs the [appropriate access rights](../../../../6-5/sites/administering/using/security.md) and [permissions](../../../../6-5/sites/administering/using/security.md#permissions) to edit pages; for example, adding, editing or deleting components, annotating, unlocking.
>
...
* [selecting components](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#sidekick) 
* [showing references](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#showing-references) 
* [accessing the audit log](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#audit-log) 
* [switching modes](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#page-modes) 
* [creating](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-work-with-versions.md#creating-a-new-version), [restoring](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-work-with-versions.md#restoring-a-page-version-from-sidekick) and [comparing](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-work-with-versions.md#comparing-with-a-previous-version) versions  

* [publishing](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-publish-pages.md#publishing-a-page), [unpublishing](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-publish-pages.md#unpublishing-a-page) a page

* [editing page properties](/6-5/sites/classic-ui-authoring/using/classic-page-author-edit-page-properties.md)   

* [scaffolding](/6-5/sites/authoring/using/scaffolding.md)  
...
1. In both the sidekick and the **Insert New Component** toolbar you see a list of the available components (paragraph types). These may be split into various sections (for example, General, Columns, etc.), which can be expanded as required.
   ...
   Depending on your production environment, these choices may differ. For complete details on components, see [Default Components](/6-5/sites/classic-ui-authoring/using/classic-page-author-default-components.md).
...
You can also add a new component to the page by dragging an asset from the [Content Finder](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#the-content-finder). This will automatically create a new component of the appropriate type containing the asset.
...
1. Make sure that your page is in [**Edit** mode](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#page-modes).
1. Open the [Content Finder](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-env-tools.md#the-content-finder).
...
>[!NOTE]
>
>If you have set your [User Properties to show the Global Editing Toolbar](../../../../6-5/sites/classic-ui-authoring/using/author-env-user-props.md) you can also perform certain actions on the paragraphs by using the **Copy**, **Cut**, **Paste**, **Delete** buttons available.  

>
>Various [keyboard shortcuts](/6-5/sites/classic-ui-authoring/using/classic-page-author-keyboard-shortcuts.md) are also available.
...
* [Multi site management](/6-5/sites/administering/using/msm.md); also in combination with [scaffolding](../../../../6-5/sites/classic-ui-authoring/using/classic-feature-scaffolding.md#scaffolding-with-msm-inheritance).

* [Launches](/6-5/sites/classic-ui-authoring/using/classic-launches.md) (when based on livecopy).
...
[Annotations](/6-5/sites/classic-ui-authoring/using/classic-page-author-annotations.md) allow other authors to provide feedback on your content. This is often used for review and validation purposes.
...
For larger scale edits of the same phrase a ** [Find & Replace](../../../../6-5/sites/classic-ui-authoring/using/author-env-search.md#find-and-replace)** menu option allows you to search for, and replace multiple instances of a string, within a section of the website.
...
>* also use [Keyboard shortcuts](/6-5/sites/classic-ui-authoring/using/classic-page-author-keyboard-shortcuts.md) for undo and redo.
>
