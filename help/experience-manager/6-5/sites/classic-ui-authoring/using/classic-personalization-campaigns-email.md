...
uuid: f12a0c1e-a441-4cf9-bd18-c431ccf5259d
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: personalization
content-type: reference
discoiquuid: da751ee5-a6be-44a2-816e-bf3e21434df0
index: y
internal: n
snippet: y
---
...
* [Managing Subscriptions](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns-email-subscriptions.md)
* [Publishing an Email to Email Service Providers](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns-email-newsletters.md)
* [Tracking Bounced Emails](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns-email-tracking-bounces.md)
...
>[!NOTE]
>
>Email notifications need to be configured via the osgi configuration. See [Configuring Email Notification.](/6-5/sites/administering/using/notification.md)
...
1. A new dialog will open immediately. Here you can enter properties for the newsletter.
   ...
   The **Default Recipients List** is a mandatory field as this forms the touchpoint for the newsletter (see [Working with Lists](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#workingwithlists) for more information about lists).
