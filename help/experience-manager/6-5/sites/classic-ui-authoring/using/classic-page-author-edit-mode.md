...
uuid: 8659734f-e592-4a78-88da-e8ba1f85084d
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 6749700a-840e-4c17-975d-d61d2dee1160
index: y
internal: n
snippet: y
---
...
Some are immediately available through the sidekick, various others are also available by using [Design mode](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-design-mode.md) to enable/disable them.
...
The components are available when [editing a page](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-edit-content.md) from the **Components** tab of the sidekick and the **Insert New Component** selector (when you double-click in the **Drag components or assets here** area).

You can select a component and drag it to the required location on your page and then [Edit Content and Properties](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-edit-content.md#editing-a-component-content-and-properties).
...
![](assets/chlimage_1-91.png) ![](assets/dc_chart_use.png)
...
[Content fragments](/6-5/sites/classic-ui-authoring/using/classic-page-author-content-fragments.md) are created and managed as page-independent assets. You can then use these fragments, and their variations, when authoring your content pages.
...
>[!CAUTION]
>
>Although the Layout container component is available in the classic UI, its full functionality is only available in the touch-enabled UI. For details see [Responsive Layout](/6-5/sites/classic-ui-authoring/using/classic-page-author-responsive-layout.md).
...
>[!NOTE]
>
>The **Table** component is based on the [Rich Text editor](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-rich-text-editor.md), as is the ** [Text](#text)** component.
>
...
For more information about applying tags, visit [Using Tags](/6-5/sites/classic-ui-authoring/using/classic-feature-tags.md).

### Text {#text}

>[!NOTE]
>
>The **Text** component is based on the [Rich Text editor](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-rich-text-editor.md), as is the ** [Table](#table)** component.
>
>It is recommended to use the **Table** component for tables, although they can also be constructed with the **Text** component.

The Text component lets you enter a text block using a WYSIWYG editor, with functionality provided by the [Rich Text editor](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-rich-text-editor.md). A selection of icons allow you to format your text, including font characteristics, alignment, links, lists and indentation.
...
For more detailed information about the Text component and the functionality provided by the Rich Text editor, see the [Rich Text Editor](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-rich-text-editor.md) page.
