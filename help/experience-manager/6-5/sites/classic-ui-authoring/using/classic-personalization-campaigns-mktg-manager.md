...
uuid: 838a3e24-118b-4d81-961d-86fab5dce9a2
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: personalization
content-type: reference
discoiquuid: a7c1de96-fb1e-42a3-a89d-fd2d4bdeacd6
index: y
internal: n
snippet: y
---
...
* ** [Dashboard](#dashboard)** 
  This is divided into four panes:
    ...
    * [Segments](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#anoverviewofsegmentation)  
    ...
    * [Reports](../../../../6-5/sites/administering/using/reporting.md)  
    ...
    * [Campaigns](#campaigns)  
      This pane lists your campaign experiences such as [newsletters](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#newsletters) and [teasers](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#teasers).
...
>[!NOTE]
>
>See [Working with Leads](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#workingwithleads) for detailed information about specific tasks.
...
>[!NOTE]
>
>See [Working with Lists](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#workingwithlists) for detailed information about specific tasks.
...
>[!NOTE]
>
>See [Teasers and Strategies](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#workingwithlists), [Setting up your Campaign](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#settingupyourcampaign) and [Newsletters](/6-5/sites/classic-ui-authoring/using/classic-personalization-campaigns.md#newsletters) for detailed information about specific tasks.
