...
uuid: 1f064d78-2bc2-42b4-8dd0-2d15c515e9ea
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: personalization
content-type: reference
discoiquuid: 0190f481-5aba-49be-929e-a1f954a5c9d0
index: y
internal: n
snippet: y
---
...
Preparing the design package for importing is covered in [Extending and Configuring the Design Importer](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md). Integrating with Adobe Analytics is covered in [Integrating Landing Pages with Adobe Analytics.](/6-5/sites/administering/using/integrating-landing-pages-with-adobe-analytics.md)

>[!CAUTION]
>
>The Design Importer, used to import landing pages, [has been deprecated with AEM 6.5](../../../../6-5/release-notes/deprecated-removed-features.md#deprecated-features).
...
1. [Prepare the HTML and assets.](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md)
...
The Text component lets you enter a text block using a WYSIWYG editor. See [Text component](/6-5/sites/authoring/using/default-components.md#text) for more information.
...
The title component lets you display a title and configure the size (h1-6). See [Title component](/6-5/sites/authoring/using/default-components.md#title) for more information.
...
The image component displays an image that you can either drag and drop from the Content Finder or click to upload. See [image component](/6-5/sites/authoring/using/default-components.md) for more information.
...
>
>Not all options are available to all lead form components. See Forms for more information on these [common settings](/6-5/sites/authoring/using/default-components.md#formsgroup).
...
1. [Prepare the HTML for importing.](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md)
...
Before importing the design package, the HTML needs to be prepared. See [Extending and Configuring the Design Import](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md) for more information.

### Importing the Design Package {#importing-the-design-package}

After an importer page has been created, you can import a design package onto it. Details on creating the design package and its recommended structure are explained in [Extending and Configuring the Design Import](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md).
...
>[!NOTE]
>
>If you have trouble importing the design package, see [Troubleshooting](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md#troubleshooting).
...
>[!NOTE]
>
>If a component on the landing page cannot be edited, you need to re-import the zip file after [modifying the HTML file.](../../../../6-5/sites/administering/using/extending-the-design-importer-for-landingpages.md) It means that during the import, the non-editable parts were not converted into AEM components.
