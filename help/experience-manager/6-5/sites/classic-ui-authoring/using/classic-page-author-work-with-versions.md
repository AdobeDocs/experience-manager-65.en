...
uuid: c991329f-543a-4ef7-99e3-b9b59d67ced5
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: c3f6ed13-dd9a-4c84-8c79-0eb9411b4c8e
index: y
internal: n
snippet: y
---
...
1. Using the date and time selectors specify the date/time you want and click **Go**.
   ...
   >[!NOTE]
   >
   >You cannot edit the old version of the page. It is only available for viewing. If you want to restore the older version you will have to do that manually using [restore](../../../../6-5/sites/classic-ui-authoring/using/classic-page-author-work-with-versions.md#restoring-a-page-version-from-sidekick).
