...
uuid: df8bf53f-ade8-4e9c-94a5-54348863064b
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 57a85c94-9131-4640-9b3e-cd6bfafc218c
index: y
internal: n
snippet: y
---
...
* A specialized inbox for workflow items is described in the [Participating in Workflows](/6-5/sites/classic-ui-authoring/using/classic-workflows-participating.md) document.
...
1. Select the notification channel:
   ...
   >[!NOTE]
   >
   >A few settings need to be configured in order to be notified by email. It is also possible to customize the email template or to add an email template for a new language. Please refer to [Configuring Email Notification](/6-5/sites/administering/using/notification.md#configuringemailnotification) to configure email notifications in AEM.
