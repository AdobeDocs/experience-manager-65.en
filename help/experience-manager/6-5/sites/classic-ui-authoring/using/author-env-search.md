...
uuid: 88bde486-3efe-463f-827f-b9421fd4fc4c
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: e3364a54-08ba-4979-ba45-fb6eb208bc1e
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Outside the author environment other mechanisms are also available for searching, such as the [Query Builder](/6-5/sites/developing/using/querybuilder-api.md) and [CRXDE Lite](../../../../6-5/sites/developing/using/developing-with-crxde-lite.md).
...
>[!NOTE]
>
>When your instance is configured for [Lucene search](/6-5/sites/deploying/using/queries-and-indexing.md) you can use the following in **Fulltext**:
>
