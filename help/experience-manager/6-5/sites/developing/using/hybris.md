...
uuid: 25b53868-dab5-484f-8d98-f8306bdb88f3
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: platform
discoiquuid: fda2eeb0-9c95-402e-9b2d-33704f035d14
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>[API documentation](../../../../6-5/sites/developing/using/ecommerce.md#api-documentation) is also available.
...
* Storage
    ...
    * In the AEM-generic case carts of are stored in the [ClientContext](../../../../6-5/sites/administering/using/client-context.md).

**Personalization**

* Personalization should always be driven through the [ClientContext](../../../../6-5/sites/administering/using/client-context.md).
...
The entry point for the search API is the `CommerceService#search` method which returns a `CommerceResult` object. See the [API Documentation](../../../../6-5/sites/developing/using/ecommerce.md#api-documentation) for more information on this topic.
