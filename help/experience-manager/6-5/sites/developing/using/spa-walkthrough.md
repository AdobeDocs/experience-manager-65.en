...
uuid: b754cdf0-e0c2-436b-a808-73f9242ab5eb
contentOwner: bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: spa
content-type: reference
discoiquuid: f184a25c-d019-4db1-87e8-7027e2ad1e91
index: y
internal: n
snippet: y
---
...
* [AEM version 6.4 with service pack 2 or newer  
  ](../../../../6-5/release-notes/sp-release-notes.md)
...
>[!NOTE]
>
>For technical details on how SPAs work in AEM, see the article [Getting Started with SPAs in AEM](../../../../6-5/sites/developing/using/spa-getting-started-react.md).
>
>For a closer look at the design, architecture, and technical workflow of the SPA Editor, see the article [SPA Editor Overview](../../../../6-5/sites/developing/using/spa-overview.md).
...
>The walkthrough is based on standard AEM functionality and the sample We.Retail Journal app. The following requirements must be met:
>
>* [AEM version 6.4 with service pack 2](../../../../6-5/release-notes/sp-release-notes.md)
>* [Install the sample We.Retail Journal app available on GitHub here.](https://github.com/Adobe-Marketing-Cloud/aem-sample-we-retail-journal)
>
...
>
>To see how this works, continue on to the next section of this article [SPA Apps and the AEM SPA Editor](../../../../6-5/sites/developing/using/spa-walkthrough.md#spa-apps-and-the-aem-spa-editor).
...
The next section, [Loading an SPA Application](../../../../6-5/sites/developing/using/spa-walkthrough.md#loading-an-spa-application), digs deeper into the mechanics of loading the SPA and how content can be loaded synchronously and asynchronously.
...
1. Load the `react.model.json` in a new tab.
   ...
   The AEM SPA Editor leverages [AEM Content Services](../../../../6-5/assets/using/content-fragments.md) to deliver the entire content of the page as a JSON model.
...
* [Getting Started with SPAs in AEM](../../../../6-5/sites/developing/using/spa-getting-started-react.md) shows how a basic SPA is built to work with the SPA Editor in AEM
* [SPA Editor Overview](../../../../6-5/sites/developing/using/spa-overview.md) goes into more depth into the communication model between AEM and the SPA.
* [Developing SPAs for AEM](../../../../6-5/sites/developing/using/spa-architecture.md) describes how to engage front-end developers to develop a SPA for AEM as well as how SPAs interact with AEM's architecture.
