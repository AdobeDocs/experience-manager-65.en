...
uuid: 0929136d-19ff-459a-b644-9242b7ee7aba
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: components
content-type: reference
discoiquuid: afb4149d-cc01-4564-8f2d-e148b2786036
index: y
internal: n
snippet: y
---
...
All of these are realised with a series of default [Form components](/6-5/sites/authoring/using/default-components.md#form), available in a standard AEM installation.

In addition to [developing new components](/6-5/sites/developing/using/developing-components-samples.md) for use on your forms you can also:
...
>[!NOTE]
>
>This document focuses on developing forms using the [Foundation Components](../../../../6-5/sites/authoring/using/default-components-foundation.md) in the classic UI. Adobe recommends leveraging the new [Core Components](/core-components/user-guide.md) and [Hide Conditions](/6-5/sites/developing/using/hide-conditions.md) for form development in the touch-enabled UI.
...
The **Items Load Path** is the path to node properties that is used to load predefined values into that specific field on the form, for example, a [drop down list](../../../../6-5/sites/authoring/using/default-components-foundation.md#dropdown-list), [check box group](../../../../6-5/sites/authoring/using/default-components-foundation.md#checkbox-group) or [radio group](../../../../6-5/sites/authoring/using/default-components-foundation.md#radio-group).
...
For more information about the API elements that can be used when writing scripts see the [javadocs related to forms](/6-5/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/foundation/forms/package-summary.md).
