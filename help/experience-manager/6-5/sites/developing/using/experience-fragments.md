...
uuid: 80a97636-6e5d-4007-89bc-c0a59bc2d07f
contentOwner: aheimoz
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 9c5b5d4e-df33-4510-9345-048e71644fe0
index: y
internal: n
snippet: y
---
...
An [Experience Fragment](../../../../6-5/sites/authoring/using/experience-fragments.md) is a group of one or more components including content and layout that can be referenced within pages.
...
>[!CAUTION]
>
>***Only*** [editable templates](../../../../6-5/sites/developing/using/page-templates-editable.md) are supported for Experience Fragments.

When developing a new template for Experience Fragments you can follow follow the standard practices for an [editable template](../../../../6-5/sites/developing/using/page-templates-editable.md).
...
>[!NOTE]
>
>[Allowed templates](../../../../6-5/sites/authoring/using/experience-fragments.md#configuring-allowed-templates) can be configured in the Experience Fragments console.

## Components for Experience Fragments {#components-for-experience-fragments}

[Developing components](/6-5/sites/developing/using/components.md) for use with/in Experience Fragments follow standard practices.

The only additional configuration is to ensure that the components are [allowed on the template, this is achieved with the Content Policy](../../../../6-5/sites/developing/using/page-templates-editable.md#content-policies).
...
Last Modified Date: 2019-06-24T09:59:51.944-0400
<p><a href="https://wiki.corp.adobe.com/display/WEM/Experience+Fragment+Link+Rewriter+Provider+-+HTML">https://wiki.corp.adobe.com/display/WEM/Experience+Fragment+Link+Rewriter+Provider+-+HTML</a></p>
-->
...
>[!NOTE]
>
>This interface was introduced in [AEM 6.5 SP1 (6.5.1.0)](../../../../6-5/release-notes/sp-release-notes.md).
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2019-06-26T06:07:17.122-0400
<p>javadocs will be rebuilt and republished for 6.5.1.0</p>
<p>when published provide a link</p>
<p>link will be comparable to https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/xf/ExperienceFragment.html</p>
<p>....but for the LinkRewriter</p>
<p>so maybe</p>
<p>https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/com/adobe/cq/xf/ExperienceFragmentLinkRewriterProvider.html</p>
-->
...
>[!NOTE]
>
>For more information on how to get a resource resolver through a service user see [Service Users in AEM](/6-5/sites/administering/using/security-service-users.md).
