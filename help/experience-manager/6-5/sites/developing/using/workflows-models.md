...
uuid: 34495af6-dc16-4969-8fb3-4d145b2ee264
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 37ffb546-9bde-409a-a40c-960068d6f177
index: y
internal: n
snippet: y
---
...
>[!CAUTION]
>
>For use of the classic UI, please see the [AEM 6.3 documentation](/6-3/sites/developing/using/workflows-models.md) for reference.

You create a [workflow model](/6-5/sites/developing/using/workflows.md#model) to define the series of steps executed when a user starts the workflow. You can also define model properties, such as whether the workflow is transient or uses multiple resources.
...
>
>This folder can then be used for [managing access to the models in that folder](/6-5/sites/administering/using/workflows-managing.md#create-a-subfolder-in-var-workflow-models-and-apply-the-acl-to-that).
...
Editing a [**Default and/or Legacy** (out-of-the-box) workflow](#editing-a-default-or-legacy-workflow-for-the-first-time) has an additional step, to ensure that a [safe copy](/6-5/sites/developing/using/workflows-best-practices.md#locations-workflow-models) is taken prior to your changes being made.
...
**Sync** (right in the editor toolbar) generates a [runtime model](/6-5/sites/developing/using/workflows.md#runtime-model). The runtime model is the model actually used when a user starts a workflow. If you do not **Sync** your changes, then the changes will not be available at runtime.
...
When you open a [Default and/or Legacy model](/6-5/sites/developing/using/workflows.md#workflow-types) for editing:
...
>[!NOTE]
>
>See [Locations of Workflow Models](/6-5/sites/developing/using/workflows-best-practices.md#locations-workflow-models) for further information.
...
>[!NOTE]
>
>For information about the primary step components that are installed with AEM, see [Workflow Steps Reference](../../../../6-5/sites/developing/using/workflows-step-ref.md).
...
1. Add as many steps, or other updates, as required.
   ...
   You can also copy, cut, paste, group or delete existing steps; as with the [page editor.](../../../../6-5/sites/authoring/using/editing-content.md)
   ...
   <note type="note">
   <p>You can also copy, cut, paste, group or delete existing steps; as with the <a href="../../../../6-5/sites/authoring/using/editing-content.md">page editor</a>.</p>
...
You can create a [Transient](/6-5/sites/developing/using/workflows.md#transient-workflows) workflow model when creating a new model, or by editing an existing one:
...
>[!NOTE]
>
>When you run a workflow in [transient](/6-5/sites/developing/using/workflows.md#transient-workflows) mode AEM does not store any workflow history. Therefore, [Timeline](../../../../6-5/sites/authoring/using/basic-handling.md#timeline) does not display any information related to that workflow. [](../../../../6-5/sites/authoring/using/basic-handling.md#timeline)
...
You can configure a workflow model for [Multi Resource Support](/6-5/sites/developing/using/workflows.md#multi-resource-support) when creating a new model, or by editing an existing one:
...
[Workflow Stages](/6-5/sites/developing/using/workflows.md#workflow-stages) help visualize the progress of a workflow when handling tasks.
...
1. Create a new package using the [Package Manager](../../../../6-5/sites/administering/using/package-manager.md#package-manager):
...
1. [Start your workflow model](/6-5/sites/administering/using/workflows-starting.md) from the console.
...
You can also configure AEM to display **DEBUG** messages in the log files. See [Logging](/6-5/sites/deploying/using/configure-logging.md) for further information and when the development is finished, set the **Log Level** back to **Info**.
...
1. Open the **User/Group** tab:
   ...
   >[!NOTE]
   >
   >For emails to be sent, [the mail service and user account details need to be configured](/6-5/sites/administering/using/notification.md).
...
>[!NOTE]
>
>See [Using ECMAScript](/6-5/sites/developing/using/workflows-customizing-extending.md#using-ecmascript).
