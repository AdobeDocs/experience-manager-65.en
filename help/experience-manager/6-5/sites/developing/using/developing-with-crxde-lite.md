...
uuid: bf38debc-c34f-47e9-befe-d236f867777a
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: development-tools
content-type: reference
discoiquuid: d546d12b-3d35-47c3-ac82-07baebd1f1bc
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>By default, all AEM users can access CRXDE Lite. If desired, [configure ACLs](../../../../6-5/sites/administering/using/security.md#permissions-and-acls) for the following node so that only developers can access CRX DE Lite:
>
>`/libs/granite/crxde`

>[!NOTE]
>
>It is recommended to use the [AEM Developer Tools for Eclipse](/6-5/sites/developing/using/aem-eclipse.md) and the [AEM HTL Brackets Extension](/6-5/sites/developing/using/aem-brackets.md) during project development.
...
![](assets/chlimage_1-25.png) ![](assets/chlimage_1-26.png) 
...
You can also use the Dialog Editor to edit a dialog. Double clicking the dialog node in CRXDE Lite will bring up the editor. More information about the Dialog Editor can be found [here](/6-5/sites/developing/using/dialog-editor.md).
...
>[!NOTE]
>
>See [Users, Groups and Access Rights Administration](../../../../6-5/sites/administering/using/user-group-ac-admin.md) for more information.
