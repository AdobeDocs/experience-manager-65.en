...
uuid: 6fa1ad11-e95e-40f3-adff-fe2c7e8be870
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: platform
content-type: reference
discoiquuid: a18d62a3-6a09-4912-96db-7df2df3ebede
index: y
internal: n
snippet: y
---
...
* [Tags in Different Languages](/6-5/sites/developing/using/building.md#tags-in-different-languages) - which describes use of the APIs
* [Managing Tags in Different Languages](/6-5/sites/administering/using/tags.md#managing-tags-in-different-languages) - which describes use of the Tagging console
...
The following is a description of the effects in the repository when moving or merging tags using the [Tagging console](/6-5/sites/administering/using/tags.md):
