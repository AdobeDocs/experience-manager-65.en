...
uuid: 3fa61ff8-7fa3-47ae-b3b4-6d62b066042d
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: development-tools
content-type: reference
discoiquuid: b6c7f5d6-e96b-448e-bd52-eef8562ce0de
index: y
internal: n
snippet: y
---
...
Last Modified Date: 2019-03-14T13:38:46.678-0400
I think this section can be removed. This code is quite old.
-->
...
<note type="note">
<p>It is also possible to configure these repositories in your Maven <em>settings.xml</em> file.</p>
</note>
-->
...
For details, see [Using Maven for Communities](/6-5/communities/using/maven.md)
