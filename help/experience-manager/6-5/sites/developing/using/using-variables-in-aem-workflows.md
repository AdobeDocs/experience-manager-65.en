...
uuid: 0836aab1-ff8e-4117-8f12-caed10c5cd44
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 9abf158e-2e31-46c1-a518-eb283cf5e333
index: y
internal: n
snippet: y
---
...
* [Create a variable](../../../../6-5/sites/developing/using/using-variables-in-aem-workflows.md#create-a-variable) of a data type based on the information type that you want to store in it.
* [Set a value for the variable](../../../../6-5/sites/developing/using/using-variables-in-aem-workflows.md#set-a-variable) using the Set Variable workflow step.
* [Use the variable](../../../../6-5/sites/developing/using/using-variables-in-aem-workflows.md#use-a-variable) in OR Split and Goto AEM workflow steps to define an expression for taking routing decisions. You can also use variables in all AEM Forms workflow steps.
...
For more information, see [adaptive forms rule editor](../../../../6-5/forms/using/rule-editor.md).
...
You can use variables to define the routing expression using the expression editor. For more information on using routing expressions for the OR Split step, see [OR Split step](../../../../6-5/sites/developing/using/workflows-step-ref.md#or-split).

In this example, before defining the routing expression, use [example 2](../../../../6-5/sites/developing/using/using-variables-in-aem-workflows.md#example2) to set the value for the **totalvalue** variable. Branch 1 is active if the value of the **totalvalue** variable is greater than 50000. Similarly, you can define a rule to make the Branch 2 active if the value of the **totalvalue** variable is less than 50000.
...
For more examples, see [Create a workflow model](../../../../6-5/forms/using/aem-forms-workflow.md#create-a-workflow-model).
...
You can use variables to define the routing expression using the expression editor. For more information on using routing expressions for the Goto step, see [Goto Step](../../../../6-5/sites/developing/using/workflows-step-ref.md#goto-step).
...
For more examples on using rule definition in the Goto step, see [Simulating a For loop](../../../../6-5/sites/developing/using/workflows-step-ref.md#simulateforloop).

#### Forms-workflow centric workflow steps {#forms-workflow-centric-workflow-steps}

All AEM Forms workflow steps support variables. For more information, see [Forms-centric workflow on OSGi](../../../../6-5/forms/using/aem-forms-workflow-step-reference.md).
...
For information on APIs for additional complex variable data types available in AEM Forms workflows, see [Variables in AEM Forms workflows](../../../../6-5/forms/using/variable-in-aem-workflows.md).
...
<h3>Use MetaDataMap interface to retrieve or update a variable</h3>
-->
