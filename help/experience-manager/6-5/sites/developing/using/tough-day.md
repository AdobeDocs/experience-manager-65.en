...
<note type="note">
<p>For information about maximizing response times, see <a href="/6-5/sites/deploying/using/configuring-performance.md">Performance Optimization</a>.</p>
<p> </p>
</note>
-->
...
<note type="note">
<p>For estimating the number of users on an author instance, you can use the <a href="/6-5/sites/developing/using/analyze-request.md">Request Analysis Script</a></p>
<p> </p>
</note>
-->
