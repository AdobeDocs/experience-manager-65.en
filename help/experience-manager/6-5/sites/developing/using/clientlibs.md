...
uuid: 77ae821f-0974-4aba-9f45-90d91ea49eeb
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 36118397-3272-40f1-9158-3a192d048204
index: y
internal: n
snippet: y
---
...
* `allowProxy`: If a client library is located under `/apps`, this property allows acces to it via proxy servlet. See [Locating a Client Library Folder and Using the Proxy Client Libraries Servlet](../../../../6-5/sites/developing/using/clientlibs.md#locating-a-client-library-folder-and-using-the-proxy-client-libraries-servlet) below.
...
In HTL, client libraries are loaded through a helper template provided by AEM, which can be accessed through [ `data-sly-use`](/htl/using/block-statements.md#use). Three templates are available in this file, which can be called through [ `data-sly-call`](/htl/using/block-statements.md#template-call):
...
For further details and exmple of usage, see the document [Getting Started with the HTML Template Language](/htl/using/getting-started.md#loading-client-libraries).
...
For complete information, including attributes for filtering JS, CSS, or theme libraries, see [ui:includeClientLib](/6-5/sites/developing/using/taglib.md#lt-ui-includeclientlib).

>[!CAUTION]
>
>`<cq:includeClientLib>`, which in the past was commonly used to include client libraries, has been deprecated since AEM 5.6. [ `<ui:includeClientLib>`](/6-5/sites/developing/using/taglib.md#lt-ui-includeclientlib) should be used instead as detailed above.
...
For information about requirements that are specific to client libraries for widgets, see [Using and Extending Widgets](../../../../6-5/sites/developing/using/widgets.md).
...
For information about configuring the service, see [AEM HTML Library Manager](../../../../6-5/sites/deploying/using/osgi-configuration-settings.md#aemhtmllibrarymanager).
