...
uuid: 06f170c3-b1a2-4e18-ad9f-71b5dfd74851
contentOwner: bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: spa
content-type: reference
discoiquuid: ac5b7b48-c134-4a93-a53b-2b2dfcdfe28d
index: y
internal: n
snippet: y
---
...
You should be familiar with the [structure of an SPA application for AEM](../../../../6-5/sites/developing/using/spa-getting-started-react.md) before reading this article.
...
For further information about developing SPAs for AEM see the article [Developing SPAs for AEM](../../../../6-5/sites/developing/using/spa-architecture.md).
