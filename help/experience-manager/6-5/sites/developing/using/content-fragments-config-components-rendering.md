...
uuid: 9d9e0631-ba64-4f2c-a75f-bb6b7f925518
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: c60f64bf-88e2-4b18-b6b6-0c6123acf1f9
index: y
internal: n
snippet: y
---
...
>[!CAUTION]
>
>If you do not need the [advanced services](../../../../6-5/sites/developing/using/content-fragments-config-components-rendering.md#definition-of-advanced-services-that-need-configuration) described below, you can ignore this configuration.
...
>[!NOTE]
>
>See [Configuring OSGi](/6-5/sites/deploying/using/configuring-osgi.md) for further details.
