...
uuid: a57c18a4-da24-4372-a05d-83f593395ffc
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: mobile-web
content-type: reference
discoiquuid: c3a74931-ffb0-4d61-9099-a1c7ffcd9ccc
...
The [com.day.cq.wcm.mobile.api.devicespecs.DeviceSpecsConstants](/6-5/sites/developing/using/reference-materials/javadoc/index.html?com/day/cq/wcm/mobile/api/device/DeviceGroupFilter.md) interface contains a subset of the WURFL™ capability names in static fields. Use these field constants as keys when retrieving values from the Map of device capabilities.
...
>[!NOTE]
>
>Ensure the WURFL™ database that is deployed to AEM includes the capabilities that you use as filter criteria. (See [Device Detection](../../../../6-5/sites/developing/using/mobile.md#server-side-device-detection).)
...
Add the profile that the [Obtaining the Content Package Maven Plugin](/6-5/sites/developing/using/vlt-mavenplugin.md) section provides to your maven settings file to use the public Adobe repository.
