...
uuid: c428bb3b-daee-44d3-bd85-97335c010db9
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 6be0efb2-0ba8-4eb0-beef-3ef111e65e95
index: y
internal: n
snippet: y
---
...
The page diff allows a user to compare the current page to launches, previous versions, etc. For details of this user feature, see [Page Diff](../../../../6-5/sites/authoring/using/page-diff.md).

## Operation Details {#operation-details}

When comparing versions of a page, the previous version that the user wishes to compare is recreated by AEM in the background in order to facilitate the diff. This is needed to be able to render the content [for side-by-side comparison](../../../../6-5/sites/developing/using/pagediff.md#operation-details).
