...
uuid: 8ed5fcfd-c4b2-47fd-acca-90ad81c59767
contentOwner: sarchiz
topic-tags: upgrading
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
discoiquuid: 037fea80-e377-4245-ae79-d57aa556b989
...
1. Run the [pre-upgrade maintenance tasks](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md).

### Upgrade Execution {#upgrade-execution}

![](assets/execute_upgrade.jpg)

1. Run the [in-place upgrade](../../../../6-5/sites/deploying/using/in-place-upgrade.md)
...
1. Run [pre-upgrade maintenance tasks](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md) on the primary Author instance  
...
1. Run an [in-place upgrade](../../../../6-5/sites/deploying/using/in-place-upgrade.md) on the primary Author  
...
1. Run [pre-upgrade maintenance](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md) on Publish 2  

1. Run an [in-place upgrade](../../../../6-5/sites/deploying/using/in-place-upgrade.md) on Publish 2  
...
1. Perform [post-upgrade checks](../../../../6-5/sites/deploying/using/post-upgrade-checks-and-troubleshooting.md).
