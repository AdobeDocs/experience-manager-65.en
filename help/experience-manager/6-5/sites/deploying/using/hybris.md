...
uuid: 892caf69-609f-4201-863c-f9cff6614ff3
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: e-commerce
content-type: reference
discoiquuid: 0129e301-4544-44a6-ae76-bd8fc10e8ea7
...
The hybris extension of the eCommerce Integration Framework has been updated to support Hybris 5 (as default), while maintaining backward compatibility with [Hybris 4](../../../../6-5/sites/developing/using/hybris.md#developing-for-hybris).
...
1. Install the demonstration content packages using the [package manager](../../../../6-5/sites/administering/using/package-manager.md):
...
>[!NOTE]
>
>For developers [API documentation](../../../../6-5/sites/developing/using/ecommerce.md#api-documentation) is also available for download.
