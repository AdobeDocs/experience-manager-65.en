...
uuid: 6c140af3-5111-4dfe-885c-496c3e4e4e84
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: upgrading
discoiquuid: 3b669693-8421-417c-bd18-410a36afead5
index: y
internal: n
snippet: y
---
...
* [Ensure Sufficient Disk Space](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#ensure-sufficient-disk-space)
* [Fully Back Up AEM](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#fully-back-up-aem)
* [Back Up Changes to /etc](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#backup-changes-etc)
* [Generate The quickstart.properties File](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#generate-quickstart-properties)
* [Configure Workflow and Audit Log Purging](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#configure-wf-audit-purging)
* [Install, Configure, and Run The Pre-Upgrade Tasks](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#install-configure-run-pre-upgrade-tasks)
* [Disable Custom Login Modules](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#disable-custom-login-modules)
* [Remove Updates From The /install Directory](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#remove-updates-install-directory)
* [Stop Any Cold Standby Instances](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#stop-tarmk-coldstandby-instance)
* [Disable Custom Scheduled Jobs](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#disable-custom-scheduled-jobs)
* [Execute Offline Revision Cleanup](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#execute-offline-revision-cleanup)
* [Execute Datastore Garbage Collection](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#execute-datastore-garbage-collection)
* [Upgrade the Database Schema If Needed](/6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.htm#upgradethedatabaseschemaifneeded)
* [Delete Users that Might Hinder the Upgrade](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#delete-users-that-might-hinder-the-upgrade)  

* [Rotate Log Files](../../../../6-5/sites/deploying/using/pre-upgrade-maintenance-tasks.md#rotate-log-files)
...
The `WorkflowPurgeTask` and `com.day.cq.audit.impl.AuditLogMaintenanceTask` tasks require separate OSGi configurations and will not work without them. If they fail during pre-upgrade task execution, missing configurations is the most likely reason. Therefore, make sure to add OSGi configurations for these tasks or remove them altogether from the pre-upgrade optimization tasks list if you do not wish to run them. Documentation for configuring workflow purging tasks can be found at [Administering Workflow Instances](/6-2/sites/administering/using/wf-administering.md#regular purging of workflow instances) and audit log maintenance task configuration can be found at [Audit Log Maintenance in AEM 6](/6-5/sites/administering/using/operations-audit-log.md).

For workflow and audit log purging on CQ 5.6 as well as audit log purging on AEM 6.0, see [Purge workflow and audit nodes](/kb/howtopurgewf.md).
...
The managed bean functionality can be accessed using the [JMX Console](../../../../6-5/sites/administering/using/jmx-console.md).
...
>
>For an example of `LoginModule` configuration in AEM 6, see [Configuring LDAP with AEM 6](/6-5/sites/administering/using/ldap-config.md).
...
After running revision cleanup on CRX3 instances, you should run Datastore Garbage Collection to remove any unreferenced blobs in the data store. For instructions, see the documentation on [Data Store Garbage Collection](../../../../6-5/sites/administering/using/data-store-garbage-collection.md).
...
1. Create a backup of the user(s) causing the problem. You can do this via Package Manager. For more information, see [How to Work with Packages.](../../../../6-5/sites/administering/using/package-manager.md)
