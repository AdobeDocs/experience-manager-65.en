...
uuid: 074cba73-a7b8-4bdd-a497-343556bd6446
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: platform
discoiquuid: 49f3b425-c9b4-4847-bbab-3a7f88b04697
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>* Digital asset use cases need more base memory. See [Deploying and Maintaining](../../../../6-5/sites/deploying/using/deploy.md#default-local-install) for details.
>* [AEM Forms add-on package](../../../../6-5/forms/using/installing-configuring-aem-forms-osgi.md) requires 15 GB of temporary space.  
>

For further information, see the [Hardware Sizing Guidelines](../../../../6-5/managing/using/hardware-sizing-guidelines.md).
...
>[!NOTE]
>
>See [Deploying Communities](../../../../6-5/communities/using/deploy-communities.md) for additional information regarding the AEM Communities capability.
...
>
>To get the most of your AEM deployment with MongoDB, Adobe recommends licensing the MongoDB Enterprise version to benefit from professional support. See [Recommended Deployments](../../../../6-5/sites/deploying/using/recommended-deploys.md#prerequisites-and-recommendations-when-deploying-aem-with-mongomk) for more information.
>
...
The Dispatcher is the caching and load balancing component. [Download the latest Dispatcher version](/dispatcher/release-notes.md). Experience Manager 6.5 requires Dispatcher version 4.3.2 or higher.
...
AEM Dynamic Media is disabled by default. See here to [enable Dynamic Media](../../../../6-5/assets/using/config-dynamic.md#enabling-dynamic-media).
...
* **Operating Systems:**
    ...
    * Linux (32-bit and 32-bit application support on 64-bit systems). For steps to install 32-bit client libraries, see [How to enable XMP extraction and write-back on 64-bit RedHat Linux](/kb/enable-xmp-write-back-64-bit-redhat.md).  
...
See detailed information at [Copyright, Licenses, and Disclaimers](/6-5/release-notes/licenses.md).  
