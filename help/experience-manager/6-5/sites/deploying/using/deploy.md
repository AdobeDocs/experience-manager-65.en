...
uuid: 73f82bb7-ae90-4eb1-9628-50a8c9cab3c9
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: deploying
discoiquuid: deea4de6-6f4c-4f80-b491-480f6103213d
index: y
internal: n
snippet: y
---
...
* [Application Server Install](/6-5/sites/deploying/using/application-server-install.md)
* [Troubleshooting](/6-5/sites/deploying/using/troubleshooting.md)
* [Command Line Start and Stop](/6-5/sites/deploying/using/command-line-start-and-stop.md)
* [Configuring](/6-5/sites/deploying/using/configuring.md)
* [Upgrading to AEM 6.5](../../../../6-5/sites/deploying/using/upgrade.md)
* [eCommerce](../../../../6-5/sites/deploying/using/ecommerce.md)
* [Configuration How-To Articles](/6-5/sites/deploying/using/ht-deploy.md)
* [Web Console](/6-5/sites/deploying/using/web-console.md)
* [Troubleshooting Replication](../../../../6-5/sites/deploying/using/troubleshoot-rep.md)
* [Best Practices](/6-5/sites/deploying/using/best-practices.md)
* [Deploying Communities](../../../../6-5/communities/using/deploy-communities.md)
* [Introduction to the AEM Platform](/6-5/sites/deploying/using/platform.md)
* [Performance Guidelines](/6-5/sites/deploying/using/DO-NOT-DELETE-performance-guidelines-pdf.md)
* [Getting Started with AEM Mobile](/6-5/mobile/using/getting-started-aem-mobile.md)
* [Maintenance Release Vehicle Definitions](/6-5/sites/deploying/using/maintenance-release-vehicle-definitions.md)
* [What is AEM Screens?](/6-5/sites/deploying/using/aem-screens-introduction.md)
...
You can install AEM on servers in your Corporate environment. Typical installation instances include: Development, Testing and Publishing environments. Please refer to the [Getting Started](../../../../6-5/sites/deploying/using/deploy.md#getting%20started) section for basic details on how to get the AEM software to install it locally.

To learn more about the typical on-premises deployments, refer to [Recommended Deployments](../../../../6-5/sites/deploying/using/recommended-deploys.md).
...
On the client-side, AEM works with all modern browsers (**Microsoft Edge**, **Internet Explorer** 11, **Chrome **51+** **, **Firefox **47+, **Safari** 8+) on both desktop and tablet operating systems. See [Supported Client Platforms](../../../../6-5/sites/deploying/using/technical-requirements.md#supported-client-platforms) for details.
...
In the following section we describe the **standalone installation**. For details on installing AEM in an application server see [Application Server Install](/6-5/sites/deploying/using/application-server-install.md).
...
>[!NOTE]
>
>If you are using symlinks, have a look at [issues with symlink](/kb/changing-symlink.md).
...
* [Authoring](/6-5/sites/authoring/user-guide.md) 
* [Administering](/6-5/sites/administering/user-guide.md)
* [Developing](/6-5/sites/developing/user-guide.md)
* [Managing](../../../../6-5/managing/using/manage-reference.md)
