...
uuid: c47ab421-89b8-4a50-a969-7ee720e22a7a
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: platform
content-type: reference
discoiquuid: e32bec54-7bf0-4fbf-befd-f1e04cb09715
index: y
internal: n
snippet: y
---
...
For more deployment related information, consult the [Deploying and Maintaining](../../../../6-5/sites/deploying/using/deploy.md) section of the documentation.
...
>[!NOTE]
>
>Additional information on the sizing of author instances and the definition of concurrent users can be found in the [Hardware Sizing Guidelines](../../../../6-5/managing/using/hardware-sizing-guidelines.md#authors-working-in-parallel).
...
For a list of supported operating systems for AEM 6, see the [Technical Requirements page](../../../../6-5/sites/deploying/using/technical-requirements.md).
...
For more information how to configure Node Stores, see [Configuring Node Stores and Data Stores in AEM](../../../../6-5/sites/deploying/using/data-store-config.md).
...
<img donotlocalize="true" imagerotate="0" src="do-not-localize/chlimage_1-1.png" />
-->
...
Check the [Dispatcher documentation](/dispatcher/using/dispatcher.md) for more information on how to configure it.
...
For more information on sizing, see the [Hardware Sizing Guidelines](../../../../6-5/managing/using/hardware-sizing-guidelines.md).
...
If AEM is running on a MongoMK persistence manager deployment, [page names are limited to 150 characters.](../../../../6-5/sites/authoring/using/managing-pages.md)
