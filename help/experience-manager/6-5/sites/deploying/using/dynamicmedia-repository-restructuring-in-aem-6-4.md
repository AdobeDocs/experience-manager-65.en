...
uuid: 5cbfbf28-c115-4ca5-969a-01e85e4210d1
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: repository-restructuring
discoiquuid: ca275573-3612-4a76-95ac-f2c0f5992f1b
index: y
internal: n
snippet: y
---
...
As described on the parent [Repository Restructuring in AEM 6.4](/6-5/sites/deploying/using/repository-restructuring.md) page, customers upgrading to AEM 6.4 should use this page to assess the work effort associated with repository changes impacting the Dynamic Media Solution. Some changes require work effort during the AEM 6.4 upgrade process, while others can be deferred until a 6.5 upgrade.

**Prior to 6.5 Upgrade**

* [Custom Adaptive Video Encoding Configurations](../../../../6-5/sites/deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md#custom-adaptive-video-encoding-configurations)
* [Dynamic Media (DMS7) Cloud Configuration](../../../../6-5/sites/deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md#dynamic-media-dms-cloud-configuration)
* [Dynamic Media (DM Hybrid) Cloud Service Configuration](../../../../6-5/sites/deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md#main-pars-header-501711721)
* [Dynamic Media - YouTube Cloud Service Configuration](../../../../6-5/sites/deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md#main-pars-header-1269596831)
* [Misc](../../../../6-5/sites/deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md#misc)
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   <td><strong>Notes</strong></td> 
   <td><p>See also <a href="../../../../6-5/assets/using/config-dms7.md#optional-migrating-dynamic-media-presets-and-configurations-from-to-zero-downtime">(Optional) Migrating Dynamic Media presets and configurations from 6.3 to 6.5 Zero Downtime</a>.</p> </td> 
  </tr>
 </tbody>
</table>
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   <td><strong>Notes</strong></td> 
   <td>See also <a href="../../../../6-5/assets/using/config-dynamic.md#optionalmigratingdynamicmediapresetsandconfigurationsfrom63to65zerodowntime">(Optional) Migrating Dynamic Media presets and configurations from 6.3 to 6.5 Zero Downtime</a>.</td> 
  </tr>
 </tbody>
</table>
