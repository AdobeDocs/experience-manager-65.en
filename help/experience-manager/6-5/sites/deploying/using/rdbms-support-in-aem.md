...
uuid: 36e67cb6-b3c0-4c85-8a57-c0c4ee62d26b
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: deploying
discoiquuid: 80bdc7b0-ae0e-42fb-9990-3892f9c1ee22
index: y
internal: n
snippet: y
---
...
For more information on the level of Relational Database support in AEM, please see the [Technical Requirements page](../../../../6-5/sites/deploying/using/technical-requirements.md).
...
1. Configure the data source and the JDBC parameters by creating another configuration file with the following name in the `crx-quickstart\install` folder:
   ...
   >[!NOTE]
   >
   >For detailed information on the data source configuration for each supported database, see [Data Source Configuration Options](../../../../6-5/sites/deploying/using/rdbms-support-in-aem.md#data-source-configuration-options).
...
* `url:` The URL string of the database that needs to be used with JDBC. Each database type has its own URL string format. For more info, see [URL String Formats](../../../../6-5/sites/deploying/using/rdbms-support-in-aem.md#url-string-formats) below.  
