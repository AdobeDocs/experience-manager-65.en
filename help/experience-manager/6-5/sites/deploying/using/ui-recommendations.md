...
uuid: 9b3a10df-902a-4937-bb87-3a5310fb2fba
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: best-practices
discoiquuid: 30793a8c-d5c9-4611-863d-027fce36a762
index: y
internal: n
snippet: y
---
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    <ol> 
     <li>Update your components dialogs to use the Coral 3 dialog format. Adobe recommends to use the <a href="/6-5/sites/developing/using/dialog-conversion.md">Dialog Conversion Tool</a> to update the components.</li> 
    </ol> </td> 
  </tr> 
  <tr> 
...
See the Knowledge Base article, [Touch UI Authoring FAQ](/kb/index/touchui_faq.md), for details; including any information about the deprecation schedule for the classic UI.

### Selecting Your UI {#selecting-your-ui}

See [Selecting Your UI](../../../../6-5/sites/authoring/using/select-ui.md) for information about configuring your system as required.

### Touch-Enabled UI Status {#touch-enabled-ui-status}

For details of the enhancements made to the touch-enabled UI in the AEM 6.5 see [What's New](../../../../6-5/release-notes.md#what-s-new) in the Release Notes.

A complete overview see the [Touch UI Feature Status](../../../../6-5/release-notes/touch-ui-features-status.md) page
...
* [Touch-enabled UI architecture](../../../../6-5/sites/developing/using/touch-ui-concepts.md).
* Use the [Dialog Conversion tool](/6-5/sites/developing/using/dialog-conversion.md) to convert component Edit dialogs from the classic UI to the touch-enabled UI.  

* [Structure of the touch-enabled UI](/6-5/sites/developing/using/touch-ui-structure.md).  

* [Customizing the consoles in the touch-enabled UI](../../../../6-5/sites/developing/using/customizing-consoles-touch.md) (includes sample code).  

* [Customizing page authoring in the touch-enabled UI](/6-5/sites/developing/using/customizing-page-authoring-touch.md) (includes sample code).  
