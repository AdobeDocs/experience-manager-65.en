...
uuid: eb166a89-422a-4fce-8d78-0468eca9760b
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: configuring
content-type: reference
discoiquuid: f855831f-c0c4-4f72-b00b-040584418d39
index: y
internal: n
snippet: y
---
...
For further information see [AEM Logging](/6-5/sites/deploying/using/configure-logging.md) and [Sling Logging](http://sling.apache.org/site/logging.html).
...
>[!NOTE]
>
>This setting is automatically configured for production instances if you run AEM in [Production Ready Mode](/6-5/sites/administering/using/production-ready.md).
...
For further information see [AEM Logging](/6-5/sites/deploying/using/configure-logging.md#global-logging) and [Sling Logging](http://sling.apache.org/site/logging.html).
...
See the [Security Checklist - Issues with Cross-Site Request Forgery](../../../../6-5/sites/administering/using/security-checklist.md#protect-against-cross-site-request-forgery) for further details.
...
When using [closed user groups](../../../../6-5/sites/administering/using/cug.md) you can configure (amongst others):
...
>[!NOTE]
>
>See [Page Impressions](/6-5/sites/deploying/using/configuring.md#enabling-page-impressions) for more information.
...
See [Version Purging](../../../../6-5/sites/deploying/using/version-purging.md) for more information.
...
See also [Enabling HTTP Over SSL](/6-5/sites/deploying/using/config-ssl.md) for details on the SSL-related options and a complete description on how to enable HTTPS for CQSE.
