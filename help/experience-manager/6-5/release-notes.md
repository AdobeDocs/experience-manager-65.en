...
uuid: f2045e99-4633-4c25-a4f2-e358b539b1e7
contentOwner: chuesler
topic-tags: release-notes
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5
discoiquuid: 189dfc71-c1e5-4664-97e2-ae8ba3834ccb
index: y
internal: n
snippet: y
---
...
<table border="1" cellpadding="1" cellspacing="0" width="781"> 
 <tbody>
  ...
  <tr>
   ...
   <td>See <a href="/aem-releases-updates.md">AEM Releases and Updates</a></td> 
  </tr>
 </tbody>
</table>
...
Full list of changes in [AEM Foundation](../6-5/release-notes/wcm-platform.md).
...
* For optimal performance, override default GC values with other values. For more information, please see the [Install & Update](../6-5/sites/deploying/using/custom-standalone-install.md) section.
...
* There are now [two versions of the Uberjar](../6-5/sites/developing/using/ht-projects-maven.md#experience-manager-api-dependencies), a recommended version with public interfaces that are not marked for deprecation, as well as a version that includes interfaces marked for deprecation.
...
* The [Select All](../6-5/sites/authoring/using/basic-handling.md#select-all) action is a quick way to execute an action with all pages/assets in the same folder
* The [Select All](../6-5/sites/authoring/using/basic-handling.md#select-all) action attempts to perform the action to all pages/assets, not just what has been loaded. A warning dialog will be shown if the action has not been upgraded to handle Bulk Actions

>[!CAUTION]
>
>Adobe does not plan to make further enhancements to the Classic UI. AEM 6.5 has the Classic UI included, and customers upgrading from earlier releases can keep using it as is. Note that Classic UI remains fully supported while being deprecated. [Read more](../6-5/sites/deploying/using/ui-recommendations.md).
...
Full list of changes in [AEM Sites and Add-ons](../6-5/release-notes/sites.md).

#### Managed Single-page Apps {#managed-single-page-apps}

The Page Editor adds the ability to in-context edit content and compose/layout within client-side rendered experiences (also known [as SPA Editor](../6-5/sites/developing/using/spa-architecture.md)). Existing single-page apps build with JavaScript framework React or Angular can be extended with the AEM SJ SDK to be made editable for practitioners.
...
AEM has the ability to serve the content in various formats and from various levels of the stack. Some have been around since 2008 with the [Sling GET](https://sling.apache.org/documentation/bundles/rendering-content-default-get-servlets.html) and [POST Servlet](https://sling.apache.org/documentation/bundles/manipulating-content-the-slingpostservlet-servlets-post.html). Content Services ([Sling Model Exporter](/kt/platform-repository/using/sling-model-exporter-tutorial-develop.md)) was introduced in AEM 6.3 and is the method used by the AEM SJ SDK to hydrate single-page apps. The [HTTP API for Assets](../6-5/assets/using/mac-api-assets.md) is a CRUD API, that was extended for AEM 6.5.

New HTTP API capabilites:

* Added [Content Fragment support to HTTP API for Assets](../6-5/assets/using/assets-api-content-fragments.md) to create, update, read and delete fragments.
...
For more details on changes to AEM Screens - see the Release Notes in the [AEM Screens User Guide](/6-5/screens/user-guide.md).

### Experience Manager Assets {#experience-manager-assets}

Full list of changes in [AEM 6.5 Assets release notes](../6-5/release-notes/assets.md).
...
See the [Summary of new features and enhancements in AEM 6.5 Forms](../6-5/forms/using/whats-new.md) for information about new and improved features and documentation resources.******`<sub>``<sup>``<strike>`
...
For detailed list of changes, see [AEM 6.5 Communities release notes](../6-5/release-notes/communities-release-notes.md).
...
* Dispatcher 4.3.2 or later for the various web servers and platforms ([download link](/dispatcher/release-notes.md))
* Plug-in for Eclipse IDE ([read more and download](/6-5/sites/developing/using/aem-eclipse.md))  

* Extension for Brackets Code Editor ([read more and download](/6-5/sites/developing/using/aem-brackets.md))
...
* We.Retail Reference implementation ([read more](/6-5/sites/developing/using/we-retail.md))
...
* Package to add enhanced PDF Rasterizer ([read more](../6-5/assets/using/aem-pdf-rasterizer.md))
* Package to add extended RAW image support ([read more](../6-5/assets/using/camera-raw.md))
...
See [installation instructions](../6-5/sites/deploying/using/custom-standalone-install.md) for setup requirements.

Please see [upgrade documentation](../6-5/sites/deploying/using/upgrade.md) for detailed instructions.

## Supported Platforms {#supported-platforms}

Please find the complete matrix of supported platforms incl. Support-Level on [AEM 6.5 Technical Requirements](../6-5/sites/deploying/using/technical-requirements.md)
...
For Adobe Experience Manager 6.5, [read the list of deprecated and removed capabilities](../6-5/release-notes/deprecated-removed-features.md). The page also contains pre-announcement of changes in the near future and important notice for customers that update from prior releases.

## Known Issues {#known-issues}

[List of known issues](../6-5/release-notes/known-issues.md)
...
<li><a href="/6-5/sites/developing/using/reference-materials/diff-previous/changes.md">API Differences between AEM 6.3 and AEM 6.4</a></li>
</ul>
-->
