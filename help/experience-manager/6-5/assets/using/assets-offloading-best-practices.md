...
uuid: 40fd2128-1aab-4cfc-8296-91bd4f116ba4
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 3724d4a9-fe65-4928-87bb-8729e9302bf3
index: y
internal: n
snippet: y
---
...
For details around configuring a datastore, see [Configuring node stores and data stores in AEM](../../../6-5/sites/deploying/using/data-store-config.md).
...
* [Offloading Jobs](/6-5/sites/deploying/using/offloading.md) 
* [Assets workflow offloader](/6-5/sites/administering/using/workflow-offloader.md)
