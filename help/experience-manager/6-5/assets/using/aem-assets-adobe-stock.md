...
uuid: 5f6d218c-2bcc-4057-8c26-332ea90244ed
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: authoring
discoiquuid: 136db08e-e101-4d91-a112-a9face19de0d
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Assets searched from Adobe Stock are just displayed in AEM. Adobe Stock assets are fetched and stored in AEM repository only after a user either [saves an asset](../../../6-5/assets/using/aem-assets-adobe-stock.md#saveassets) or [licenses an asset](../../../6-5/assets/using/aem-assets-adobe-stock.md#licenseassets). Assets that are already stored in AEM are displayed and highlighted for ease of reference and access. Also, such assets are saved with some additional metadata to indicate the source as Adobe Stock.
...
[Video tutorial on using Adobe Stock assets with AEM Assets](/kt/assets/using/stock-assets-feature-video-use.md)
