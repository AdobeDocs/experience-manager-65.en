...
uuid: 3e59faa5-4344-4f67-be28-948cf678583e
contentOwner: Rick Brough
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: ae502c42-18b8-469e-a49b-3628d9a157f3
...
This section describes how to create, modify, and generally manage image presets. You can apply an image preset to an image anytime you preview it. See [Applying Image Presets](/6-5/assets/using/image-presets.md).
...
See also [Viewing pages of a multi-page file](../../../6-5/assets/using/managing-linked-subassets.md#viewingpagesofamultipagefile).  
...
See [Integrating AEM Assets with InDesign Server](../../../6-5/assets/using/indesign.md).  
