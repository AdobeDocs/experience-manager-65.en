...
uuid: 541fc81c-f71a-4a15-ae18-6b7611dc89b4
contentOwner: asgupta
topic-tags: managing-assets
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
discoiquuid: d0470ddb-5612-4294-82b3-6ec29b755516
index: y
internal: n
snippet: y
---
...
AEM allows you to extend the functionality using the MSM Java APIs. For Assets, the extending works just the same as it works with MSM for Site. For details, see [Extending the MSM](../../../6-5/sites/developing/using/extending-msm.md) and the following for information about specific tasks:

* [Overview of APIs](../../../6-5/sites/developing/using/extending-msm.md#overview-of-the-java-api)  

* [Create a new synchronization action](../../../6-5/sites/developing/using/extending-msm.md#creating-a-new-synchronization-action)
* [Create a new rollout configuration](../../../6-5/sites/developing/using/extending-msm.md#creating-a-new-rollout-configuration)  

* [Create and use a simple LiveActionFactory class](../../../6-5/sites/developing/using/extending-msm.md#creating-and-using-a-simple-liveactionfactory-class)
...
Comment Type: remark
Last Modified By: Ashish Gupta . (asgupta)
Last Modified Date: 2019-06-20T09:53:47.800-0400
<p>Cannot use or is not available? Add service pack. See prereq above.<br /> </p>
<p>Cannot configure? </p>
<p>Conflict during rollout?</p>
<p>Cannot resume?</p>
<p>Too many changes, how to revert?<br /> </p>
-->
