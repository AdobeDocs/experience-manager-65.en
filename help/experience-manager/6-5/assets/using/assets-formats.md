...
uuid: 58bbffc0-29ac-4ae9-9b87-63a46cf16352
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 980ca6b8-5b5d-4a24-95b9-42044131da68
index: y
internal: n
snippet: y
---
...
| PPM |x |x |  |  |  |  |x |  |  |  |  |  |
| PSD&#42; |x |x |x |x |  |  |x |x |  |  |  |  |
| [EPS](../../../6-5/assets/using/managing-image-presets.md#adobe-illustrator-ai-postscript-eps-and-pdf-file-formats) |x |x |x |x |  |x |  |x |x |x |x |x |
| PICT |  |  |  |  |  |  |x |x |  |  |  |  |
| PSB |x  |x  |x  |x  |  |  |  |  |  |  |  |  |

>[!NOTE]
>
>* Support for EPS files applies to raster images only. For example, thumbnail generation for EPS vector images is not supported by default. To add support, [configure ImageMagick](../../../6-5/assets/using/best-practices-for-imagemagick.md)*. *For information about integrating third-party tools to enable extra capabilities, see [Command Line Base Media Handler](/6-5/assets/using/media-handlers.md#command-line-based-media-handler).
>
...
>* To use Dynamic Media to preview and generate dynamic renditions for EPS files, see [Adobe Illustrator (AI), Postscript (EPS), and PDF file formats.](../../../6-5/assets/using/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
...
For details, see [Using PDF Rasterizer](../../../6-5/assets/using/aem-pdf-rasterizer.md).
...
The Adobe Camera Raw library enables AEM Assets to ingest raw images. For details, see [Camera Raw Support](../../../6-5/assets/using/camera-raw.md).
...
<table border="1" cellpadding="1" cellspacing="0" columns="3" header="none" width="400"> 
 <tbody>
  ...
  <tr>
   <td><a href="../../../6-5/assets/using/managing-image-presets.md#adobe-illustrator-ai-postscript-eps-and-pdf-file-formats"><strong>AI</strong></a></td> 
  ...
  <tr>
   <td title="Adobe PDF"><a href="../../../6-5/assets/using/managing-image-presets.md#adobe-illustrator-ai-postscript-eps-and-pdf-file-formats"><strong>PDF</strong></a></td> 
   <td style="text-align: center;">x</td> 
   <td style="text-align: center;">x</td> 
   <td style="text-align: center;">x</td> 
   <td style="text-align: center;">x</td> 
  ...
  <tr>
   <td title="Adobe In Design"><strong><a href="../../../6-5/assets/using/managing-image-presets.md#indesign-indd-file-format">INDD</a></strong></td> 
   <td style="text-align: center;">x</td> 
   <td style="text-align: center;">x</td> 
   <td style="text-align: center;"> </td> 
   <td style="text-align: center;">x</td> 
...
>[!NOTE]
>
>* To use Dynamic Media to generate dynamic renditions for PDF files, see [Adobe Illustrator (AI), Postscript (EPS), and PDF file formats.](../../../6-5/assets/using/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
>* To use Dynamic Media to preview and generate dynamic renditions for AI files, see [Adobe Illustrator (AI), Postscript (EPS), and PDF file formats.](../../../6-5/assets/using/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
>* To use Dynamic Media to generate dynamic renditions for INDD files, see [InDesign (INDD) file format](../../../6-5/assets/using/managing-image-presets.md#indesign28indd29fileformat) [](../../../6-5/assets/using/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
>
...
See [Configure MIME type-based for upload job parameters support](../../../6-5/assets/using/config-dynamic.md#configuringmimetypebasedassetsforuploadjobparametersupport).

See also [Enabling MIME type-based Assets/Scene7 upload job parameter support](/6-5/sites/administering/using/scene7.md#enabling-mime-type-based-assets-scene-upload-job-parameter-support).
