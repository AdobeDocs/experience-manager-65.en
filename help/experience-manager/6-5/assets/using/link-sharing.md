...
uuid: 3b5c4c43-c277-4f95-9e21-4a4132483664
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 5507d51a-332f-4ba8-ba0e-d2beb149073b
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Before you share a link with users, ensure that Day CQ Mail Service is configured. An error occurs if you attempt to share a link without first [configuring Day CQ Mail Service](../../../6-5/assets/using/link-sharing.md#configure-day-cq-mail-service).
...
1. From the toolbar, click/tap the **[!UICONTROL Share Link]** ![](assets/assets_share.png).
   ...
   ![Dialog with the Link Share](assets/chlimage_1-179.png)
...
1. In the email address box of the **[!UICONTROL Link Sharing]** dialog, type the email ID of the user you want to share the link with. You can also share the link with multiple users.
   ...
   To enable emails to be sent out to users, configure the SMTP server details in [Day CQ Mail Service](../../../6-5/assets/using/link-sharing.md#configure-day-cq-mail-service).

   ![Share links to assets directly from the Link Sharing dialog](assets/chlimage_1-180.png)
