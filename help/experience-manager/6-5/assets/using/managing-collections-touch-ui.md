...
uuid: 7faa7c71-9570-4883-94d7-47b28712f606
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
content-type: reference
topic-tags: authoring
discoiquuid: 22724dc2-7ed8-4312-8a1b-61e34e897851
index: y
internal: n
snippet: y
---
...
1. Tap/click **Create**, and then tap/click **OK** to close the dialog. A collection with the specified title and properties is opened in the Collections console.
   ...
   To add assets to the collection, navigate to the Assets user interface. For details, see [Adding assets to a collection](../../../6-5/assets/using/managing-collections-touch-ui.md#adding-assets-to-a-collection).
...
Editing saved searches is the same as editing smart collections. For details, see [Editing a smart collection](../../../6-5/assets/using/managing-collections-touch-ui.md#editing-a-smart-collection).
...
* [Configure AEM Assets email notifications](/6-5/sites/administering/using/notification.md#assetsconfig)
* [Edit metadata properties of multiple Collections](/6-5/assets/using/managing-multiple-assets.md)
* [Create a review task for Collections](/6-5/assets/using/bulk-approval.md)
