...
uuid: 4f301f47-3629-48c8-9559-dc11ef1046f8
topic-tags: brand-portal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
discoiquuid: ba3bdfc1-2720-4517-a214-db1f814c7ac8
index: y
internal: n
snippet: y
---
...
1. In the **Client ID** field, paste the application ID you copied at the end of the procedure [Create an application](../../../6-5/assets/using/brand-portal-configuring-integration.md#create-jwt-application). Click **OK**.
...
1. Display the public key using one of the following methods mentioned in the last step of the procedure [Add a new configuration to Marketing Cloud](../../../6-5/assets/using/brand-portal-configuring-integration.md#create-a-new-cloud-configuration).

    * Click the **Display Public Key** button to display the key.
    * Open the downloaded file containing the key.

1. Open the Marketing Cloud Developer Connection interface and click the application you created in [Create an application](../../../6-5/assets/using/brand-portal-configuring-integration.md#create-jwt-application).
...
* [Publish assets and folders to Brand Portal](../../../6-5/assets/using/brand-portal-publish-folder.md)
