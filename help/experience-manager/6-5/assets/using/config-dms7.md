...
uuid: 21576eb5-0ac4-42e1-b404-7e4496523bc8
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 3e083a77-f410-4441-a4d0-8d16ef215aa7
index: y
internal: n
snippet: y
---
...
Last Modified Date: 2019-04-29T16:43:18.983-0400
...
<p> </p>
<p>[rb] - This feature pack 18912... does it apply to 6.4 and/or 6.5?</p>
-->
...
See [Installing feature pack 18912 for bulk asset migration](../../../6-5/assets/using/bulk-ingest-migrate.md) for more information.
...
1. On the right side of the CRXDE Lite page, in the lower portion:
    ...
    * double-click **jobParam** to open its associated text field. See [Supported Mime Types](../../../6-5/assets/using/assets-formats.md#supported-mime-types) for a list of permitted processing parameter values you can use for a given mime type.
