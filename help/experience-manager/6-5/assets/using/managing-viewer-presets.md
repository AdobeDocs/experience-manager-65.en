...
uuid: 5144759d-5b37-4b64-8f8e-203dfb57da7e
contentOwner: Alva Ware-Bevacqui
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: ec3bece7-0f22-4d55-80f2-6134e0045c87
...
This section describes how to create, edit, and manage viewer presets. You can apply a viewer preset to an asset anytime you preview it. See [Applying Viewer Presets](/6-5/assets/using/viewer-presets.md).
  ...
  <tr> 
   ...
   <td><p>The Panoramic Image and PanoramicVR viewers render spherical panoramic images to immerse users in a 360° viewing experience of a room, property, location, or landscape.</p> <p>For an uploaded image to qualify as a spherical panorama, it must have either one or both of the following:</p> 
    <ul> 
     ...
     <li>Tagged with the keywords <span class="kbd">equirectangular</span>, or <span class="kbd">spherical</span> and <span class="kbd">panorama</span>, or <span class="kbd">spherical </span>and <span class="kbd">panoramic</span>. See <a href="../../../6-5/sites/authoring/using/tags.md">Using Tags</a>.</li> 
...
See also [Previewing Assets](../../../6-5/assets/using/previewing-assets.md).
...
1. Select a viewer preset** **from the left pane to apply it to the asset.
   ...
   You can [copy the URL to share](/6-5/assets/using/linking-urls-to-yourwebapplication.md) with other users.

## Delivering Assets with Viewer Presets {#delivering-assets-with-viewer-presets}

To get the URLs for Viewer Presets, see [Linking URLs to your Web application](/6-5/assets/using/linking-urls-to-yourwebapplication.md). See also [Embedding the Video Viewer on a Web Page](/6-5/assets/using/embed-code.md).

If you are using AEM as your WCM, you can add assets using the viewer presets directly on the page. See [Adding Dynamic Media Assets to Pages](../../../6-5/assets/using/adding-dynamic-media-assets-to-pages.md).
