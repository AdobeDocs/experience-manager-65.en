...
uuid: 699ba127-d6d1-45c0-a17f-725ba31b777d
contentOwner: rbrough
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 6a369288-1104-4f8e-ae76-cc498a058426
index: y
internal: n
snippet: y
---
...
1. [Apply an adaptive video profile to the folder](../../../6-5/assets/using/video-profiles.md#applying-a-video-profile-to-folders).
    ...
    * [Create a custom Adaptive Video Profile](../../../6-5/assets/using/video-profiles.md#creating-a-video-encoding-profile-for-adaptive-streaming) with higher quality renditions. For example, you may want to create an Adaptive Video Profile that contains the following three settings:
...
1. [Upload your video to the folder](../../../6-5/assets/using/managing-video-assets.md#uploadingandpreviewingvideoassets).
...
The aspect ratio applies to 360 video assets for the asset details page and the [Video 360 Media WCM component](../../../6-5/assets/using/adding-dynamic-media-assets-to-pages.md#dynamic-media-components).
...
See also [Editing Viewer Presets](../../../6-5/assets/using/managing-viewer-presets.md#editing-viewer-presets).
...
See [Publishing Dynamic Media Assets](/6-5/assets/using/publishing-dynamicmedia-assets.md) for details on how to publish 360 Video.
