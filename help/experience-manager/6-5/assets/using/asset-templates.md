...
uuid: cd830f8c-42ca-4439-bd5f-ee5a684b8283
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 27568db6-2c40-4f8f-b5b1-4bae4d90b19b
index: y
internal: n
snippet: y
---
...
1. To open the collateral for editing, do one of the following:
    ...
    * Open the collateral (brochure in this case) you created in step 7 of [Creating a Collateral](../../../6-5/assets/using/asset-templates.md#creating-a-collateral).
   ...
   >[!NOTE]
   >
   >Ensure that your AEM instance is integrated with an InDesign server to enable AEM Assets to extract data from the InDesign template and make it available for editing. For details, see [Integrating AEM Assets with InDesign Server](../../../6-5/assets/using/indesign.md).
...
1. Click/tap the **Preview** icon on the toolbar to preview all the changes. Click/tap **Done** to save the editing changes to the collateral.
   ...
   >    
   >    
   >For more information around working with InDesign documents, see [Best Practices for Working with InDesign Documents in AEM](/kb/best-practices-idd-docs-aem.md).
