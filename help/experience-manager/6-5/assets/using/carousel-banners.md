...
uuid: bfe5ec37-5d59-49e1-a8ae-9012b2633a56
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 3981ba28-defd-44d3-be00-237e9fa45971
index: y
internal: n
snippet: y
---
...
1. [Identify hotspot and image map variables](#identifying-hotspot-and-image-map-variables) (only for customers using AEM Assets + Dynamic Media)
   ...
   >[!NOTE]
   >
   >If you are an AEM Sites or Ecommerce customer, you can use the built-in feature to navigate to product pages and lookup the existing skus in the product catalog. You do not need to manually enter hotspot or image map variables. See information on [setting up eCommerce](../../../6-5/sites/administering/using/generic.md).
   >
   >
...
1. Optional: [Create a Carousel Set viewer preset](../../../6-5/assets/using/managing-viewer-presets.md), as needed.****
...
1. Do one of the following:
    ...
    * [Add a carousel banner to your website in AEM  
      ](../../../6-5/assets/using/adding-dynamic-media-assets-to-pages.md)If you are an AEM Sites customer you can add the carousel set directly to the page in AEM, using the Interactive Media component.
...
>[!NOTE]
>
>If you are an AEM Sites and/or AEM Ecommerce customer, skip this step. You do not need to manually identify hotspot or image map variables; you can use the integration with Ecommerce for product integration. See information on [setting up eCommerce](../../../6-5/sites/administering/using/generic.md). In addition, you can use the Interactive component and add it to your web page.
>
...
To upload image banners, see [Uploading assets](../../../6-5/assets/using/managing-assets-touch-ui.md).

<!--
Comment Type: draft

<ol>
<li><p>Upload image banners that you want to make interactive.<br /> </p> <p>See <a href="../../../6-5/assets/using/managing-assets-touch-ui.md">Uploading assets</a>.<br /> </p> <p>You are now ready to create a carousel set; see the next task below.</p> </li>
</ol>
-->
...
1. You can change the visual design and behavior of carousel sets by tapping or clicking the Behavior and Appearance tabs and making adjustments to how your carousel banner looks or how specific components behave. See [managing viewer presets](/6-5/assets/using/viewer-presets.md) for more information on how to use the viewer editor.
   ...
   >    
   >    
   >See [Special Considerations for Carousel Banners](/6-5/assets/using/viewer-presets.md#specialconsiderationsforcreatingacarouselbannerviewerpreset) for detailed instructions and more information on the viewer editor.
   >
   >
...
See [Experience Fragment](../../../6-5/sites/authoring/using/experience-fragments.md).
...
>[!NOTE]
>
>When you add hotspots to an image in an [Interactive Image](../../../6-5/assets/using/interactive-images.md) or a Carousel Banner, the hotspot information is stored in the same metadata location - relative to the image's location--regardless of whether it is an Interactive Image or a Carousel Banner. This functionality means that you can easily re-use the same image - along with its defined hotspot data - in either viewer.  
...
* Add slides to a Carousel Set. See also [Working with Selectors](/6-5/assets/using/working-with-selectors.md).
* Re-order slides in the Carousel Set.
* Delete assets in the Carousel Set.
* Apply a viewer preset.  
* Delete the Carousel Set.
* Add or edit hotspots and image maps. See also [Working with Selectors](/6-5/assets/using/working-with-selectors.md).
...
See [Publishing Dynamic Media Assets](/6-5/assets/using/publishing-dynamicmedia-assets.md) for info on how to publish carousel banners.
...
>[!NOTE]
>
>If you are an AEM Sites customer, you can add the carousel banner directly to your page by dragging the Interactive Media component to your page. See [Adding Dynamic Media Assets to Pages.](../../../6-5/assets/using/adding-dynamic-media-assets-to-pages.md)
