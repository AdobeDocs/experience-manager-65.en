...
uuid: bc066f20-18cc-4b9f-b2f1-23d9bdfa96c3
contentOwner: Alison Heimoz
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: content-fragments
content-type: reference
discoiquuid: ab6852a3-1a49-46d9-bf54-7f96c878469b
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Content fragments are then used with authoring pages; see [Page Authoring with Content Fragments](../../../6-5/sites/authoring/using/content-fragments.md).

## Creating Content Fragments {#creating-content-fragments}

### Creating a Content Model {#creating-a-content-model}

[Content fragment models](../../../6-5/assets/using/content-fragments-models.md) can be enabled and created, prior to creating content fragments with structured content.

>[!NOTE]
>
>See [Developing Content Fragments](../../../6-5/sites/developing/using/customizing-content-fragments.md) for further information on templates; used for simple content fragments.
...
1. The first step of the wizard requires you to specify the basis of the new fragment.
    ...
    * This can be a:
        ...
        * [Template](../../../6-5/sites/developing/using/content-fragment-templates.md) - for example **Simple Fragment**
        
        * [Model](../../../6-5/assets/using/content-fragments-models.md) - used to create a fragment that requires structured content; for example the **Airport** model
...
* As [quick actions](../../../6-5/sites/authoring/using/basic-handling.md#quick-actions); a subset of actions available for the individual fragment cards.
...
* **Edit**
    ...
    * Allows you to [open the fragment for editing content](../../../6-5/assets/using/content-fragments-variations.md) together with its elements, variations, associated content and metadata.

* **Manage Tags**
* **To Collection**

    * Add the fragment to a collection.  
    * This can also be done when [associating a collection with the fragment](../../../6-5/assets/using/content-fragments-assoc-content.md#adding-associated-content).
...
>[!NOTE]
>
>Many of these are [standard actions for Assets](../../../6-5/assets/using/managing-assets-touch-ui.md) and/or the [Desktop App](/desktop-app/aem-desktop-app.md).
...
>[!CAUTION]
>
>To edit a content fragment you need [the appropriate permissions](../../../6-5/sites/developing/using/customizing-content-fragments.md#asset-permissions). Please contact your system administrator if you are experiencing issues.
...
1. Navigate through the three modes using the icons in the side panel:
    ...
    * [Annotations](../../../6-5/assets/using/content-fragments-variations.md#annotating-a-content-fragment)
...
>[!NOTE]
>
>Versions can also be [created, compared and reverted from the Timeline](/6-3/assets/using/content-fragments-managing.md#timeline-for-content-fragments).
...
Once you have opened your fragment, you can use the [Variations](../../../6-5/assets/using/content-fragments-variations.md) tab to author your content.

## Creating and Managing Variations within your Fragment {#creating-and-managing-variations-within-your-fragment}

Once you have created the Master content, you can create, and manage, [Variations](../../../6-5/assets/using/content-fragments-variations.md) of that content.

## Associating Content with your Fragment {#associating-content-with-your-fragment}

You can also [associate content](../../../6-5/assets/using/content-fragments-assoc-content.md) with a fragment. This provides a connection so that assets (i.e. images) can be (optionally) used with the fragment when it is added to a content page.
...
You can view, and edit, the properties of a fragment using the [Metadata](../../../6-5/assets/using/content-fragments-metadata.md) tab.

## Timeline for Content Fragments {#timeline-for-content-fragments}

In addition to the standard options, [Timeline](../../../6-5/assets/using/managing-assets-touch-ui.md#timeline) provides both information and actions specific to content fragments:
...
The **Compare to Current** action is available from the [Timeline](/6-3/assets/using/content-fragments-managing.md#timeline-for-content-fragments) after you have selected a specific version.
...
* Directly from the [Timeline](../../../6-5/assets/using/content-fragments-managing.md#timeline-for-content-fragments).  
  Select the required version, then the **Revert to this Version** action.

* While [comparing a version to the current version](../../../6-5/assets/using/content-fragments-managing.md#comparing-fragment-versions) you can **Revert** to the selected version.

## Publishing and Referencing a Fragment {#publishing-and-referencing-a-fragment}

>[!CAUTION]
>
>If your fragment is based on a model, then you should ensure that the [model has been published](../../../6-5/assets/using/content-fragments-models.md#publishing-a-content-fragment-model).
>
...
* When you [publish a page that uses the fragment](../../../6-5/sites/authoring/using/content-fragments.md#publishing); the fragment will be listed in the page references.
