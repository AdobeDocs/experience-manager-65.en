...
uuid: 6e5b090d-4692-4eee-9daf-ceb3e0abb33d
contentOwner: aheimoz
topic-tags: content-fragments
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
content-type: reference
discoiquuid: 1bb3dcac-439f-4d51-9bd2-005a6fe68ec2
index: y
internal: n
snippet: y
---
...
1. **The Content Fragment as a single entity.**
    ...
    * **Permissions**: The [Delete](../../../6-5/sites/administering/using/security.md#actions) permission can be [assigned through User and/or Group Management](../../../6-5/sites/administering/using/security.md#managing-permissions).
...
1. **The multiple sub-entities that make up a content fragment; for example, variations, sub-nodes.**
    ...
    * **Permissions**: See [Permissions Required for Editor Functionality Only](../../../6-5/assets/using/content-fragments-delete.md#permissions-required-for-editor-functionality-only).

>[!NOTE]
>
>When a user does not have any [Delete](../../../6-5/sites/administering/using/security.md#actions) permissions, the Content Fragment editor operates in *read-only* mode.

>[!NOTE]
>
>See also [How to Audit User Management Operations in AEM](../../../6-5/sites/administering/using/audit-user-management-operations.md).
...
>[!NOTE]
>
>The delete permissions, required to edit/update a Content Fragment, are included in the Delete permission [assigned through User and/or Group Management](../../../6-5/sites/administering/using/security.md#managing-permissions).
...
These `remove` privileges must be [administered using Access Control Lists, within CRXDE Lite](../../../6-5/sites/administering/using/user-group-ac-admin.md#access-right-management).
