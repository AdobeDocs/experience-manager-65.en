...
uuid: 90d37bd4-7f77-4556-98fc-ab3687221218
contentOwner: Alison Heimoz
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: content-fragments
content-type: reference
discoiquuid: 4e0d7a5e-c395-4ecf-b58f-04739c128152
index: y
internal: n
snippet: y
---
...
[Variations](../../../6-5/assets/using/content-fragments.md#constituent-parts-of-a-content-fragment) are a significant feature of content fragments, as they allow you to create and edit copies of the master content for use on specific channels, and/or scenarios.
...
* [Summarize Text](#summarizing-text)
* [Annotate](../../../6-5/assets/using/content-fragments-variations.md#annotating-a-content-fragment) your text  
...
>[!NOTE]
>
>For full information see the [Markdown](../../../6-5/assets/using/content-fragments-markdown.md) documentation.
...
* Can be viewed, and deleted, in [Timeline](/6-3/assets/using/content-fragments-managing.md#timeline-for-content-fragments) for the selected fragment.

### Inserting Assets into your Fragment {#inserting-assets-into-your-fragment}

To ease the process of authoring content fragments you can add [Assets](../../../6-5/assets/using/managing-assets-touch-ui.md) (images) directly to the fragment.

They will be added to the paragraph sequence of the fragment without any formatting; formatting can be done when the [fragment is used/referenced on a page](../../../6-5/sites/authoring/using/content-fragments.md).

>[!CAUTION]
>
>These assets cannot be moved or deleted on a referencing page, this must be done in the fragment editor.
>
>However, formatting of the asset (e.g. size) must be done in the [page editor](../../../6-5/sites/authoring/using/content-fragments.md). The representation of the asset in the fragment editor is purely for authoring the content flow.

>[!NOTE]
>
>There are various methods of adding [images](../../../6-5/assets/using/content-fragments.md#fragments-with-visual-assets) to the fragment and/or page.
