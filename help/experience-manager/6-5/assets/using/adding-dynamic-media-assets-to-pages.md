...
uuid: a447f862-e8e1-4d13-aeba-52a0daed9398
contentOwner: Rick Brough
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 72763eb5-dd72-4939-9339-141fe9aec620
index: y
internal: n
snippet: y
---
...
You add Dynamic Media assets directly to the page if you are using AEM as your WCM. If you are using a third-party for your WCM, either [link](/6-5/assets/using/linking-urls-to-yourwebapplication.md) or [embed](/6-5/assets/using/embed-code.md) your assets. For a responsive third-party web site, see [delivering optimized images to a responsive site](/6-5/assets/using/responsive-site.md).

>[!NOTE]
>
>You must publish assets before adding them to pages in AEM. See [Publishing Dynamic Media Assets](/6-5/assets/using/publishing-dynamicmedia-assets.md).
...
1. In the left pane, tap the **Components **icon, then filter for Dynamic Media.
   ...
   If no Dynamic Media components are available, you need to enable the Dynamic Media components. See [Editing Page Templates](../../../6-5/sites/authoring/using/templates.md#editing-templates-template-authors) for more information. 
...
1. Depending on the Dynamic Media component you dropped onto the page, a configuration dialog box opens. [Set the component's options](../../../6-5/assets/using/adding-dynamic-media-assets-to-pages.md#dynamic-media-components) as necessary.
...
* You have [enabled Dynamic Media](../../../6-5/assets/using/config-dynamic.md). Dynamic Media is disabled by default.
...
See also [Image Profiles](/6-5/assets/using/image-profiles.md).
...
* Tagged with the keywords “equirectangular” or (“spherical” + “panorama”) or (“spherical” + “panoramic”). See [Using Tags](../../../6-5/sites/authoring/using/tags.md).
...
If the viewer preset you are looking for is not visible, check to ensure that it is published. You must publish viewer presets before you can use them. See [Managing Viewer Presets](../../../6-5/assets/using/managing-viewer-presets.md).
...
See [HTTP2 Delivery of Content](/6-5/assets/using/http2.md) for complete details on getting started using HTTP/2 with your Dynamic Media account.
