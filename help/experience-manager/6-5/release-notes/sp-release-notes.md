...
<details> 
 ...
 <ul> 
  ...
  <li>Enabled <strong><span class="kbd">Japanese Word Wrap</span></strong> feature via the styles plugin of Rich Text Editor. For more information, see <a href="../../6-5/sites/administering/using/configure-rich-text-editor-plug-ins.md#jpwordwrap">Configure Japanese word wrap</a>.</li> 
 </ul> 
 <h3>Assets</h3> 
 <ul> 
