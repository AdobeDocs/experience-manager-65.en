...
uuid: 1277a3fd-88de-4111-ae9b-10e046540717
contentOwner: jsyal
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
topic-tags: release-notes
content-type: reference
discoiquuid: 8609e8da-85b7-49e0-accc-78976d37871f
index: y
internal: n
snippet: y
---
...
Refer to [**Emergency Channel**](../../../6-5/screens/using/emergency-channel.md) Use Case for implementation.

Additionally, refer to the use case example, ** [Data Triggered Asset Change](../../../6-5/screens/using/data-triggered-asset-change.md)** that describes how to achieve personalized content based on weather of your location.
...
To learn more about how you can enable targeting for assets in AEM Screens project, refer to [**Configuring ContextHub in AEM Screens**](../../../6-5/screens/using/configuring-context-hub.md).
...
Refer to [**Launches**](../../../6-5/screens/using/launches.md) for more details.

* **Offline Configurations in Experience Fragments**

You can now add offline configs (client-side libraries and static files) while configuring Screens experience fragment. Refer to [**Using Experience Fragments**](../../../6-5/screens/using/experience-fragments-in-screens.md) for more details.
