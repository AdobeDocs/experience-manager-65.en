...
uuid: 47a45f52-b2ac-423d-ba73-bf0831265757
contentOwner: jsyal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
topic-tags: authoring
discoiquuid: 3965d06a-11f8-4f0b-95e6-7ed06d6c3bf2
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Refer to [**Embedded Sequences**](../../../6-5/screens/using/embedded-sequences.md) under Authoring Screens section, to learn in detail about embedded sequences.
...
To learn more about how to create an experience fragment and leverage it into an AEM Screens project, refer to ** [Using Experience Fragments](../../../6-5/screens/using/experience-fragments-in-screens.md)**.
