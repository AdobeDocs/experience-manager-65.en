...
uuid: bb531653-66ae-4254-acdb-2e2246e3464d
contentOwner: Jyotika Syal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
topic-tags: troubleshoot
discoiquuid: 1b148779-5b59-4765-a660-94052a3a9ff9
index: y
internal: n
snippet: y
---
...
Additionally, click **Clear cache** and **Update** to clear the cache of your device and update the [firmware](../../../6-5/screens/using/screens-glossary.md) version respectively from this panel.
...
>[!NOTE]
>
>To learn more about the events associated with device's automatic or manual updates, see the section ***Automatic versus Manual Updates from the Device Dashboard*** in [Managing Channels](../../../6-5/screens/using/managing-channels.md).
...
>[!NOTE]
>
>To learn more on these option, See [AEM Screens Player](/6-5/screens/using/working-with-screens-player.md).
...
See [Video Playback Configuration and Troubleshooting](/6-5/screens/using/troubleshoot-videos.md) to debug and troubleshoot videos playing in your channel.
