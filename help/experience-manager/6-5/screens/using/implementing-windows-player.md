...
uuid: 6635aff8-daa6-473e-8788-bcf1cf4762ec
contentOwner: jsyal
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
topic-tags: administering
content-type: reference
discoiquuid: f94e4b4c-8949-4d7f-8bb5-cf0b860e62ba
index: y
internal: n
snippet: y
---
...
1. Enable Shell Launcher.
   ...
   Last Modified Date: 2019-04-12T12:48:47.594-0400
   add link Enable Shell Launcher using Control Panel
   -->
...
1. Refer to [Use Shell Launcher to create a Windows 10 kiosk](https://docs.microsoft.com/en-us/windows/configuration/kiosk-shelllauncher) to modify your PowerShell script for more information.
   ...
   Comment Type: annotation
   Last Modified By: jsyal
   Last Modified Date: 2019-04-12T12:50:11.776-0400
   provide link start
   -->
