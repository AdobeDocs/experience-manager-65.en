...
uuid: dee653cb-9917-48cb-86f3-8a85dc16271b
content-type: reference
topic-tags: developing
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
discoiquuid: 8e922b41-0f95-4f65-a6ae-06c8609a4a1b
index: y
internal: n
snippet: y
---
...
1. Create a new AEM Screens project. Refer to [Creating and Managing Projects](/6-4/screens/using/creating-a-screens-project.md) for more details.
   ...
   >
   >
   >Refer to [Creating and Managing Channels](/6-4/screens/using/managing-channels.md) for more details.

   ![](assets/screen_shot_2019-02-15at100330am.png)

1. Edit any sequence channel and drag and drop an embedded page component.

   Refer to [Adding Components to a Channel](/6-4/screens/using/adding-components-to-a-channel.md) for more details.
...
1. Register a player against this project and you should now be able to see your interactive application running on AEM Screens.
   ...
   Refer to [Device Registration](/6-4/screens/using/device-registration.md) to learn in detail about registering a device.
...
1. Configure Adobe Analytics in AEM Screens.
   ...
   Refer to [Configuring Adobe Analytics with AEM Screens](/6-4/screens/using/configuring-adobe-analytics-aem-screens.md) to learn how to** **perform sequencing in Adobe Analytics with AEM Screens and send custom events using offline Adobe Analytics.
...
1. On the click event or other event that you wish to capture for your component, add the analytics information using the standard data model.
   ...
   Refer to [Configuring Adobe Analytics with AEM Screen](/6-4/screens/using/configuring-adobe-analytics-aem-screens.md)s for more details.
