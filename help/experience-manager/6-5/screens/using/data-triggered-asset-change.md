...
uuid: 0e850265-4955-4f97-b133-a09b068df486
content-type: example
topic-tags: use-case-examples
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
discoiquuid: 9f9e5a2d-e522-4aac-9d53-c7c02dd424ed
index: y
internal: n
snippet: y
---
...
* [Personalization](/6-4/sites/administering/using/personalization.md)
* [Configuring ContextHub](/6-4/sites/administering/using/contexthub-config.md)
* [Configuring Segmentation with ContextHub](/6-4/sites/administering/using/segmentation.md)
* [Authoring Targeted Content Using Targeting Mode](/6-4/sites/authoring/using/content-targeting-touch.md)
