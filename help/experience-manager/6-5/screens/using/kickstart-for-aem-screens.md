...
uuid: e928e754-a918-449d-82ce-d694b87bbcf2
contentOwner: Jyotika syal
content-type: reference
topic-tags: introduction
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
discoiquuid: f7ddb611-5a22-49e7-95f5-f0c798f38e31
index: y
internal: n
snippet: y
---
...
1. To download **AEM Screens Player**, click [here](https://download.macromedia.com/screens/).
   ...
   For implementation of Chrome OS Player, see [**Chrome Management Console**](/6-5/screens/using/implementing-chrome-os-player.html?cq_ck=1513900475345) for more information.

   See [Installing and Configuring Screens](../../../6-5/screens/using/configuring-screens-introduction.md) for more details.
...
1. **Creating a new project**
   ...
   See [Create and Manage Screens Project](/6-5/screens/using/creating-a-screens-project.md) for more details.
...
1. **Creating a new channel**
   ...
   See [Channel Management](../../../6-5/screens/using/managing-channels.md) for more details on creating and managing channels.
...
1. **Adding a Schedule**
   ...
   *Schedules*, in AEM Screens, lets you organise channels into re-usable groups so that you do not have to repeat their assignment individually for each display on which you want to show your content.
   ...
   See [Create and Manage Schedules](/6-5/screens/using/managing-schedules.md) to get detailed information on schedules.
...
1. **Assigning a channel**
   ...
   To learn more about **Channel Assignment** dialog box and the properties associated with it, see [Assign Channels](../../../6-5/screens/using/channel-assignment.md).
...
See [AEM Screens Player](/6-5/screens/using/working-with-screens-player.md) to get more detailed information on AEM Screens player.
...
1. [Manage Devices](/6-5/screens/using/managing-devices.md)
