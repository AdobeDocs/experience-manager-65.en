...
uuid: 1b0b745b-b8a3-4681-8ad8-03073d9e1925
contentOwner: jsyal
products: SG_EXPERIENCEMANAGER/6.5/SCREENS
content-type: reference
topic-tags: troubleshoot
discoiquuid: dc27aff8-b790-4908-800d-de612e930d8d
index: y
internal: n
snippet: y
---
...
For more information on how to implement Android Player, please refer to [**Implementing Android Player**](../../../6-5/screens/using/implementing-android-player.md).
...
For more information on where you can monitor device activity, please refer to [**AEM Screens Notifications Service**](/6-5/screens/using/screens-notifications-service.md).
