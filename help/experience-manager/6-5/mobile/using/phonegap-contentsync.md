...
uuid: 0f2e5870-069e-409f-bd29-1c343d59a130
contentOwner: User
content-type: reference
products: SG_EXPERIENCEMANAGER/6.5/MOBILE
topic-tags: developing-adobe-phonegap-enterprise
discoiquuid: f19c9827-05ea-4c10-9a3a-be8ef3ead858
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>This document is part of the [Getting Started with AEM Mobile](/6-5/mobile/using/getting-started-aem-mobile.md) Guide, a recommended starting point for AEM Mobile reference.
...
>[!NOTE]
>
>To get more information on guidelines for developing Content Sync handlers ade see out of the box app handlers, See [Developing Content Sync Handlers](/6-5/mobile/using/contentsync-app-handlers.md).
...
If you are [configuring the service using the Web Console](/6-5/sites/deploying/using/configuring-osgi.md#osgi-configuration-with-the-web-console), type the name of the user or group as the value of the Fallback Cache Authorizable property.

If you are [configuring in the repository](/6-5/sites/deploying/using/configuring-osgi.md#osgi-configuration-in-the-repository), use the following information about the service:
...
* `REWRITE_EXTERNAL`: rewrites the path by pointing to the resource on the server, using the AEM [Externalizer service](../../../6-5/sites/developing/using/externalizer.md).
...
* [Authoring for Adobe PhoneGap Enterprise with AEM](/6-5/mobile/using/phonegap.md)
* [Administering Content for Adobe PhoneGap Enterprise with AEM](/6-5/mobile/using/administer-phonegap.md)
