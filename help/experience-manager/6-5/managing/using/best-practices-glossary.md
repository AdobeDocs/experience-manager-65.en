...
uuid: c6003391-3788-4c85-b552-1d4fa8adab72
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/MANAGING
topic-tags: managing-checklist
content-type: reference
discoiquuid: df87f6bc-31a9-4e44-b792-72ef8ef59210
index: y
internal: n
snippet: y
---
...
This glossary lists (alpabetically) details of all Deliverable documents from the [Project Checklist](/6-5/managing/using/best-practices-checklist.md).
...
The [application architecture](../../../6-5/managing/using/best-practices.md#development-preparation) should clearly define the behavior of the proposed applications.
...
>[!NOTE]
>
>For an example, see the [AEM Release Notes](../../../6-5/release-notes.md).
