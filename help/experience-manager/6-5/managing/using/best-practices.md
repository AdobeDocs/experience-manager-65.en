...
uuid: f5eec214-0283-456e-82bc-12a814af4bf3
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/MANAGING
topic-tags: managing-checklist
content-type: reference
topic-tags: introduction
discoiquuid: ac659248-6a23-407e-a729-18fab71b5e54
index: y
internal: n
snippet: y
---
...
* An [interactive checklist](/6-5/managing/using/best-practices-checklist.md) that allows you to track and monitor your progress with these best practices.
...
* Documentation, based directly on the [checklist](/6-5/managing/using/best-practices-checklist.md), that details the:
    ...
    * A [Glossary](../../../6-5/managing/using/best-practices-glossary.md) of the [Required Documents and Deliverables](#required-documents-and-deliverables).

* [Further reference](/6-5/managing/using/best-practices-further-reference.md) material to provide more details on specific areas.
...
* **System Architecture**
  ...
  The system architecture defines the conceptual view of your system; including (amongst other information):
    ...
    * [System structure](../../../6-5/sites/deploying/using/recommended-deploys.md#deployment-scenarios) for all required environments
    * Sub-systems
    * Third party systems
    * Interfaces; hardware, software and human interaction
    * Servers for each environment; see the [Technical Requirements](../../../6-5/sites/deploying/using/technical-requirements.md) and [Hardware Sizing Guidelines](../../../6-5/managing/using/hardware-sizing-guidelines.md)
    ...
    * [Dispatcher](/dispatcher/user-guide.md) caching 
    * [Clustering](../../../6-5/sites/deploying/using/recommended-deploys.md#deployment-scenarios) Publish/Authorshare 
...
* **System Integration**
  ...
  System integration requires you to plan (then implement):
    ...
    * How all the sub-systems and [solution integrations](/6-5/sites/administering/using/integration.md) will be brought together to operate as one coherent system
...
* **Test Concept**
  ...
  Before starting development you should draw up an in-depth and comprehensive concept of all [testing](/6-5/sites/developing/using/planning.md) requirements for your project.
...
* **Permissions**
  ...
  For more information, see [User Administration and Security](../../../6-5/sites/administering/using/security.md).
...
* **Monitoring and Maintenance**
  ...
  See also [Monitoring and Maintenance](../../../6-5/sites/deploying/using/monitoring-and-maintaining.md) for more information.
...
* **Development Environment**
  ...
  Plan and document your development environment, including:
    ...
    * Architecture
    * [Development tools](/6-5/sites/developing/using/dev-tools.md)
    ...
    * [Solution integration/dependencies](/6-5/sites/administering/using/integration.md)
    * Deployment cadence
...
* **Production System**
  ...
  Plan and document your production environment, including:
    ...
    * Third party software integration/dependencies
    * Security setup
    * Baseline performance verified by running the [Tough Day tests](../../../6-5/sites/developing/using/tough-day.md) on the production setup
    * Requirements for performance tests; see [Best Practices for Quality Assurance](/6-5/sites/deploying/using/configuring-performance.md#best-practices-for-quality-assurance)

* **Integration**

  Plan, document and test all aspects of the system and [solution integration](/6-5/sites/administering/using/integration.md), including:

    * An automated testing strategy
    * Automated processes to [move applications from development to test, then production](/6-5/managing/using/enterprise-devops.md#code-movement)
    * Automated processes to [move content from production to test and development](/6-5/managing/using/enterprise-devops.md#content-movement)
...
Once the new application is available it will need to undergo stringent testing, both for functionality and [performance](/6-5/sites/deploying/using/configuring-performance.md).
...
* **End-User Acceptance Test**
  ...
  [User acceptance testing](/6-5/sites/developing/using/acceptance-signoff.md) (UAT) is crucial to ensure that:
...
* **Performance and Load Tests**
  ...
  For more information about performance testing, see:
    ...
    * [Performance Testing](/6-5/sites/deploying/using/configuring-performance.md)
    * [How to plan and run testing](/6-5/sites/developing/using/planning.md)  
    
    * [Basic Performance Guidelines](/6-5/sites/deploying/using/configuring-performance.md#basic-performance-guidelines)
...
* **Penetration/Security Tests**
  ...
  See the [Security Checklist](../../../6-5/sites/administering/using/security-checklist.md) for more details.
...
* [Other Best Practices and Guidelines related to Managing an AEM project](../../../6-5/managing/using/manage-reference.md)
* [Deploying and Maintaining best practices](/6-5/sites/deploying/using/best-practices.md)
* [Administering best practices](/6-5/sites/administering/using/administer-best-practices.md)
* [Developing best practices](/6-5/sites/developing/using/best-practices.md)
* [Authoring best practices](/6-5/sites/authoring/using/best-practices.md)
...
* AEM Documentation  
  In addition, the following sections of AEM documentation are of particular interest (however, this list is not exhaustive):
    ...
    * [Security](/6-5/sites/developing/using/security.md)
    ...
    * [Hardware sizing](../../../6-5/managing/using/hardware-sizing-guidelines.md)
    * Concepts of AEM:

        * [Developing - the basics](/6-5/sites/developing/using/the-basics.md)
        * [MSM concepts](/6-5/sites/administering/using/msm.md)
        * [HTML Template Language (HTL)](/htl/user-guide.md)
