...
uuid: 0f312b98-63b9-4254-9560-cfb54f32dbdf
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: deb8053c-2658-4802-8b05-f6f72d586fdd
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Email notifications need to be configured via the osgi configuration. See [Configuring Email Notification.](/6-4/sites/administering/using/notification.md)
...
1. A new dialog will open immediately. Here you can enter properties for the newsletter.
   ...
   The **Default Recipients List** is a mandatory field as this forms the touchpoint for the newsletter (see [Working with Lists](../../../../6-4/sites/authoring/using/campaigns.md#workingwithlists) for more information about lists).
