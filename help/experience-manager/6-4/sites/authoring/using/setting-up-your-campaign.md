...
uuid: b2f68d8e-449b-4fad-b0ee-18ef2f8a7481
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: a72e7b8b-2653-4136-9cb0-2a5fd05286b9
index: y
internal: n
snippet: y
---
...
* If creating a Teaser:
    ...
    1. [Create a teaser experience](../../../../6-4/sites/authoring/using/campaigns.md#creatingateaserexperience).
    1. [Add content to your teaser](../../../../6-4/sites/authoring/using/campaigns.md#addingcontenttoyourteaser).
    1. [Create a Touchpoint for your Teaser](../../../../6-4/sites/authoring/using/campaigns.md#creatingatouchpointforyourteaser) (add your teaser to a content page).

* If creating a Newsletter:

    1. [Create a newsletter experience](../../../../6-4/sites/authoring/using/campaigns.md#creatinganewsletterexperience).
    1. [Add content to the newsletter.](../../../../6-4/sites/authoring/using/campaigns.md#addingcontenttonewsletters)
    1. [Personalize the newsletter.](../../../../6-4/sites/authoring/using/campaigns.md#personalizingnewsletters)
    1. [Create a compelling newsletter landing page](../../../../6-4/sites/authoring/using/campaigns.md#settingupanewsletterlandingpage).
    1. [Send the newsletter](../../../../6-4/sites/authoring/using/campaigns.md#sendingnewsletters) to subscribers or leads.

* If creating an Adobe Target (formerly Test&Target) Offer:

    1. [Create an Adobe Target offer experience](../../../../6-4/sites/authoring/using/campaigns.md#creatingatesttargetofferexperience).
    1. [Integrate with Adobe Target](../../../../6-4/sites/authoring/using/target-offers.md).

>[!NOTE]
>
>See [Segmentation](/6-4/sites/administering/using/campaign-segmentation.md) for detailed instructions on defining your segments.
...
* **Cloud Services:** The Cloud Service configurations with which the campaign is integrated. (See [Integrating with Adobe Marketing Cloud](/6-4/sites/administering/using/marketing-cloud.md).)

* **Adobe Target:** Properties that configure campaigns that are integrated with Adobe Target. (See [Integrating with Adobe Target](/6-4/sites/administering/using/target.md).)
...
* [Creating a Teaser](../../../../6-4/sites/authoring/using/campaigns.md#creatingateaser)
* [Creating a Newsletter](../../../../6-4/sites/authoring/using/campaigns.md#creatinganewsletter)
* [Creating an Adobe Target Offer](../../../../6-4/sites/authoring/using/campaigns.md#creatingatesttargetoffer)
...
* [Teaser](../../../../6-4/sites/authoring/using/campaigns.md#teasers):

    * [Connect the teaser page to visitor segments.](../../../../6-4/sites/authoring/using/campaigns.md#applyingasegmenttoyourteaser)
    * [Create a Touchpoint for your Teaser](../../../../6-4/sites/authoring/using/campaigns.md#creatingatouchpointforyourteaser) (add your teaser to a content page).

* [Newsletter](../../../../6-4/sites/authoring/using/campaigns.md#newsletters):

    * [Add content to the newsletter.](../../../../6-4/sites/authoring/using/campaigns.md#addingcontenttonewsletters)
    * [Personalize the newsletter.](../../../../6-4/sites/authoring/using/campaigns.md#personalizingnewsletters)
    * [Send the newsletter](../../../../6-4/sites/authoring/using/campaigns.md#sendingnewsletters) to subscribers or leads.
    * [Create a compelling newsletter landing page](../../../../6-4/sites/authoring/using/campaigns.md#settingupanewsletterlandingpage).

* [Adobe Target Offer](../../../../6-4/sites/authoring/using/campaigns.md#testtargetoffers):

    * [Integrate with Adobe Target](/6-4/sites/administering/using/target.md).
