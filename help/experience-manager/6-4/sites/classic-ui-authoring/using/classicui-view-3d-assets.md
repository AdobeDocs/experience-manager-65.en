...
uuid: 14b2bc67-f76d-41ff-a968-dbf133410852
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: authoring
content-type: reference
discoiquuid: 45b56ce0-e7db-4dbf-b9d8-74672db0bd32
index: y
internal: n
snippet: y
---
...
See [About the use of stages in AEM 3D](../../../../6-4/sites/classic-ui-authoring/using/classicui-stages-aem3d.md).
...
1. Make sure you have uploaded 3D assets into AEM.  
   See [About the uploading and processing of 3D assets in AEM](../../../../6-4/sites/classic-ui-authoring/using/classicui-upload-proc-3d.md).
...
1. Do one of the following:
    ...
    * Render the 3D asset.  
      See [Rendering 3D assets](../../../../6-4/sites/classic-ui-authoring/using/classicui-rendering-3d.md).
