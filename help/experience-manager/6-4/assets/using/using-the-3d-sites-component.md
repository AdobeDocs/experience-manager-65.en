...
uuid: f551879b-eed8-46a1-8d90-b74328249962
contentOwner: Rick Brough
topic-tags: 3D
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
content-type: reference
discoiquuid: 15632412-646c-4d04-b7df-f7432bc36363
index: y
internal: n
snippet: y
---
...
After you have added your 3D component, you can [view the 3D asset in that component.](../../../6-4/assets/using/viewing-3d-assets.md)

## Adding the 3D component to the page template {#adding-the-d-component-to-the-page-template}

You must enable the 3D component in the page before you can place it on a page. See [Editing templates](/6-4/sites/authoring/using/templates.md#editingatemplatelayoutauthor)for detailed information on enabling components in templates.
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   <td>Stage Name</td> 
   <td><p>Select a 3D Stage from the list of available stages. The stage provides background and lighting.</p> <p>See <a href="../../../6-4/assets/using/about-the-use-of-stages-in-aem-3d.md" target="_blank">About the use of stages in AEM 3D Sites</a>.</p> </td> 
...
1. Tap the check mark to save your changes.
   ...
   >[!NOTE]
   >
   >In addition to the settings available in the component configuration dialog, a number of global configuration settings are available which can be modified via the CRXDELite. See [Advanced Configuration Settings](../../../6-4/assets/using/advanced-config-3d.md) for detailed information on these global settings.
...
See also [Viewing 3D assets in the Sites 3D component](../../../6-4/assets/using/viewing-3d-assets.md#viewing-d-assets-in-the-sites-d-component).
...
See [Publishing Assets](/6-4/assets/using/managing-assets-touch-ui.md) for information on how to publish assets. See [Publishing Pages](/6-4/sites/authoring/using/publishing-pages.md) for information on how to publish pages.
