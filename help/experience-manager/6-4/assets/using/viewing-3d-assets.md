...
uuid: 13747d17-b995-4a40-86d4-c7f10117f218
contentOwner: Rick Brough
topic-tags: 3D
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
discoiquuid: 5c49f7fb-40d3-4438-b3d3-21da32d5b30f
index: y
internal: n
snippet: y
---
...
See [About the use of stages in AEM 3D](../../../6-4/assets/using/about-the-use-of-stages-in-aem-3d.md).
...
1. Make sure you have uploaded 3D assets into AEM.  
   See [About the uploading and processing of 3D assets in AEM](../../../6-4/assets/using/upload-processing-3d-assets.md).
...
1. Do one of the following:
    ...
    * Render the 3D asset.  
      See [Rendering 3D assets](../../../6-4/assets/using/rendering-3d-assets.md).
...
See also [Previewing a web page that has a 3D component](../../../6-4/assets/using/using-the-3d-sites-component.md#previewing-a-web-page-that-has-a-d-component).
