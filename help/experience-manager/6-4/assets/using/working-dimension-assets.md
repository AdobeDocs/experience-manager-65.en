...
uuid: 8114bfe2-8528-4ea1-a6dc-4acd6c096109
contentOwner: rbrough
topic-tags: 3D
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
content-type: reference
discoiquuid: 516a90ae-b6a4-400a-bda5-972053aa1c4c
index: y
internal: n
snippet: y
---
...
You can configure the .glb conversion format using one of two ways (see [Installing and configuring AEM 3D](../../../6-4/assets/using/install-config-3d.md) for instructions):
...
To enable support for Dimension assets, you must obtain credentials from Adobe for accessing the conversion service. See [Installing and configuring AEM 3D](../../../6-4/assets/using/install-config-3d.md).
...
* [AEM 3D release notes](../../../6-4/release-notes/aem3d-release-notes.md) for restrictions and limitations applicable to Dn assets and the glTF viewer.
* [Working with the 3D Sites component](../../../6-4/assets/using/using-the-3d-sites-component.md) for component properties specific to Adobe Dimension assets.
* [Installing and configuring AEM 3D](../../../6-4/assets/using/install-config-3d.md) to configure the cloud-based conversion service.
