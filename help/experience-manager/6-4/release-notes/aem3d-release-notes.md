...
uuid: 525900c6-93b2-41bc-9925-e188fcd0e9e7
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4
topic-tags: release-notes
content-type: reference
topic-tags: 3D
discoiquuid: 522422c7-ca74-4cee-a7cf-0f40699aed49
index: y
internal: n
snippet: y
---
...
AEM 3D supports Adobe Dimension (Dn) and glTF asset types. The implementation for these asset types is substantially different from that for traditional 3D types described in this documentation. See [Working with Adobe Dimension assets](../../6-4/assets/using/working-dimension-assets.md).
...
See [Integrating with Autodesk Maya](../../6-4/assets/using/integrate-maya-with-3d.md).

See also [Installing and configuring AEM 3D Assets](../../6-4/assets/using/install-config-3d.md) and [Advanced configuration settings](../../6-4/assets/using/advanced-config-3d.md).
...
See [Installing and configuring AEM 3D](../../6-4/assets/using/install-config-3d.md).

See also [Integrating AEM 3D with Autodesk Maya](../../6-4/assets/using/integrate-maya-with-3d.md) and [Integrating AEM 3D with Autodesk 3ds Max](../../6-4/assets/using/integrating-aem-3d-with-autodesk-3ds-max.md).
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   ...
   <td>Windows only</td> 
   <td>Autodesk Maya is required on the Author node to enable these file formats. See <a href="../../6-4/assets/using/integrate-maya-with-3d.md" target="_blank">Integrating AEM 3D with Autodesk Maya</a>.</td> 
  </tr>
  <tr>
   <td>JT</td> 
   <td>Siemens PLM Open CAD</td> 
   <td>Windows only</td> 
   <td>Autodesk Maya is required on the Author node to enable these file formats. See <a href="../../6-4/assets/using/integrate-maya-with-3d.md">Integrating AEM 3D with Autodesk Maya</a>.</td> 
  </tr>
  <tr>
   <td>*</td> 
   <td><p>Additional 3D input formats supported by Autodesk Maya can be enabled.</p> <p>See <a href="../../6-4/assets/using/integrate-maya-with-3d.md#enabling-additional-formats-supported-by-maya" target="_blank">Enabling Additional Formats Supported by Maya</a>.</p> </td> 
   <td>Windows only</td> 
   <td>Autodesk Maya is required on the Author node to enable these file formats. See <a href="../../6-4/assets/using/integrate-maya-with-3d.md">Integrating AEM 3D with Autodesk Maya</a>.</td> 
  </tr>
  <tr>
   ...
   <td>Windows only</td> 
   <td>Autodesk 3ds Max is required on the author node to enable this file format. See <a href="../../6-4/assets/using/integrating-aem-3d-with-autodesk-3ds-max.md">Integrating AEM 3D with Autodesk 3ds Max</a>.</td> 
  </tr>
 </tbody>
</table>
