...
uuid: a65d3ae7-8ae8-4972-b67e-77f256e7c7ec
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: upgrading
discoiquuid: c55ce9d6-1fc9-4cb2-a9ad-7a000147825a
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>This page outlines the upgrade procedure for AEM 6.5. If you have an installation that is deployed to an application server, see [Upgrade Steps for Application Server Installations](../../../sites/deploying/using/app-server-upgrade.md).
