...
uuid: 5d46efb5-9bc3-45bd-8815-c06a25cb0a59
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: upgrading
discoiquuid: 14580f4a-e207-4e8c-a6a0-a17e019618d2
index: y
internal: n
snippet: y
---
...
* [Upgrade the Database Schema If Needed](/sites/deploying/using/pre-upgrade-maintenance-tasks.htm#upgradethedatabaseschemaifneeded)
* [Delete Users that Might Hinder the Upgrade](../../../sites/deploying/using/pre-upgrade-maintenance-tasks.md#delete-users-that-might-hinder-the-upgrade)  
