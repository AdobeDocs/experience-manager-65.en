...
uuid: 42de1d30-47bf-47d6-ba78-4dfe95362d76
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
content-type: reference
topic-tags: best-practices
discoiquuid: e4bf69dc-1954-4b67-af1d-a16b686b0bb8
index: y
internal: n
snippet: y
---
...
* [Touch-enabled UI architecture](../../../sites/developing/using/touch-ui-concepts.md).
* Use the [Dialog Conversion tool](/sites/developing/using/dialog-conversion.md) to convert component Edit dialogs from the classic UI to the touch-enabled UI.  

* [Structure of the touch-enabled UI](/sites/developing/using/touch-ui-structure.md).  

* [Customizing the consoles in the touch-enabled UI](../../../sites/developing/using/customizing-consoles-touch.md) (includes sample code).  
