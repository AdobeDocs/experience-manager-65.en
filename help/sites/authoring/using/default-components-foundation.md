...
uuid: b8f9d31c-6ce9-458d-82d9-fb5736fa7ab5
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 6de9a4b7-17f1-4bd8-8068-0662c31be899
...
>[!NOTE]
>
>The **Table** Fourndation Component is based on the [Rich Text editor](../../../sites/authoring/using/rich-text-editor.md), as is the ** [Text](#text)** Foundation Component.
...
>[!NOTE]
>
>The **Text** Fourndation Component is based on the [Rich Text editor](../../../sites/authoring/using/rich-text-editor.md), as is the **Table** Foundation Component.
