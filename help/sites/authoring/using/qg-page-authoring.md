...
uuid: 7bb0da4a-c160-46fa-a77a-709679137a3c
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 0e8e24ab-21fc-42f0-bd00-b2876fe7c46f
index: y
internal: n
snippet: y
---
...
* Versions are not started/created from the page editor; this is now done from the Sites console (via either **Create** or [Timeline](../../../sites/authoring/using/basic-handling.md#timeline) for a selected resource).
...
1. You can also [Search](../../../sites/authoring/using/search.md) for a page. You can select your page from the results shown.

   ![](assets/qgtap-03.png)

### Creating a New Page {#creating-a-new-page}

To [create a new page](../../../sites/authoring/using/managing-pages.md#creating-a-new-page):
...
[Quick actions](../../../sites/authoring/using/basic-handling.md#quick-actions) are available:
...
To create a [version](../../../sites/authoring/using/working-with-page-versions.md) of your page:
