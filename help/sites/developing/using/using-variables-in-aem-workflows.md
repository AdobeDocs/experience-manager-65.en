...
uuid: 4e32672d-c48e-405b-81e4-08e98d2573c8
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 8ae0a44d-77ab-46d9-a714-1f882ba6df0a
index: y
internal: n
snippet: y
---
...
* [Create a variable](../../../sites/developing/using/using-variables-in-aem-workflows.md#create-a-variable) of a data type based on the information type that you want to store in it.
* [Set a value for the variable](../../../sites/developing/using/using-variables-in-aem-workflows.md#set-a-variable) using the Set Variable workflow step.
* [Use the variable](../../../sites/developing/using/using-variables-in-aem-workflows.md#use-a-variable) in OR Split and Goto AEM workflow steps to define an expression for taking routing decisions. You can also use variables in all AEM Forms workflow steps.
...
In this example, before defining the routing expression, use [example 2](../../../sites/developing/using/using-variables-in-aem-workflows.md#example2) to set the value for the **totalvalue** variable. Branch 1 is active if the value of the **totalvalue** variable is greater than 50000. Similarly, you can define a rule to make the Branch 2 active if the value of the **totalvalue** variable is less than 50000.
