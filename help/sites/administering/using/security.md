...
uuid: 91bd5958-533e-40f1-9221-afa1ab68cfa5
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: Security
content-type: reference
discoiquuid: 1ae60827-27a3-4668-bfb2-7713b90a7f31
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>Adobe has introduced a new Touch UI based principal view for permissions management. For more details on how to use it, see [this page](../../../sites/administering/using/touch-ui-principal-view.md).
