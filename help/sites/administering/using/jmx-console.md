...
uuid: 4f12377f-c20c-4a7f-a990-6a12220f24dc
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: operations
content-type: reference
discoiquuid: d6df63df-de9b-4b4a-af6f-2c596a5f7c89
index: y
internal: n
snippet: y
---
...
<p>Information about all packages that Package Manager contains.</p>
<ul>
<li>Domain: com.adobe.granite.packaging</li>
<li>Type: manager</li>
</ul>
-->
...
<p>Each row in the table represents a package in Package Manager. The column headings are package properties. Read-only.</p>
-->
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><a data-disable-query="false" href="https://docs.oracle.com/javase/8/docs/jre/api/management/extension/com/sun/management/HotSpotDiagnosticMXBean.html">com.sun.management.HotSpotDiagnosticMXBean</a></td> 
  </tr> 
  <tr> 
   <td>java.lang</td> 
   <td> 
