...
uuid: 4cbfce07-380e-442a-938a-0c8b8bfe1bd2
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: Security
content-type: reference
discoiquuid: b53aeb84-90be-49c7-92f5-b4230d9a09fd
index: y
internal: n
snippet: y
---
...
1. Next, go to the **Permissions** tab and press the **Edit Closed User Group** button.
   ...
   >
   >
   >For more information, see [this page](../../../sites/administering/using/closed-user-groups.md#aem-livecopy).
