...
uuid: 527b190a-4edb-4d71-9f5d-dd870c0d701c
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: operations
content-type: reference
discoiquuid: 63339375-e8f7-47b4-ada0-2e6777bcd50c
index: y
internal: n
snippet: y
---
...
>
>For more information, see the [RTE UI settings and content polices](../../../sites/administering/using/rich-text-editor.md#main-pars-header-206036638) section of this document as well as [Creating Page Templates](../../../sites/authoring/using/templates.md) and the [Core Components developer documentation](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/developing.html).
