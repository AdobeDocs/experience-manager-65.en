...
uuid: 07fe3e2d-fe0d-4282-9717-59bdaecf5307
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.5/SITES
topic-tags: operations
content-type: reference
discoiquuid: 65969c4c-cfb6-44c6-86fd-9181c72560a5
index: y
internal: n
snippet: y
---
...
For more information on performing Revision Clean Up, [see this dedicated article](/sites/deploying/using/revision-cleanup.md).
...
<li><p>Next, verify that the value for <strong>PausedCompaction</strong> is set to <span class="code">false</span>. This confirms that online revision cleanup is set to run:</p> <img imagerotate="0" src="assets/chlimage_1-130.png" /><p>Online revision cleanup is now scheduled to run as part of the tasks performed in the Daily Maintenance Window. For more info, see <a href="#automated-maintenance-tasks">Automated Maintenance Tasks</a>.</p> </li>
...
<img donotlocalize="true" imagerotate="0" src="do-not-localize/chlimage_1-19.png" />
-->
...
>[!NOTE]
>
>For more detailed information about Workflow Maintenance, see [this page](/sites/administering/using/workflows-administering.md#regular-purging-of-workflow-instances).
