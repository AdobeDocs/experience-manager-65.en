...
1. In Experience Manager, tap **[!UICONTROL Adobe Experience Manager]** to access the global navigation console, then tap the **[!UICONTROL Tools] > Workflow > Models]**.
1. On the Workflow Models page, in **[!UICONTROL Card View]** or **[!UICONTROL List View]**, select **[!UICONTROL Scene7: Reprocess Assets]**.
