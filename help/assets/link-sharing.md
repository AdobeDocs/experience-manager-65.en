...
1. To view the assets you shared as links, go to the Assets UI and click the Experience Manager logo. Choose **[!UICONTROL Navigation]** from the list to display the Navigation pane.
