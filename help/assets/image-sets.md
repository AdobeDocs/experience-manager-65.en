...
1. [Create Image Sets](#creating-image-sets).
   ...
   To create an Image Set in Assets, tap or click **[!UICONTROL Create]** > **[!UICONTROL Image Sets]**. Then, add images and click **[!UICONTROL Save]**.
...
1. In Experience Manager, tap the Experience Manager logo to access the global navigation console, then tap **[!UICONTROL Navigation]** > **[!UICONTROL Assets]**. Navigate to where you want to create an image set, then tap **[!UICONTROL Create]** > **[!UICONTROL Image Set]** to open the Image Set Editor page.
...
1. (Optional) Do any of the following:
   ...
   >[!NOTE]
   >
   >When creating the image set, you can change the image set thumbnail or allow Experience Manager to select the thumbnail automatically based on the assets in the image set. To select a thumbnail, tap **[!UICONTROL Change thumbnail]** above the Title field on the Image Set Editor page, then select any image (you can navigate to other folders to find images as well). If you have selected a thumbnail, and then decide that you want Experience Manager to generate one from the image set, select **[!UICONTROL Switch to]** **[!UICONTROL Automatic thumbnail]**.
...
* Open the properties of an individual asset. Properties indicate what sets the selected asset is referenced or a member of. Click the name of the set if you want to see the entire set.
