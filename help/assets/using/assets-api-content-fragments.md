...
uuid: b834498d-b085-4ec2-988f-3fc9bac4dfdc
contentOwner: aheimoz
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
content-type: reference
topic-tags: extending-assets
discoiquuid: 303de1ba-72d1-4168-8bb1-436719514edd
index: y
internal: n
snippet: y
---
...
<p>In environments with specific authentication requirements, OAuth is recommended. To configure please see this <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-oauth-server-functionality-in-aem.html">Gem session</a>. Additional information is available under <a href="https://helpx.adobe.com/experience-manager/kt/platform-repository/using/oauth-code-sample-develop.html">OAuth scopes</a>.</p>
-->
...
* [Available Features](../../assets/using/mac-api-assets.md#available-features) of the Assets REST API
...
<li><strong>Errors status codes</strong> of the API might be misleading, see <a href="../../assets/using/assets-api-content-fragments.md#status-codes-and-error-messages">Status Codes and Error Messages</a>.</li>
...
<li><a href="https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-oauth-server-functionality-in-aem.html">AEM Gem session: OAuth</a></li>
