...
uuid: 71452718-b5f7-4e1d-beae-63fac39645cf
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
content-type: reference
topic-tags: authoring
discoiquuid: 75a7293d-1761-4872-b353-fa053bd8bf72
index: y
internal: n
snippet: y
---
...
>[!NOTE]
>
>To upload assets by way of FTP in Dynamic Media - Scene7 mode, you must install Feature Pack 18912 on your AEM author instances. Contact Adobe Support to get access to FP-18912 and complete the setup of your FTP account. See [Installing feature pack 18912 for bulk asset migration](../../assets/using/bulk-ingest-migrate.md).
>
...
See [Download assets from AEM](../../assets/using/download-assets-from-aem.md).
...
For simple, advanced, and custom searches to discover and use the most appropriate assets, see [search assets in AEM](../../assets/using/search-assets.md).
...
>[!NOTE]
>
>Timeline contains several [options specific to content fragments](../../assets/using/content-fragments-managing.md#timeline-for-content-fragments).
...
>[!NOTE]
>
>For Content Fragments, [annotations are created in the fragment editor](../../assets/using/content-fragments-variations.md#annotating-a-content-fragment).
