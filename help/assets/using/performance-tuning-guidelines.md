...
uuid: 39356fde-d91d-4564-9232-3f409abc5109
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: b180abcc-0dca-484e-91df-fef7da632cde
...
>
>The policy changes required to process large files using ImageMagick may impact the AEM performance. For more information, see [install and configure ImageMagick](../../assets/using/best-practices-for-imagemagick.md).
