...
uuid: 1b46e40a-c5ad-4fa2-9caa-dfd5dc56df5e
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.5/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 576d73f8-0a32-4144-8b11-6d1b0c273dea
index: y
internal: n
snippet: y
---
...
>
>* See [Configuring Dynamic Media Cloud Services](../../assets/using/config-dms7.md#configuring-dynamic-media-cloud-services) in Configuring Dynamic Media - Scene7 mode and [Troubleshooting Dynamic Media - Scene7 mode.](../../assets/using/troubleshoot-dms7.md)
>
>* See [Configuring Dynamic Media Cloud Services](../../assets/using/config-dynamic.md#configuring-dynamic-media-cloud-services) in Configuring Dynamic Media - Hybrid mode.
>
...
1. **Upload your Dynamic Media videos** by doing the following:
    ...
    * Create your own video encoding profile. Or, you can simply use the predefined "Adaptive Video Encoding" profile that comes with Dynamic Media.
        ...
        * [Creating a video encoding profile](../../assets/using/video-profiles.md#creating-a-video-encoding-profile-for-adaptive-streaming).
...
1. **Manage your Dynamic Media videos** by doing any of the following:
    ...
    * Review, approve, and annotate videos, and maintain full version control
        ...
        * [Annotating videos](../../assets/using/managing-video-assets.md#annotatingvideoassets) or [Annotating assets](../../assets/using/managing-assets-touch-ui.md#annotating)
        
        * [Creating a version](../../assets/using/managing-assets-touch-ui.md#asset-versioning)
...
1. Under the **Authorized redirect URIs** heading, in the text field, enter the following path, substituting your own domain and port number in the path, then press **Enter** to add the path to the list:  
   ...
   `http://<servername.domain>:<port_number>/etc/cloudservices/youtube.youtubecredentialcallback.json`  
...
Publishing videos to YouTube requires that you have one or more channels. If you have already created a YouTube channel, you can skip this task and go to [Adding tags for publishing](../../assets/using/video.md#adding-tags-for-publishing).
...
* To configure YouTube in AEM before 6.4, see [Setting up YouTube in AEM before 6.4](../../assets/using/video.md#setting-up-youtube-in-aem-before).
...
1. Using a plain text editor, open the JSON file that you downloaded and saved earlier in the task [Configuring Google Cloud settings](../../assets/using/video.md#configuring-google-cloud-settings).
...
1. In the YouTube Account Settings dialog box, in the **Application Name** field, enter the Google Project ID.
   ...
   You specified the project ID when you initially [configured Google Cloud settings](../../assets/using/video.md#configuring-google-cloud-settings) earlier.  
...
Last Modified Date: 2019-03-08T20:31:02.635-0500
MAYBE ADD IN THE FUTURE BASED ON CQDOC-12851 Information: starting with AEM 6.3, there are three other ways of obtaining the YouTube URL Timeline includes the link as well as the YouTube Channel name; here are steps at browse, select the published Video Asset click navigation menu > Timeline click on "Asset Uploaded to YouTube" E-mail notification (requires e-mail is setup) YouTube publish log found under replication (requires admin access, I believe)
-->
...
1. Be sure you have already done the following:
    ...
    * [Applied a video profile to the folder](../../assets/using/video-profiles.md#applying-a-video-profile-to-folders).  
    
    * [Uploaded your videos to the folder](../../assets/using/managing-video-assets.md#uploadingandpreviewingvideoassets).
...
See also [About video thumbnails in Dynamic Media - Scene7 mode](../../assets/using/video.md#about-video-thumbnails-in-dynamic-media-scene-mode).
