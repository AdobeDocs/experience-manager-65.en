...
<p>This page is undergoing a major revamp given Adobe Asset Link is released at the same time as 6.5 GA. I have created a copy of previous content (referring to AEM to CC Folder Sharing; now deprecated) and saved it under <a href="/assets/using/aem-cc-integration-best-practices1.md">aem-cc-integration-best-practices1.html</a></p>
-->
...
<a href="https://helpx.adobe.com/experience-manager/desktop-app/aem-desktop-app-best-practices.html">AEM desktop app best practices</a>
<a href="https://helpx.adobe.com/experience-manager/brand-portal/user-guide.html">AEM Brand Portal</a>
<a href="../../assets/using/aem-assets-adobe-stock.md">AEM and Adobe Stock integration</a>
<a href="../../assets/using/aem-cc-folder-sharing-best-practices.md">AEM to Creative Cloud folder sharing best practices</a>
</related-links>
-->
