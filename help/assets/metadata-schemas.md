...
1. To view the [!UICONTROL Properties] page for an asset, click **[!UICONTROL View Properties]** from quick actions on the asset tile in the card view. Alternatively, select the asset in the interface and then click **[!UICONTROL Properties]** from the toolbar.
...
1. To view a list of forms/templates, in [!DNL Experience Manager] interface navigate to **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL Metadata Schemas]**.
   ...
   [!DNL Experience Manager] provides the following templates out of the box:
