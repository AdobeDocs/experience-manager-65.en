...
>* To use Dynamic Media to preview and generate dynamic renditions for EPS files, see [Adobe Illustrator (AI), Postscript (EPS), and PDF file formats.](/help/assets/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
...
>* To use Dynamic Media to generate dynamic renditions for INDD files, see [InDesign (INDD) file format](/help/assets/managing-image-presets.md#indesign28indd29fileformat) [](/help/assets/managing-image-presets.md#adobeillustrator28ai29postscript28eps29andpdffileformats)
>
...
See [Configure MIME type-based for upload job parameters support](/help/assets/config-dynamic.md#configuringmimetypebasedassetsforuploadjobparametersupport).
