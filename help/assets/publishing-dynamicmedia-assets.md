...
You can also instantly publish assets that you upload&mdash;without any user intervention. Or, you can selectively publish assets. See [Configuring Dynamic Media - Scene7 mode](config-dms7.md).
