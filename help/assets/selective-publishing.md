...
1. In AEM, tap the AEM logo to access the global navigation console. On the left side, tap the Navigation icon (just above the Tools icon), then tap **[!UICONTROL Assets]** > **[!UICONTROL Files]**.
...
1. In AEM, tap the AEM logo to access the global navigation console. On the left side of the page, tap the Navigation icon (just above the Tools icon), then on the right side of the page tap **[!UICONTROL Assets]** > **[!UICONTROL Files]**.
1. In **[!UICONTROL Card View]**, **[!UICONTROL Column View]**, or **[!UICONTROL List View]**, do one of the following:
...
1. In AEM, in the upper-left corner of the page, tap the AEM logo to access the global navigation console. On the left side of the page, tap the Navigation icon (just above the Tools icon), then tap **[!UICONTROL Assets]** > **[!UICONTROL Files]**.
