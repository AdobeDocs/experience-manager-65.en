...
|---|---|---|
| 1 | Clone Dynamic Media&ndash;Hybrid Author instance.<br> | You should maintain your existing instance of Dynamic Media&ndash;Hybrid Author for fallback purposes until the remaining steps in this migration process are successfully completed. |
